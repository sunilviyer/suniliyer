...
/* ═══════════════════════════════════════════════════════════════
   BEHIND THE BUILD — HOMEPAGE TEASER
   Spine-out bookshelf · 9 books · Hover to peek · Click → full page
   Embeds as a section in suniliyer.ca homepage
   ═══════════════════════════════════════════════════════════════ */
...
function BookSpine({ project, index }) {
  ...
  return (
    <a
      ...
      onClick={(e) => { e.preventDefault(); window.location.href = "/behind-the-build"; }}
...
export default function BehindTheBuildTeaser() {
  return (
    <section style={{
      padding: "80px 16px 60px",
      background: "linear-gradient(180deg, #0a0a0c 0%, #12090688 8%, #0c080655 50%, #12090688 92%, #0a0a0c 100%)",
      position: "relative", overflow: "hidden",
      ...
      {/* Decorative top line */}
      <div style={{ position: "absolute", top: 0, left: "10%", right: "10%", height: 1, background: "linear-gradient(to right, transparent, rgba(180,140,80,0.12), transparent)" }} />

      {/* Title */}
      <div style={{ textAlign: "center", marginBottom: 44, position: "relative", zIndex: 2 }}>
        <p style={{
          fontSize: 10, fontFamily: "'JetBrains Mono', monospace",
          color: WOOD.honey, letterSpacing: "0.28em", textTransform: "uppercase",
          marginBottom: 14, opacity: 0.5,
        }}>Behind the Build</p>
        <h2 style={{
          fontSize: "clamp(22px, 3.5vw, 36px)", fontWeight: 400,
          color: WOOD.cream, fontFamily: "'Libre Baskerville', serif",
          margin: "0 0 10px", lineHeight: 1.3,
        }}>Pull a book. Read the story.</h2>
        <p style={{
          fontSize: 14, color: `${WOOD.oak}88`,
      ...
      <div style={{ position: "absolute", bottom: 0, left: "10%", right: "10%", height: 1, background: "linear-gradient(to right, transparent, rgba(180,140,80,0.12), transparent)" }} />
    </section>
  );
}
