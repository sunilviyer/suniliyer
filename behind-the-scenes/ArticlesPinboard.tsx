...
const ARTICLES: Article[] = [
  { id:1,  category:"builder",    status:"published", isHero:true,
    ...
    readTime:"5 min read", date:"Feb 2025", link:"https://medium.com/@sunilviswanathaniyer/seshan-what-280-hours-of-building-taught-me-about-ai-learning-and-letting-go-of-perfection-9cf27c021c2f",
    image:"/images/medium/seshan.webp" },
  { id:2,  category:"builder",    status:"soon",      isHero:true,
    title:"Five AI Agents, One Portfolio: The Architecture Behind Automation",
    description:"How SIU, Banker, Matchmaker, Editor, and Guru were built — and why the human never left the loop.",
  ...
  { id:3,  category:"futurist",   status:"published",
    ...
    readTime:"5 min read", date:"Feb 2025", link:"https://medium.com/@sunilviswanathaniyer/the-race-to-agi-who-is-doing-what-where-we-stand-and-the-ssi-wildcard-5b884815a168",
    image:"/images/medium/AGI.webp" },
  { id:4,  category:"governance", status:"published",
    ...
    readTime:"4 min read", date:"May 2024", link:"https://medium.com/@sunilviswanathaniyer/the-new-gold-standard-for-ai-governance-and-responsible-ai-f27e36fc7bb7",
    image:"/images/medium/gold-standard-eu.webp" },
  { id:5,  category:"governance", status:"published",
    ...
    readTime:"3 min read", date:"May 2024", link:"https://medium.com/@sunilviswanathaniyer/ensuring-ai-implementation-are-fair-explainable-socially-beneficial-and-human-centric-b689a9964a58",
    image:"/images/medium/human-centric.webp" },
  { id:6,  category:"governance", status:"published",
    ...
    readTime:"2 min read", date:"May 2024", link:"https://medium.com/@sunilviswanathaniyer/responsibility-of-responsible-ai-debcf574ec8f",
    image:"/images/medium/responsiblity-of-responsible.webp" },
  { id:7,  category:"governance", status:"published",
    ...
    readTime:"6 min read", date:"Jan 2025", link:"https://medium.com/@sunilviswanathaniyer/responsible-ai-the-urgency-is-real-but-the-world-is-not-lost-a83fd28ccddb",
    image:"/images/medium/responsible-ai.webp" },
  { id:8,  category:"futurist",   status:"published",
    ...
    readTime:"7 min read", date:"Jan 2025", link:"https://medium.com/@sunilviswanathaniyer/the-council-of-ai-when-multiple-llms-debate-everyone-wins-9b4909f18d79",
    image:"/images/medium/council-of-ai.webp" },
  ...
  { id:11, category:"builder",    status:"idea", isSticky:true,
    ...
    description:"The architectural philosophy behind keeping SIU, Banker, Matchmaker, Editor and Guru beautifully separate.",
  ...
  { id:16, category:"futurist",   status:"published",
    title:"AI Models Sometimes Confess Their Own Misbehaviour. Nobody Is Required to Read It.",
    description:"A window into how AI systems think is open right now. It will not stay open forever. Here is what good developers do about it, and what you should be asking your vendors.",
    readTime:"5 min read", date:"Mar 2026", link:"https://medium.com/@sunilviswanathaniyer/ai-models-sometimes-confess-their-own-misbehaviour-nobody-is-required-to-read-it-0be557684a14",
