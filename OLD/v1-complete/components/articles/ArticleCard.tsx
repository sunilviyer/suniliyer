...
export default function ArticleCard({ article, allArticles }: ArticleCardProps) {
  ...
  // Progressive enhancement: Link works without JS, onClick enhances with expandable dialog
  const handleClick = (e: React.MouseEvent) => {
    e.preventDefault(); // Prevent navigation when JS is available
    setIsExpanded(true);
  };
  ...
  return (
    <>
      {/* Progressive Enhancement: Link works without JS, enhanced with dialog when JS available */}
      <Link
