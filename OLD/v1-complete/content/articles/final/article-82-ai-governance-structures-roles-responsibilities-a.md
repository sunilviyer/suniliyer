...
![Article 82: AI Governance Structures – Roles, Responsibilities, and RACI]({{IMAGE_PLACEHOLDER_article-82-ai-governance-structures-roles-responsibilities-a}})

---
title: 'Article 82: AI Governance Structures – Roles, Responsibilities, and RACI'
tldr: ''
...
- type: image_prompt
  ...
  prompt: organizational structure, implementation roadmap, strategic planning elements,
    ...
    article header
- type: table
  label: Activity vs Exec Sponsor Table
  section: Sample AI Governance RACI
  id: table-sample-ai-governance-raci
- type: table
  label: Role vs Person Table
  section: 'Example 1: Small Organization (< 500 employees)'
  id: table-example-1-small-organization-500-employees
- type: table
  label: Metric vs Target Table
  section: Measuring Governance Effectiveness
  id: table-measuring-governance-effectiveness
- type: flowchart
...
- type: list
  label: RACI Design Principles
  section: RACI Design Principles
  id: list-raci-design-principles
topic_fingerprint:
- accountability
- fairness
- explainability
...
- nist
word_count: 2107
processed_date: '2025-12-18T02:16:53.534Z'
---
...
<!-- component:table:table-sample-ai-governance-raci -->
|----------|--------------|-------------------------|--------------|-----------------|----------------|--------------|------------------|
...
<!-- component:list:list-raci-design-principles -->
...
<!-- component:table:table-example-1-small-organization-500-employees -->
|------|--------|------------|
...
<!-- component:table:table-measuring-governance-effectiveness -->
|--------|--------|-----------|
