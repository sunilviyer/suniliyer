...
![Article 115: Scaling AI Governance – From Pilot to Enterprise-Wide]({{IMAGE_PLACEHOLDER_article-115-scaling-ai-governance-from-pilot-to-enterprise-w}})
...
- type: checklist
  ...
  section: Scaling Checklist
  id: checklist-scaling-checklist
- type: table
  label: Aspect vs Pilot (5-10 systems) Table
  section: Why Scaling Is Different
  id: table-why-scaling-is-different
- type: table
  label: Role vs Scope Table
  section: Roles in Scaled Model
  id: table-roles-in-scaled-model
- type: table
  label: Organization Size vs Central Team Table
  section: Staffing the Scaled Model
  id: table-staffing-the-scaled-model
- type: table
  label: Metric vs Target Table
  section: Coverage Metrics
  id: table-coverage-metrics
- type: table
  label: Metric vs Target Table
  section: Quality Metrics
  id: table-quality-metrics
- type: table
  label: Metric vs Target Table
  section: Efficiency Metrics
  id: table-efficiency-metrics
- type: table
  label: Metric vs Target Table
...
- type: list
  label: Scaling Principles
  section: Scaling Principles
  id: list-scaling-principles
- type: list
  label: 'Principle 1: Standardize Before Scaling'
  section: 'Principle 1: Standardize Before Scaling'
  id: list-principle-1-standardize-before-scaling
- type: list
  label: 'Principle 2: Automate Where Possible'
  section: 'Principle 2: Automate Where Possible'
  id: list-principle-2-automate-where-possible
- type: list
  label: 'Principle 3: Federate Responsibility'
  section: 'Principle 3: Federate Responsibility'
  id: list-principle-3-federate-responsibility
- type: list
  label: 'Principle 4: Risk-Based Prioritization'
  section: 'Principle 4: Risk-Based Prioritization'
  id: list-principle-4-risk-based-prioritization
- type: list
  label: 'Principle 5: Build Capability, Not Dependency'
  section: 'Principle 5: Build Capability, Not Dependency'
  id: list-principle-5-build-capability-not-dependency
- type: list
  label: Scaling Testing Requirements
  section: Scaling Testing Requirements
  id: list-scaling-testing-requirements
topic_fingerprint:
- accountability
- oversight
...
- nist
word_count: 1504
processed_date: '2025-12-18T20:04:57.262Z'
---
