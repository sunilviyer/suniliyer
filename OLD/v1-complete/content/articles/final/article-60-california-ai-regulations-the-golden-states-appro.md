...
![Article 60: California AI Regulations – The Golden State's Approach]({{IMAGE_PLACEHOLDER_article-60-california-ai-regulations-the-golden-states-appro}})

---
title: 'Article 60: California AI Regulations – The Golden State''s Approach'
tldr: ''
category: AI Laws
learning_objectives:
...
- type: table
  label: Aspect vs California Table
  section: California vs. EU AI Act
  id: table-california-vs-eu-ai-act
- type: table
  label: Aspect vs California Table
  section: California vs. Colorado
  id: table-california-vs-colorado
- type: table
  label: Aspect vs California Table
  section: California vs. NYC Local Law 144
  id: table-california-vs-nyc-local-law-144
- type: table
  label: AI Activity vs Potentially Applicable Laws Table
  section: 'Step 1: Determine Which Laws Apply'
  id: table-step-1-determine-which-laws-apply
- type: table
  label: Requirement vs Source Table
  section: 'Example 1: AI Startup Building Image Generator'
  id: table-example-1-ai-startup-building-image-generator
- type: table
  label: Requirement vs Source Table
  section: 'Example 2: National Retailer Using AI Chatbot'
  id: table-example-2-national-retailer-using-ai-chatbot
- type: table
  label: Requirement vs Source Table
  section: 'Example 3: HR Software Company'
  id: table-example-3-hr-software-company
- type: flowchart
  label: Introduction Process
  section: Introduction
  id: flowchart-introduction
- type: flowchart
  label: 'AB 2013: Generative AI Training Data Transparency (2024) Process'
  section: 'AB 2013: Generative AI Training Data Transparency (2024)'
  id: flowchart-ab-2013-generative-ai-training-data-transparency-2024
- type: flowchart
  label: 'SB 942: California AI Transparency Act (2024) Process'
  section: 'SB 942: California AI Transparency Act (2024)'
  id: flowchart-sb-942-california-ai-transparency-act-2024
- type: flowchart
  label: 'SB 1047: The AI Safety Bill (Vetoed but Influential) Process'
  section: 'SB 1047: The AI Safety Bill (Vetoed but Influential)'
  id: flowchart-sb-1047-the-ai-safety-bill-vetoed-but-influential
- type: flowchart
...
- type: template
  label: The "Brussels Effect" in American Form
  section: The "Brussels Effect" in American Form
  id: template-the-brussels-effect-in-american-form
  template_link: /templates/the-brussels-effect-in-american-form.md
topic_fingerprint:
- generative ai
- transparency
- ai safety
...
- stanford
word_count: 2063
processed_date: '2025-12-18T20:06:50.119Z'
---


## California's Regulatory Philosophy

<!-- component:template:template-the-brussels-effect-in-american-form -->
...
<!-- component:flowchart:flowchart-ab-2013-generative-ai-training-data-transparency-2024 -->
...
<!-- component:flowchart:flowchart-sb-1047-the-ai-safety-bill-vetoed-but-influential -->
...
<!-- component:table:table-california-vs-eu-ai-act -->
|--------|------------|-----------|
...
<!-- component:table:table-california-vs-colorado -->
|--------|------------|----------|
...
<!-- component:table:table-california-vs-nyc-local-law-144 -->
|--------|------------|------------|
...
<!-- component:table:table-step-1-determine-which-laws-apply -->
|-------------|----------------------------|
...
<!-- component:table:table-example-1-ai-startup-building-image-generator -->
|-------------|--------|---------------|
...
| Requirement | Source | Action Needed |
<!-- component:table:table-example-2-national-retailer-using-ai-chatbot -->
|-------------|--------|---------------|
...
| Requirement | Source | Action Needed |
<!-- component:table:table-example-3-hr-software-company -->
|-------------|--------|---------------|
