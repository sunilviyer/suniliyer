...
![The AI Audit – How to Evaluate AI Systems]({{IMAGE_PLACEHOLDER_the-ai-audit-how-to-evaluate-ai-systems}})

---
title: The AI Audit – How to Evaluate AI Systems
tldr: ''
...
- type: flowchart
  label: 'Phase 4: Reporting Process'
  section: 'Phase 4: Reporting'
  id: flowchart-phase-4-reporting
- type: flowchart
  label: Sources Process
  section: Sources
  id: flowchart-sources
- type: template
  label: 'Example: The Audit Landscape'
  section: What Audits Are Not
  id: template-what-audits-are-not
  template_link: /templates/example-the-audit-landscape.md
- type: template
  label: 'Dimension 4: Technical Performance'
  section: 'Dimension 4: Technical Performance'
  id: template-dimension-4-technical-performance
  template_link: /templates/dimension-4-technical-performance.md
- type: template
  label: 'Phase 2: Information Gathering'
  section: 'Phase 2: Information Gathering'
  id: template-phase-2-information-gathering
  template_link: /templates/phase-2-information-gathering.md
- type: template
  label: 'Example: Establishing Audit Criteria'
  section: Best Practices
  id: template-best-practices
  template_link: /templates/example-establishing-audit-criteria.md
- type: list
  label: Audit Standards and Criteria
  section: Audit Standards and Criteria
  id: list-audit-standards-and-criteria
- type: list
...
- nyc local law 144
word_count: 3394
processed_date: '2025-12-18T20:07:38.666Z'
---
...
<!-- component:template:template-what-audits-are-not -->
...
<!-- component:template:template-dimension-4-technical-performance -->
...
<!-- component:template:template-phase-2-information-gathering -->
...
**Report Contents**:
<!-- component:flowchart:flowchart-phase-4-reporting -->
1. Executive Summary
...
<!-- component:list:list-audit-standards-and-criteria -->
...
<!-- component:list:list-best-practices -->
...
<!-- component:template:template-best-practices -->
