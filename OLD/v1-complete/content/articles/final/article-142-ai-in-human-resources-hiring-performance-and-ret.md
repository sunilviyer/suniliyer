...
![Article 142: AI in Human Resources – Hiring, Performance, and Retention]({{IMAGE_PLACEHOLDER_article-142-ai-in-human-resources-hiring-performance-and-ret}})

---
title: 'Article 142: AI in Human Resources – Hiring, Performance, and Retention'
tldr: ''
...
- type: image_prompt
  ...
  prompt: industry-specific icons, sector applications, business context, professional
    ...
    header
- type: table
  label: Requirement vs Details Table
  section: NYC Local Law 144
  id: table-nyc-local-law-144
- type: table
  label: Jurisdiction vs Requirement Table
  section: Other Regulations
  id: table-other-regulations
- type: table
  label: Proxy vs What It May Encode Table
  section: 'Challenge 2: Proxy Discrimination'
  id: table-challenge-2-proxy-discrimination
- type: table
  label: Question vs Why It Matters Table
  section: Pre-Deployment Assessment
  id: table-pre-deployment-assessment
- type: table
  label: Test vs Purpose Table
  section: Bias Testing Framework
  id: table-bias-testing-framework
- type: table
  label: Timing vs What to Communicate Table
  section: Transparency Requirements
  id: table-transparency-requirements
- type: table
  label: Level vs Description Table
  section: Human Oversight
  id: table-human-oversight
- type: table
  label: Area vs Questions to Ask Table
...
- type: template
  label: 'Article 142: AI in Human Resources – Hiring, Performance, and Retention'
  section: 'Article 142: AI in Human Resources – Hiring, Performance, and Retention'
  id: template-article-142-ai-in-human-resources-hiring-performance-and-retention
  template_link: /templates/article-142-ai-in-human-resources-hiring-performance-and-retention.md
- type: template
  label: Performance Management
  section: Performance Management
  id: template-performance-management
  template_link: /templates/performance-management.md
- type: template
  label: 'Example:'
  section: 'Challenge 5: The "Black Box" Problem'
  id: template-challenge-5-the-black-box-problem
  template_link: /templates/example.md
- type: template
  label: Remote/Gig Work Platforms
  section: Remote/Gig Work Platforms
  id: template-remotegig-work-platforms
  template_link: /templates/remotegig-work-platforms.md
- type: template
  label: The Performance and Retention Dimension
  section: The Performance and Retention Dimension
  id: template-the-performance-and-retention-dimension
  template_link: /templates/the-performance-and-retention-dimension.md
- type: template
  label: AI in Performance Management
  section: AI in Performance Management
  id: template-ai-in-performance-management
  template_link: /templates/ai-in-performance-management.md
- type: list
  label: Best Practices for HR AI Governance
  section: Best Practices for HR AI Governance
  id: list-best-practices-for-hr-ai-governance
- type: list
...
- nyc local law 144
word_count: 2248
processed_date: '2025-12-18T20:05:43.918Z'
---
...
<!-- component:template:template-performance-management -->
...
| Requirement | Details |
<!-- component:table:table-nyc-local-law-144 -->
|-------------|---------|
...
<!-- component:table:table-challenge-2-proxy-discrimination -->
|-------|-------------------|
...
<!-- component:template:template-challenge-5-the-black-box-problem -->
**Example:**
...
<!-- component:list:list-best-practices-for-hr-ai-governance -->
...
<!-- component:table:table-pre-deployment-assessment -->
|----------|---------------|
...
| Test | Purpose |
<!-- component:table:table-bias-testing-framework -->
|------|---------|
...
<!-- component:table:table-transparency-requirements -->
|--------|---------------------|
...
<!-- component:template:template-remotegig-work-platforms -->
...
<!-- component:template:template-the-performance-and-retention-dimension -->

## The Performance and Retention Dimension

<!-- component:template:template-ai-in-performance-management -->
