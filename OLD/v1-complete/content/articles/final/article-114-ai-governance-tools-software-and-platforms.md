...
![Article 114: AI Governance Tools – Software and Platforms]({{IMAGE_PLACEHOLDER_article-114-ai-governance-tools-software-and-platforms}})
...
- type: image_prompt
  ...
  prompt: organizational structure, implementation roadmap, strategic planning elements,
    ...
    article header
- type: table
  label: Challenge vs Manual Approach Table
  section: Why Tools Matter
  id: table-why-tools-matter
- type: table
  label: Tool vs Type Table
  section: AI Inventory and Registry Tools
  id: table-ai-inventory-and-registry-tools
- type: table
  label: Tool vs Type Table
  section: Fairness and Bias Testing Tools
  id: table-fairness-and-bias-testing-tools
- type: table
  label: Tool vs Type Table
  section: Explainability Tools
  id: table-explainability-tools
- type: table
  label: Tool vs Type Table
  section: Monitoring and Observability Tools
  id: table-monitoring-and-observability-tools
- type: table
  label: Tool vs Type Table
  section: Compliance and Workflow Tools
  id: table-compliance-and-workflow-tools
- type: table
  label: Tool vs Type Table
  section: Integrated AI Governance Platforms
  id: table-integrated-ai-governance-platforms
- type: table
  label: Factor vs Lean Build Table
  section: Build vs. Buy Decision Matrix
  id: table-build-vs-buy-decision-matrix
- type: table
  label: Tool vs Maintainer Table
  section: Fairness and Bias
  id: table-fairness-and-bias
- type: table
  label: Tool vs Maintainer Table
  section: Explainability
  id: table-explainability
- type: table
  label: Tool vs Maintainer Table
  section: Monitoring
  id: table-monitoring
- type: table
  label: Tool vs Maintainer Table
  section: MLOps with Governance Features
  id: table-mlops-with-governance-features
- type: flowchart
...
- type: template
  label: 'Article 114: AI Governance Tools – Software and Platforms'
  section: 'Article 114: AI Governance Tools – Software and Platforms'
  id: template-article-114-ai-governance-tools-software-and-platforms
  template_link: /templates/article-114-ai-governance-tools-software-and-platforms.md
- type: template
  label: 'Example: Using Fairlearn'
  section: Fairness and Bias Testing Tools
  id: template-fairness-and-bias-testing-tools
  template_link: /templates/example-using-fairlearn.md
- type: template
  label: Integrated AI Governance Platforms
  section: Integrated AI Governance Platforms
  id: template-integrated-ai-governance-platforms
  template_link: /templates/integrated-ai-governance-platforms.md
topic_fingerprint:
- audit
- risk assessment
- fairness
...
- watson
word_count: 1540
processed_date: '2025-12-18T20:04:55.679Z'
---
