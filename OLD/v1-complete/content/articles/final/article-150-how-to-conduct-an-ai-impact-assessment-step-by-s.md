...
![Article 150: How to Conduct an AI Impact Assessment — Step by Step]({{IMAGE_PLACEHOLDER_article-150-how-to-conduct-an-ai-impact-assessment-step-by-s}})
...
- type: checklist
  label: 3.1 Documentation Checklist
  section: 3.1 Documentation Checklist
  id: checklist-31-documentation-checklist
- type: checklist
  label: 'Template 2: Quick Risk Assessment Checklist'
  section: 'Template 2: Quick Risk Assessment Checklist'
  id: checklist-template-2-quick-risk-assessment-checklist
- type: table
  label: Reason vs Benefit Table
  section: Why Conduct an AIA?
  id: table-why-conduct-an-aia
- type: table
  label: Type vs Focus Table
  section: Types of AI Impact Assessments
  id: table-types-of-ai-impact-assessments
- type: table
  label: Timing vs Purpose Table
  section: When to Conduct an AIA
  id: table-when-to-conduct-an-aia
- type: table
  label: Risk Level vs Assessment Depth Table
  section: 1.4 Determine Assessment Depth
  id: table-14-determine-assessment-depth
- type: table
  label: Role vs Responsibility Table
  section: 2.1 Define Required Roles
  id: table-21-define-required-roles
- type: table
  label: Role vs Responsibility Table
  section: 2.1 Define Required Roles
  id: table-21-define-required-roles
- type: table
  label: Name vs Role Table
  section: 2.2 Document the Team
  id: table-22-document-the-team
- type: table
  label: '------ vs ------ Table'
  section: 2.2 Document the Team
  id: table-22-document-the-team
- type: table
  label: 2.2 Document the Team Table
  section: 2.2 Document the Team
  id: table-22-document-the-team
- type: table
  label: 2.2 Document the Team Table
...
- type: table
  ...
  id: table-22-document-the-team
- type: table
  label: Name/Organization vs Role Table
  section: 2.2 Document the Team
  id: table-22-document-the-team
- type: table
  label: '------------------- vs ------ Table'
  ...
  id: table-22-document-the-team
- type: table
  label: Document vs Owner Table
  section: 3.1 Documentation Checklist
  id: table-31-documentation-checklist
- type: table
  label: '---------- vs ------- Table'
  section: 3.1 Documentation Checklist
  id: table-31-documentation-checklist
- type: table
  label: Component vs Function Table
  section: 4.2 Technical Description
  id: table-42-technical-description
- type: table
  label: '----------- vs ---------- Table'
  section: 4.2 Technical Description
  id: table-42-technical-description
- type: table
  label: 4.2 Technical Description Table
  section: 4.2 Technical Description
  id: table-42-technical-description
- type: table
  label: Component vs Vendor Table
  section: 4.2 Technical Description
  id: table-42-technical-description
- type: table
  label: '----------- vs -------- Table'
  ...
  id: table-42-technical-description
- type: table
  label: Data Source vs Data Type Table
  section: 4.3 Data Description
  id: table-43-data-description
- type: table
  label: '------------- vs ----------- Table'
  section: 4.3 Data Description
  id: table-43-data-description
- type: table
  label: 4.3 Data Description Table
  section: 4.3 Data Description
  id: table-43-data-description
- type: table
  label: Input vs Source Table
  section: 4.3 Data Description
  id: table-43-data-description
- type: table
  label: '------- vs -------- Table'
...
- type: table
  ...
  id: table-43-data-description
- type: table
  label: Decision vs Fully Automated? Table
  section: 4.4 Decision Framework
  id: table-44-decision-framework
- type: table
  label: '---------- vs ------------------ Table'
  section: 4.4 Decision Framework
  id: table-44-decision-framework
- type: table
  label: 4.4 Decision Framework Table
  section: 4.4 Decision Framework
  id: table-44-decision-framework
- type: table
  label: User Type vs Number Table
  section: 4.5 Operational Context
  id: table-45-operational-context
- type: table
  label: '----------- vs -------- Table'
  section: 4.5 Operational Context
  id: table-45-operational-context
- type: table
  label: Connected System vs Integration Type Table
  section: 4.5 Operational Context
  id: table-45-operational-context
- type: table
  label: '------------------ vs ------------------ Table'
  ...
  id: table-45-operational-context
- type: table
  label: Stakeholder vs Role Table
  section: 5.1 Stakeholder Identification
  id: table-51-stakeholder-identification
- type: table
  label: 5.1 Stakeholder Identification Table
  section: 5.1 Stakeholder Identification
  id: table-51-stakeholder-identification
- type: table
...
- type: table
  ...
  id: table-51-stakeholder-identification
- type: table
  label: Group vs How Affected Table
  section: 5.2 Affected Persons Analysis
  id: table-52-affected-persons-analysis
- type: table
  label: '------- vs -------------- Table'
  section: 5.2 Affected Persons Analysis
  id: table-52-affected-persons-analysis
- type: table
  label: 5.2 Affected Persons Analysis Table
  section: 5.2 Affected Persons Analysis
  id: table-52-affected-persons-analysis
- type: table
  label: Group vs Specific Vulnerabilities Table
  section: 5.2 Affected Persons Analysis
  id: table-52-affected-persons-analysis
- type: table
  label: '------- vs ------------------------- Table'
  ...
  id: table-52-affected-persons-analysis
- type: table
  label: Stakeholder vs Engagement Method Table
  section: 5.3 Stakeholder Engagement Plan
  id: table-53-stakeholder-engagement-plan
- type: table
  label: '------------- vs ------------------- Table'
  section: 5.3 Stakeholder Engagement Plan
  id: table-53-stakeholder-engagement-plan
- type: table
  label: Barrier vs Mitigation Table
  section: 5.3 Stakeholder Engagement Plan
  id: table-53-stakeholder-engagement-plan
- type: table
  label: '--------- vs ------------ Table'
  ...
  id: table-53-stakeholder-engagement-plan
- type: table
  label: Date vs Stakeholder Table
  section: 5.3 Stakeholder Engagement Plan
  id: table-53-stakeholder-engagement-plan
- type: table
  label: '------ vs ------------- Table'
  ...
  id: table-53-stakeholder-engagement-plan
- type: table
  label: Failure Mode vs Cause Table
  section: 6.2 Impact Identification Techniques
  id: table-62-impact-identification-techniques
- type: table
  label: Similar System vs Harm Caused Table
  section: 6.2 Impact Identification Techniques
  id: table-62-impact-identification-techniques
- type: table
  label: '---------------- vs ------------- Table'
  ...
  id: table-62-impact-identification-techniques
- type: table
  label: 6.2 Impact Identification Techniques Table
  section: 6.2 Impact Identification Techniques
  id: table-62-impact-identification-techniques
- type: table
  label: Stakeholder vs Concerns Raised Table
  section: 6.2 Impact Identification Techniques
  id: table-62-impact-identification-techniques
- type: table
  label: '------------- vs ----------------- Table'
...
- type: table
  ...
  id: table-62-impact-identification-techniques
- type: table
  label: ID vs Impact Description Table
  section: 6.3 Compile Impact Inventory
  id: table-63-compile-impact-inventory
- type: table
  label: Level vs Description Table
  section: 7.1 Assessment Criteria
  id: table-71-assessment-criteria
- type: table
  label: Level vs Description Table
  section: 7.1 Assessment Criteria
  id: table-71-assessment-criteria
...
- type: table
  ...
  id: table-71-assessment-criteria
- type: table
  label: ID vs Impact Table
  section: 7.2 Impact Assessment Matrix
  id: table-72-impact-assessment-matrix
- type: table
  label: Score Range vs Risk Level Table
  section: 7.2 Impact Assessment Matrix
  id: table-72-impact-assessment-matrix
- type: table
  label: ID vs Benefit Description Table
  section: 7.4 Benefits Assessment
  id: table-74-benefits-assessment
- type: table
  label: Category vs Positive Score Table
  section: 7.5 Net Impact Analysis
  id: table-75-net-impact-analysis
- type: table
  label: Option vs Type Table
  section: 8.2 Mitigation Planning
  id: table-82-mitigation-planning
- type: table
  label: H/M/L vs H/M/L Table
  section: 8.2 Mitigation Planning
  id: table-82-mitigation-planning
- type: table
  label: 8.2 Mitigation Planning Table
  section: 8.2 Mitigation Planning
  id: table-82-mitigation-planning
- type: table
  label: Impact ID vs Mitigation Table
  section: 8.3 Consolidated Mitigation Plan
  id: table-83-consolidated-mitigation-plan
- type: table
  label: '----------- vs ------------ Table'
  section: 8.3 Consolidated Mitigation Plan
  id: table-83-consolidated-mitigation-plan
- type: table
  label: 8.3 Consolidated Mitigation Plan Table
  section: 8.3 Consolidated Mitigation Plan
  id: table-83-consolidated-mitigation-plan
- type: table
  label: 8.3 Consolidated Mitigation Plan Table
  ...
  id: table-83-consolidated-mitigation-plan
- type: table
  label: Impact ID vs Original Risk Table
  section: 8.4 Residual Risk Summary
  id: table-84-residual-risk-summary
- type: table
  label: '----------- vs --------------- Table'
  section: 8.4 Residual Risk Summary
  id: table-84-residual-risk-summary
- type: table
  label: 8.4 Residual Risk Summary Table
  section: 8.4 Residual Risk Summary
  id: table-84-residual-risk-summary
- type: table
  label: Risk vs Reason Not Mitigated Table
  section: 8.4 Residual Risk Summary
  id: table-84-residual-risk-summary
- type: table
  label: '------ vs --------------------- Table'
  ...
  id: table-84-residual-risk-summary
- type: table
  label: Condition vs Owner Table
  section: 9.2 Recommendation Development
  id: table-92-recommendation-development
- type: table
  label: '----------- vs ------- Table'
  section: 9.2 Recommendation Development
  id: table-92-recommendation-development
- type: table
  label: 9.2 Recommendation Development Table
  section: 9.2 Recommendation Development
  id: table-92-recommendation-development
- type: table
  label: Approver vs Role Table
  section: 9.2 Recommendation Development
  id: table-92-recommendation-development
- type: table
  label: '---------- vs ------ Table'
...
- type: table
  ...
  id: table-92-recommendation-development
- type: table
  label: Metric/Indicator vs Target Table
  section: 10.2 Monitoring Plan
  id: table-102-monitoring-plan
- type: table
  label: '------------------ vs -------- Table'
  section: 10.2 Monitoring Plan
  id: table-102-monitoring-plan
- type: table
  label: 10.2 Monitoring Plan Table
  section: 10.2 Monitoring Plan
  id: table-102-monitoring-plan
- type: table
  label: 10.2 Monitoring Plan Table
  ...
  id: table-102-monitoring-plan
- type: table
  label: Impact ID vs Monitoring Approach Table
  section: 10.2 Monitoring Plan
  id: table-102-monitoring-plan
- type: table
  label: '----------- vs -------------------- Table'
...
- type: table
  ...
  id: table-102-monitoring-plan
- type: table
  label: Review Type vs Frequency Table
  section: 10.2 Monitoring Plan
  id: table-102-monitoring-plan
- type: table
  label: Audience vs Information Table
  section: 10.3 Communication Plan
  id: table-103-communication-plan
- type: table
  label: Audience vs Information Table
  section: 10.3 Communication Plan
  id: table-103-communication-plan
- type: table
  label: Finding vs Risk Level Table
  section: 'Template 1: AIA Executive Summary'
  id: table-template-1-aia-executive-summary
- type: table
  label: '--------- vs ------------ Table'
  section: 'Template 1: AIA Executive Summary'
  id: table-template-1-aia-executive-summary
- type: table
  label: 'Template 1: AIA Executive Summary Table'
  section: 'Template 1: AIA Executive Summary'
  id: table-template-1-aia-executive-summary
- type: table
  label: Risk vs Accepted By Table
  section: 'Template 1: AIA Executive Summary'
  id: table-template-1-aia-executive-summary
- type: table
  label: '------ vs ------------- Table'
...
- type: table
  label: Assessment Depth vs Preparation Table
  section: Time Estimates
  id: table-time-estimates
- type: flowchart
...
- type: template
  ...
  section: Templates and Tools
  id: template-templates-and-tools
  template_link: /templates/templates-and-tools.md
- type: template
  label: 'Template 1: AIA Executive Summary'
  section: 'Template 1: AIA Executive Summary'
  id: template-template-1-aia-executive-summary
  template_link: /templates/template-1-aia-executive-summary.md
- type: template
  label: 'Template 2: Quick Risk Assessment Checklist'
  section: 'Template 2: Quick Risk Assessment Checklist'
  id: template-template-2-quick-risk-assessment-checklist
  template_link: /templates/template-2-quick-risk-assessment-checklist.md
- type: template
  label: 'Template 3: Stakeholder Interview Guide'
  section: 'Template 3: Stakeholder Interview Guide'
  id: template-template-3-stakeholder-interview-guide
  template_link: /templates/template-3-stakeholder-interview-guide.md
- type: list
  label: 7.1 Assessment Criteria
  section: 7.1 Assessment Criteria
  id: list-71-assessment-criteria
- type: list
  label: EU AI Act Requirements
  section: EU AI Act Requirements
  id: list-eu-ai-act-requirements
- type: list
  label: Canada AIDA Requirements
  section: Canada AIDA Requirements
  id: list-canada-aida-requirements
topic_fingerprint:
- machine learning
- deep learning
- neural network
...
- gdpr
word_count: 1198
processed_date: '2025-12-18T20:05:59.294Z'
---
