...
![AI Hallucinations – When Machines Confidently Lie]({{IMAGE_PLACEHOLDER_ai-hallucinations-when-machines-confidently-lie}})
...
- type: template
  label: 'Example: The Invented Ingredient'
  section: Filling Gaps Creatively
  id: template-filling-gaps-creatively
  template_link: /templates/example-the-invented-ingredient.md
- type: template
  label: 'Example: The Phantom CEO Quote'
  section: Academic Integrity
  id: template-academic-integrity
  template_link: /templates/example-the-phantom-ceo-quote.md
- type: template
  label: 'Example: The Verified Customer Service Bot'
  section: Use AI for Draft Generation, Not Final Output
  id: template-use-ai-for-draft-generation-not-final-output
  template_link: /templates/example-the-verified-customer-service-bot.md
- type: list
  label: Disclosure Requirements
  section: Disclosure Requirements
  id: list-disclosure-requirements
- type: list
  label: Acceptable Use Guidelines
  section: Acceptable Use Guidelines
  id: list-acceptable-use-guidelines
topic_fingerprint:
