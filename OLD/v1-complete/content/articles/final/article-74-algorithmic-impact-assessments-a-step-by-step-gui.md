...
![Article 74: Algorithmic Impact Assessments – A Step-by-Step Guide]({{IMAGE_PLACEHOLDER_article-74-algorithmic-impact-assessments-a-step-by-step-gui}})

---
title: 'Article 74: Algorithmic Impact Assessments – A Step-by-Step Guide'
tldr: ''
...
- type: table
  label: Assessment Type vs Focus Table
  section: AIAs vs. Other Assessments
  id: table-aias-vs-other-assessments
- type: table
  label: Risk Level vs Examples Table
  section: The Risk-Based Approach
  id: table-the-risk-based-approach
- type: table
  label: Category vs Description Table
  section: 'Step 2: Stakeholder Identification'
  id: table-step-2-stakeholder-identification
- type: table
  label: Impact vs Description Table
  section: 'Step 3: Impact Identification'
  id: table-step-3-impact-identification
- type: table
  label: Likelihood vs Severity Table
  section: 'Step 4: Impact Analysis'
  id: table-step-4-impact-analysis
- type: table
  label: Impact vs Likelihood Table
  section: 'Step 4: Impact Analysis'
  id: table-step-4-impact-analysis
- type: table
  label: Metric vs What It Measures Table
  section: 'Step 5: Fairness Deep Dive'
  id: table-step-5-fairness-deep-dive
- type: table
...
- type: table
  ...
  section: 'Step 6: Mitigation Planning'
  id: table-step-6-mitigation-planning
- type: table
  label: Risk Level vs Approval Required Table
  section: 'Step 7: Documentation and Approval'
  id: table-step-7-documentation-and-approval
- type: table
  label: Metric vs Frequency Table
  section: 'Step 8: Ongoing Monitoring'
  id: table-step-8-ongoing-monitoring
- type: flowchart
  label: 'Step 3: Impact Identification Process'
  section: 'Step 3: Impact Identification'
  id: flowchart-step-3-impact-identification
- type: flowchart
  label: 'Step 6: Mitigation Planning Process'
  section: 'Step 6: Mitigation Planning'
  id: flowchart-step-6-mitigation-planning
- type: flowchart
  label: 'Step 7: Documentation and Approval Process'
  section: 'Step 7: Documentation and Approval'
  id: flowchart-step-7-documentation-and-approval
- type: flowchart
...
- type: template
  label: 'Example:'
  section: 'Step 1: Define the Scope'
  id: template-step-1-define-the-scope
  template_link: /templates/example.md
- type: template
  label: 'Example:'
  section: 'Step 2: Stakeholder Identification'
  id: template-step-2-stakeholder-identification
  template_link: /templates/example.md
- type: template
  label: AIA Templates
  section: AIA Templates
  id: template-aia-templates
  template_link: /templates/aia-templates.md
- type: template
  label: Abbreviated AIA Template (Low-Risk Systems)
  section: Abbreviated AIA Template (Low-Risk Systems)
  id: template-abbreviated-aia-template-low-risk-systems
  template_link: /templates/abbreviated-aia-template-low-risk-systems.md
- type: template
  label: Standard AIA Template (Medium-Risk Systems)
  section: Standard AIA Template (Medium-Risk Systems)
  id: template-standard-aia-template-medium-risk-systems
  template_link: /templates/standard-aia-template-medium-risk-systems.md
- type: list
  label: Legal Requirements
  section: Legal Requirements
  id: list-legal-requirements
- type: list
  label: Best Practice Triggers
  section: Best Practice Triggers
  id: list-best-practice-triggers
topic_fingerprint:
- impact assessment
- fairness
- transparency
...
- nyc local law 144
word_count: 1763
processed_date: '2025-12-18T02:16:44.256Z'
---
...
<!-- component:table:table-aias-vs-other-assessments -->
|----------------|-------|--------|
...
<!-- component:list:list-legal-requirements -->
...
<!-- component:list:list-best-practice-triggers -->
...
<!-- component:table:table-the-risk-based-approach -->
|------------|----------|------------------|
...
<!-- component:template:template-step-1-define-the-scope -->
**Example:**
...
<!-- component:table:table-step-2-stakeholder-identification -->
|----------|-------------|----------|
...
<!-- component:template:template-step-2-stakeholder-identification -->
**Example:**
...
<!-- component:flowchart:flowchart-step-3-impact-identification -->
...
<!-- component:table:table-step-3-impact-identification -->
|--------|-------------|----------------|
...
<!-- component:table:table-step-4-impact-analysis -->
|------------|----------|------------|
| High | High | Critical |
| High | Medium | High |
| Medium | High | High |
...
<!-- component:table:table-step-5-fairness-deep-dive -->
|--------|------------------|-------------------|
...
<!-- component:flowchart:flowchart-step-6-mitigation-planning -->
...
<!-- component:table:table-step-6-mitigation-planning -->
|------|------------|----------|-------|
...
<!-- component:table:table-step-7-documentation-and-approval -->
|------------|-------------------|
...
<!-- component:table:table-step-8-ongoing-monitoring -->
|--------|-----------|-----------|-------------------|
...
<!-- component:template:template-aia-templates -->

## AIA Templates

<!-- component:template:template-abbreviated-aia-template-low-risk-systems -->
...
<!-- component:template:template-standard-aia-template-medium-risk-systems -->
