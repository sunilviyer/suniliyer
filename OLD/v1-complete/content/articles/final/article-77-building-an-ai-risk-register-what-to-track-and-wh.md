...
![Article 77: Building an AI Risk Register – What to Track and Why]({{IMAGE_PLACEHOLDER_article-77-building-an-ai-risk-register-what-to-track-and-wh}})
...
- type: image_prompt
  ...
  prompt: balanced composition showing risk and safety elements, warning symbols with
    ...
    article header
- type: table
  label: Field vs Purpose Table
  section: Essential Fields
  id: table-essential-fields
- type: table
  label: Field vs Purpose Table
  section: Enhanced Fields for Mature Programs
  id: table-enhanced-fields-for-mature-programs
- type: table
  label: Rating vs Definition Table
  section: 'Step 3: Establish Your Scales'
  id: table-step-3-establish-your-scales
- type: table
  label: Rating vs Financial Table
  section: 'Step 3: Establish Your Scales'
  id: table-step-3-establish-your-scales
- type: table
  label: Low Impact vs Medium Impact Table
  section: 'Step 3: Establish Your Scales'
  id: table-step-3-establish-your-scales
- type: table
  label: Trigger vs Action Table
  section: Triggers for Updates
  id: table-triggers-for-updates
- type: flowchart
...
- type: template
  ...
  template_link: /templates/step-2-create-your-template.md
- type: template
  label: GRC Platforms
  section: GRC Platforms
  id: template-grc-platforms
  template_link: /templates/grc-platforms.md
- type: template
  label: Specialized AI Governance Platforms
  section: Specialized AI Governance Platforms
  id: template-specialized-ai-governance-platforms
  template_link: /templates/specialized-ai-governance-platforms.md
topic_fingerprint:
- explainability
- fairness
- audit
...
- nist
word_count: 2036
processed_date: '2025-12-18T02:16:48.405Z'
---
