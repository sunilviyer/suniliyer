...
---
title: 'Article 123: AI Conformity Assessment – Meeting EU AI Act Requirements'
tldr: ''
...
- type: image_prompt
  ...
  prompt: audit checklist, magnifying glass over AI system, accountability chain visualization,
    checklist, magnifying glass, inspection tools, quality badges, European Union
    flag colors, EU stars, professional illustration, modern flat design style, clean
    and authoritative, high quality, blue and gray color scheme with accent colors,
    suitable for professional article header
- type: checklist
  label: Assessment Readiness Checklist
  section: Assessment Readiness Checklist
  id: checklist-assessment-readiness-checklist
- type: table
  label: Risk Level vs Examples Table
  section: The Risk-Based Framework
  id: table-the-risk-based-framework
- type: table
  label: Situation vs Required Pathway Table
  section: 'Step 3: Choose Assessment Pathway'
  id: table-step-3-choose-assessment-pathway
- type: table
  label: Category vs Timeline Table
  section: When Requirements Apply
  id: table-when-requirements-apply
- type: table
  label: Activity vs Estimated Cost Table
  section: Cost Estimates
  id: table-cost-estimates
- type: table
  label: Violation vs Maximum Penalty Table
  section: Enforcement and Penalties
  id: table-enforcement-and-penalties
- type: flowchart
  label: 'Step 2: Classify Your System Process'
  section: 'Step 2: Classify Your System'
  id: flowchart-step-2-classify-your-system
- type: flowchart
  label: 'Step 5: Conduct Assessment Process'
  section: 'Step 5: Conduct Assessment'
  id: flowchart-step-5-conduct-assessment
- type: flowchart
...
- type: template
  label: 'Article 123: AI Conformity Assessment – Meeting EU AI Act Requirements'
  section: 'Article 123: AI Conformity Assessment – Meeting EU AI Act Requirements'
  id: template-article-123-ai-conformity-assessment-meeting-eu-ai-act-requirements
  template_link: /templates/article-123-ai-conformity-assessment-meeting-eu-ai-act-requirements.md
- type: template
  label: What Is Conformity Assessment?
  section: What Is Conformity Assessment?
  id: template-what-is-conformity-assessment
  template_link: /templates/what-is-conformity-assessment.md
- type: template
  label: Why Conformity Assessment Matters
  section: Why Conformity Assessment Matters
  id: template-why-conformity-assessment-matters
  template_link: /templates/why-conformity-assessment-matters.md
- type: template
  label: When Is Conformity Assessment Required?
  section: When Is Conformity Assessment Required?
  id: template-when-is-conformity-assessment-required
  template_link: /templates/when-is-conformity-assessment-required.md
- type: template
  label: 'Example:'
  section: Products Covered by Existing Legislation (Annex I)
  id: template-products-covered-by-existing-legislation-annex-i
  template_link: /templates/example.md
- type: template
  label: 'Example:'
  section: Notified Bodies Explained
  id: template-notified-bodies-explained
  template_link: /templates/example.md
- type: template
  label: 'The Conformity Assessment Process: Step by Step'
  section: 'The Conformity Assessment Process: Step by Step'
  id: template-the-conformity-assessment-process-step-by-step
  template_link: /templates/the-conformity-assessment-process-step-by-step.md
- type: template
  label: 'Step 6: Create EU Declaration of Conformity'
  section: 'Step 6: Create EU Declaration of Conformity'
  id: template-step-6-create-eu-declaration-of-conformity
  template_link: /templates/step-6-create-eu-declaration-of-conformity.md
- type: template
  label: How Long Does Conformity Assessment Take?
  section: How Long Does Conformity Assessment Take?
  id: template-how-long-does-conformity-assessment-take
  template_link: /templates/how-long-does-conformity-assessment-take.md
- type: template
  label: Building Conformity Assessment into the AI Lifecycle
  section: Building Conformity Assessment into the AI Lifecycle
  id: template-building-conformity-assessment-into-the-ai-lifecycle
  template_link: /templates/building-conformity-assessment-into-the-ai-lifecycle.md
- type: list
  label: 'Article 123: AI Conformity Assessment – Meeting EU AI Act Requirements'
  section: 'Article 123: AI Conformity Assessment – Meeting EU AI Act Requirements'
  id: list-article-123-ai-conformity-assessment-meeting-eu-ai-act-requirements
- type: list
  label: What Requirements Must Be Met?
  section: What Requirements Must Be Met?
  id: list-what-requirements-must-be-met
- type: list
...
- type: list
  label: 'Requirement 2: Data Governance (Article 10)'
  section: 'Requirement 2: Data Governance (Article 10)'
  id: list-requirement-2-data-governance-article-10
- type: list
...
- type: list
  label: 'Requirement 4: Record-Keeping (Article 12)'
  section: 'Requirement 4: Record-Keeping (Article 12)'
  id: list-requirement-4-record-keeping-article-12
- type: list
  label: 'Requirement 5: Transparency (Article 13)'
  section: 'Requirement 5: Transparency (Article 13)'
  id: list-requirement-5-transparency-article-13
- type: list
...
- type: list
  label: 'Requirement 7: Accuracy, Robustness, Cybersecurity (Article 15)'
  section: 'Requirement 7: Accuracy, Robustness, Cybersecurity (Article 15)'
  id: list-requirement-7-accuracy-robustness-cybersecurity-article-15
- type: list
  label: When Requirements Apply
  section: When Requirements Apply
  id: list-when-requirements-apply
topic_fingerprint:
- foundation model
- audit
- transparency
...
- nist
word_count: 2639
processed_date: '2025-12-18T20:05:11.439Z'
---

<!-- component:template:template-what-is-conformity-assessment -->
...
<!-- component:template:template-why-conformity-assessment-matters -->
...
<!-- component:template:template-when-is-conformity-assessment-required -->
...
<!-- component:table:table-the-risk-based-framework -->
|------------|----------|-------------------------------|
...
<!-- component:template:template-products-covered-by-existing-legislation-annex-i -->
...
<!-- component:template:template-notified-bodies-explained -->
...
<!-- component:list:list-what-requirements-must-be-met -->
...
<!-- component:list:list-requirement-2-data-governance-article-10 -->
...
<!-- component:list:list-requirement-4-record-keeping-article-12 -->
...
<!-- component:list:list-requirement-5-transparency-article-13 -->
...
<!-- component:list:list-requirement-7-accuracy-robustness-cybersecurity-article-15 -->
...
<!-- component:template:template-the-conformity-assessment-process-step-by-step -->
...
<!-- component:flowchart:flowchart-step-2-classify-your-system -->
...
<!-- component:table:table-step-3-choose-assessment-pathway -->
|-----------|------------------|
...
**For self-assessment:**
<!-- component:flowchart:flowchart-step-5-conduct-assessment -->
...
<!-- component:template:template-step-6-create-eu-declaration-of-conformity -->
...
<!-- component:list:list-when-requirements-apply -->

### When Requirements Apply

| Category | Timeline |
<!-- component:table:table-when-requirements-apply -->
|----------|----------|
...
<!-- component:template:template-how-long-does-conformity-assessment-take -->
...
<!-- component:table:table-cost-estimates -->
|----------|---------------|
...
**Governance:**
<!-- component:checklist:checklist-assessment-readiness-checklist -->
...
<!-- component:template:template-building-conformity-assessment-into-the-ai-lifecycle -->
...
<!-- component:table:table-enforcement-and-penalties -->
|-----------|----------------|
