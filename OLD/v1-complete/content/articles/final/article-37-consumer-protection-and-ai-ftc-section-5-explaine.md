...
---
title: 'Article 37: Consumer Protection and AI – FTC Section 5 Explained'
tldr: ''
...
- type: image_prompt
  ...
  prompt: educational diagram showing AI concepts, neural network visualization, technology
    ...
    article header
- type: flowchart
  label: 'Deception: The Three-Part Test Process'
  section: 'Deception: The Three-Part Test'
  id: flowchart-deception-the-three-part-test
- type: flowchart
  label: 'Unfairness: The Three-Part Test Process'
  section: 'Unfairness: The Three-Part Test'
  id: flowchart-unfairness-the-three-part-test
- type: flowchart
  label: The Algorithmic Disgorgement Remedy Process
  section: The Algorithmic Disgorgement Remedy
  id: flowchart-the-algorithmic-disgorgement-remedy
- type: flowchart
...
- type: template
  label: 'Example:'
  section: 'Deception: The Three-Part Test'
  id: template-deception-the-three-part-test
  template_link: /templates/example.md
- type: template
  label: 'Example:'
  section: 'Unfairness: The Three-Part Test'
  id: template-unfairness-the-three-part-test
  template_link: /templates/example.md
- type: template
  label: 'Example:'
  section: 'AI Washing: False Claims About AI Capabilities'
  id: template-ai-washing-false-claims-about-ai-capabilities
  template_link: /templates/example.md
- type: template
  label: 'Example:'
  section: Discriminatory AI Outcomes
  id: template-discriminatory-ai-outcomes
  template_link: /templates/example.md
- type: template
  label: 'Example:'
  section: Data Collection for AI Training
  id: template-data-collection-for-ai-training
  template_link: /templates/example.md
- type: template
  label: 'Example:'
  section: The Algorithmic Disgorgement Remedy
  id: template-the-algorithmic-disgorgement-remedy
  template_link: /templates/example.md
topic_fingerprint:
- machine learning
- neural network
...
- meta
word_count: 3155
processed_date: '2025-12-18T20:06:17.528Z'
---
...
<!-- component:flowchart:flowchart-deception-the-three-part-test -->
...
<!-- component:template:template-deception-the-three-part-test -->
...
<!-- component:template:template-unfairness-the-three-part-test -->
...
<!-- component:template:template-ai-washing-false-claims-about-ai-capabilities -->
...
<!-- component:template:template-discriminatory-ai-outcomes -->
...
<!-- component:template:template-data-collection-for-ai-training -->
...
<!-- component:flowchart:flowchart-the-algorithmic-disgorgement-remedy -->
...
<!-- component:template:template-the-algorithmic-disgorgement-remedy -->
