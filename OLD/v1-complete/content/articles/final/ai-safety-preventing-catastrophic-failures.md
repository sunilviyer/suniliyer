...
- type: image_prompt
  ...
  prompt: balanced composition showing risk and safety elements, warning symbols with
    ...
    article header
- type: flowchart
  label: Safety Culture Process
  section: Safety Culture
  id: flowchart-safety-culture
- type: flowchart
...
- type: template
  label: 'Example: The Self-Driving Car That Couldn''t See'
  section: Adversarial Attacks
  id: template-adversarial-attacks
  template_link: /templates/example-the-self-driving-car-that-couldnt-see.md
- type: template
  label: Information Ecosystem Damage
  section: Information Ecosystem Damage
  id: template-information-ecosystem-damage
  template_link: /templates/information-ecosystem-damage.md
- type: template
  label: 'Example: The Power Grid That Optimized Itself Into a Corner'
  section: Autonomy and Control Failures
  id: template-autonomy-and-control-failures
  template_link: /templates/example-the-power-grid-that-optimized-itself-into-a-corner.md
- type: template
  label: 'Example: The Safety-First Deployment'
  section: Safety Culture
  id: template-safety-culture
  template_link: /templates/example-the-safety-first-deployment.md
- type: template
...
- stanford
word_count: 3428
processed_date: '2025-12-18T02:17:52.689Z'
---
...
<!-- component:template:template-adversarial-attacks -->
