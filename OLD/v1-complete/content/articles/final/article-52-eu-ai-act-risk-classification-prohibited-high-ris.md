...
![Article 52: EU AI Act Risk Classification – Prohibited, High-Risk, and Beyond]({{IMAGE_PLACEHOLDER_article-52-eu-ai-act-risk-classification-prohibited-high-ris}})

---
title: 'Article 52: EU AI Act Risk Classification – Prohibited, High-Risk, and Beyond'
tldr: ''
...
- type: image_prompt
  ...
  prompt: balanced composition showing risk and safety elements, warning symbols with
    ...
    nets, European Union flag colors, EU stars, professional illustration, modern
...
- type: table
  label: Area vs Examples Table
  section: What Makes AI "High-Risk"?
  id: table-what-makes-ai-high-risk
- type: table
  label: AI System vs Classification Table
  section: Real-World Classification Examples
  id: table-real-world-classification-examples
- type: flowchart
  label: What High-Risk Providers Must Do Process
  section: What High-Risk Providers Must Do
  id: flowchart-what-high-risk-providers-must-do
- type: flowchart
  label: Sources Process
  section: Sources
  id: flowchart-sources
- type: list
  label: The Transparency Requirement
  section: The Transparency Requirement
  id: list-the-transparency-requirement
topic_fingerprint:
- foundation model
- transparency
- risk assessment
...
- stanford
word_count: 2088
processed_date: '2025-12-18T20:06:39.416Z'
---
...
| Area | Examples |
<!-- component:table:table-what-makes-ai-high-risk -->
|------|----------|
...
<!-- component:flowchart:flowchart-what-high-risk-providers-must-do -->
...
<!-- component:list:list-the-transparency-requirement -->
...
<!-- component:table:table-real-world-classification-examples -->
|-----------|---------------|-----------|
