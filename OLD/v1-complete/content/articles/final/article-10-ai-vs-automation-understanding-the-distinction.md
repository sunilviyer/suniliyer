...
![Article 10: AI vs. Automation – Understanding the Distinction]({{IMAGE_PLACEHOLDER_article-10-ai-vs-automation-understanding-the-distinction}})

---
title: 'Article 10: AI vs. Automation – Understanding the Distinction'
...
- type: table
  label: System vs What It Does Table
  section: What Is Automation?
  id: table-what-is-automation
- type: table
  label: System vs What It Does Table
  section: What Is Artificial Intelligence?
  id: table-what-is-artificial-intelligence
- type: table
  label: Aspect vs Automation Table
  section: The Crucial Difference
  id: table-the-crucial-difference
- type: table
  label: Component vs Type Table
  section: Hybrid Systems
  id: table-hybrid-systems
- type: table
  label: Component vs Type Table
  section: Hybrid Systems
  id: table-hybrid-systems
- type: table
  label: Capability vs Pure RPA Table
  section: 'RPA + AI: "Intelligent Automation"'
  id: table-rpa-ai-intelligent-automation
- type: table
  label: Aspect vs RPA Governance Table
  section: RPA Governance vs. AI Governance
  id: table-rpa-governance-vs-ai-governance
- type: table
  label: Risk vs Description Table
  section: Different Risk Profiles
  id: table-different-risk-profiles
- type: table
  label: Risk vs Description Table
  section: Different Risk Profiles
  id: table-different-risk-profiles
- type: table
  label: Stakeholder vs Expects from "AI" Table
  section: Different Stakeholder Expectations
  id: table-different-stakeholder-expectations
- type: table
  label: Often Called "AI" vs Actually Is Table
  section: Common Misclassifications
  id: table-common-misclassifications
- type: table
  label: Often Called "Automation" vs Actually Has AI Table
  section: Common Misclassifications
  id: table-common-misclassifications
- type: table
  label: System vs Classification Table
  section: Inventory Classification
  id: table-inventory-classification
- type: table
  label: Question vs Pure Automation Answer Table
  section: How to Cut Through the Marketing
  id: table-how-to-cut-through-the-marketing
- type: flowchart
  label: The Crucial Difference Process
  section: The Crucial Difference
  id: flowchart-the-crucial-difference
- type: flowchart
  label: Classification Questions Process
  section: Classification Questions
  id: flowchart-classification-questions
- type: template
  label: 'Example: Credit Card Fraud Detection'
  section: Hybrid Systems
  id: template-hybrid-systems
  template_link: /templates/example-credit-card-fraud-detection.md
- type: template
  label: 'Example: Customer Service Chatbot'
  section: Hybrid Systems
  id: template-hybrid-systems
  template_link: /templates/example-customer-service-chatbot.md
topic_fingerprint:
- machine learning
- neural network
- deep learning
...
- nyc local law 144
word_count: 2502
processed_date: '2025-12-18T20:04:34.499Z'
---
...
<!-- component:template:template-hybrid-systems -->
**Example: Credit Card Fraud Detection**

| Component | Type | Function |
<!-- component:table:table-hybrid-systems -->
|-----------|------|----------|
