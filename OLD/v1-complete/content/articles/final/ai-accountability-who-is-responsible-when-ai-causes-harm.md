...
![AI Accountability – Who Is Responsible When AI Causes Harm]({{IMAGE_PLACEHOLDER_ai-accountability-who-is-responsible-when-ai-causes-harm}})
...
- type: template
  label: 'Example: The Distributed Failure'
  section: The Accountability Gap
  id: template-the-accountability-gap
  template_link: /templates/example-the-distributed-failure.md
- type: template
  label: 'Example: The Liability Puzzle'
  section: Regulatory Enforcement
  id: template-regulatory-enforcement
  template_link: /templates/example-the-liability-puzzle.md
- type: template
  label: 'Example: The Accountability Framework'
  section: Training and Awareness
  id: template-training-and-awareness
  template_link: /templates/example-the-accountability-framework.md
- type: template
  label: 'Example: The Incident Response'
  section: External Accountability
  id: template-external-accountability
  template_link: /templates/example-the-incident-response.md
- type: list
  label: Documentation Requirements
  section: Documentation Requirements
  id: list-documentation-requirements
- type: list
  label: The Principle of No Accountability, No Deployment
  section: The Principle of No Accountability, No Deployment
  id: list-the-principle-of-no-accountability-no-deployment
topic_fingerprint:
- accountability
- oversight
- audit
...
- uber
word_count: 3214
processed_date: '2025-12-18T20:04:20.925Z'
---
