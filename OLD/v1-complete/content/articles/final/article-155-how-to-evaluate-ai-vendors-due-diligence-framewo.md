...
![Article 155: How to Evaluate AI Vendors — Due Diligence Framework]({{IMAGE_PLACEHOLDER_article-155-how-to-evaluate-ai-vendors-due-diligence-framewo}})

---
title: 'Article 155: How to Evaluate AI Vendors — Due Diligence Framework'
...
- type: image_prompt
  ...
  prompt: educational diagram showing AI concepts, neural network visualization, technology
    icons, structured framework diagram, building blocks, architectural blueprint,
    ...
    article header
- type: checklist
  label: 'Quick Reference: Vendor Evaluation Checklist'
  section: 'Quick Reference: Vendor Evaluation Checklist'
  id: checklist-quick-reference-vendor-evaluation-checklist
- type: table
  label: Traditional Software vs AI/ML Systems Table
  section: The Stakes Are Higher with AI
  id: table-the-stakes-are-higher-with-ai
- type: table
  label: Risk Category vs Examples Table
  section: Risks of Inadequate Vendor Evaluation
  id: table-risks-of-inadequate-vendor-evaluation
- type: table
  label: Metric vs Target Table
  section: 1.1 Business Requirements
  id: table-11-business-requirements
- type: table
  label: '-------- vs -------- Table'
  section: 1.1 Business Requirements
  id: table-11-business-requirements
- type: table
  label: 1.1 Business Requirements Table
  section: 1.1 Business Requirements
  id: table-11-business-requirements
- type: table
  label: 1.1 Business Requirements Table
  ...
  id: table-11-business-requirements
- type: table
  label: Requirement vs Priority Table
  section: 1.2 Technical Requirements
  id: table-12-technical-requirements
- type: table
  label: Approver vs Role Table
  section: 1.3 Governance Requirements
  id: table-13-governance-requirements
- type: table
  label: '---------- vs ------ Table'
  section: 1.3 Governance Requirements
  id: table-13-governance-requirements
- type: table
  label: 1.3 Governance Requirements Table
  section: 1.3 Governance Requirements
  id: table-13-governance-requirements
- type: table
  label: Dimension vs Weight Table
  section: 2.1 Evaluation Dimensions
  id: table-21-evaluation-dimensions
- type: table
  label: Score vs Meaning Table
  section: 2.2 Scoring Methodology
  id: table-22-scoring-methodology
- type: table
  label: Role vs Name Table
  section: 'Step 3: Assemble Evaluation Team'
  id: table-step-3-assemble-evaluation-team
- type: table
  label: Role vs Name Table
  section: 'Step 3: Assemble Evaluation Team'
  id: table-step-3-assemble-evaluation-team
- type: table
  label: Vendor vs Product Table
  section: 4.1 Identify Potential Vendors
  id: table-41-identify-potential-vendors
- type: table
  label: 4.1 Identify Potential Vendors Table
  section: 4.1 Identify Potential Vendors
  id: table-41-identify-potential-vendors
- type: table
  label: 4.1 Identify Potential Vendors Table
...
- type: table
  ...
  id: table-41-identify-potential-vendors
- type: table
  label: Requirement vs Met? Table
  section: 'Step 5: Technical Evaluation'
  id: table-step-5-technical-evaluation
- type: table
  label: Y/N/P vs /5 Table
  section: 'Step 5: Technical Evaluation'
  id: table-step-5-technical-evaluation
- type: table
  label: 'Step 5: Technical Evaluation Table'
  section: 'Step 5: Technical Evaluation'
  id: table-step-5-technical-evaluation
- type: table
  label: Metric vs Requirement Table
  section: 'Step 5: Technical Evaluation'
  id: table-step-5-technical-evaluation
- type: table
  label: Document vs Available? Table
  section: 'Step 6: AI Governance and Ethics Evaluation'
  id: table-step-6-ai-governance-and-ethics-evaluation
- type: table
  label: Certification vs Held? Table
  section: 'Step 7: Security Evaluation'
  id: table-step-7-security-evaluation
- type: table
  label: Regulation vs Compliant? Table
  section: 'Step 8: Privacy and Data Protection Evaluation'
  id: table-step-8-privacy-and-data-protection-evaluation
- type: table
  label: Company vs Industry Table
  section: 'Step 9: Vendor Stability and Support Evaluation'
  id: table-step-9-vendor-stability-and-support-evaluation
- type: table
  label: '--------- vs ---------- Table'
  section: 'Step 9: Vendor Stability and Support Evaluation'
  id: table-step-9-vendor-stability-and-support-evaluation
- type: table
  label: 'Step 9: Vendor Stability and Support Evaluation Table'
  section: 'Step 9: Vendor Stability and Support Evaluation'
  id: table-step-9-vendor-stability-and-support-evaluation
- type: table
  label: 'Step 9: Vendor Stability and Support Evaluation Table'
  ...
  id: table-step-9-vendor-stability-and-support-evaluation
- type: table
  label: Component vs Unit Table
  section: 'Step 10: Commercial Evaluation'
  id: table-step-10-commercial-evaluation
- type: table
  label: '----------- vs ------ Table'
  section: 'Step 10: Commercial Evaluation'
  id: table-step-10-commercial-evaluation
- type: table
  label: 'Step 10: Commercial Evaluation Table'
  section: 'Step 10: Commercial Evaluation'
  id: table-step-10-commercial-evaluation
- type: table
  label: 'Step 10: Commercial Evaluation Table'
  ...
  id: table-step-10-commercial-evaluation
- type: table
  label: Period vs Volume Table
  section: 'Step 10: Commercial Evaluation'
  id: table-step-10-commercial-evaluation
- type: table
  label: Term vs Vendor Position Table
  section: 'Step 10: Commercial Evaluation'
  id: table-step-10-commercial-evaluation
- type: table
  label: Item vs Cost Table
  section: 'Step 10: Commercial Evaluation'
  id: table-step-10-commercial-evaluation
- type: table
  label: Item vs Cost Table
  ...
  id: table-step-10-commercial-evaluation
- type: table
  label: Test vs Objective Table
  section: 'Step 11: Proof of Concept'
  id: table-step-11-proof-of-concept
- type: table
  label: '------ vs ----------- Table'
  section: 'Step 11: Proof of Concept'
  id: table-step-11-proof-of-concept
- type: table
  label: 'Step 11: Proof of Concept Table'
  section: 'Step 11: Proof of Concept'
  id: table-step-11-proof-of-concept
- type: table
  label: 'Step 11: Proof of Concept Table'
...
- type: table
  label: Dimension vs Weight Table
  section: 'Step 13: Final Selection'
  id: table-step-13-final-selection
- type: table
  label: Factor vs Vendor A Table
  section: 'Step 13: Final Selection'
  id: table-step-13-final-selection
- type: table
  label: Risk vs Vendor A Table
  section: 'Step 13: Final Selection'
  id: table-step-13-final-selection
- type: table
  label: Approver vs Decision Table
  section: 'Step 13: Final Selection'
  id: table-step-13-final-selection
- type: table
  label: '---------- vs ---------- Table'
  ...
  id: table-step-13-final-selection
- type: table
  label: 'Step 13: Final Selection Table'
  section: 'Step 13: Final Selection'
  id: table-step-13-final-selection
- type: table
  label: Metric vs Frequency Table
  section: 'Step 15: Ongoing Vendor Management'
  id: table-step-15-ongoing-vendor-management
- type: table
  label: Criterion vs Rating Table
  section: 'Step 15: Ongoing Vendor Management'
  id: table-step-15-ongoing-vendor-management
- type: flowchart
...
- type: list
  label: 'Step 1: Define Your Requirements'
  section: 'Step 1: Define Your Requirements'
  id: list-step-1-define-your-requirements
- type: list
  label: 1.1 Business Requirements
  section: 1.1 Business Requirements
  id: list-11-business-requirements
- type: list
  label: 1.2 Technical Requirements
  section: 1.2 Technical Requirements
  id: list-12-technical-requirements
- type: list
  label: 1.3 Governance Requirements
  section: 1.3 Governance Requirements
  id: list-13-governance-requirements
- type: list
  label: 'Step 2: Establish Evaluation Criteria'
  section: 'Step 2: Establish Evaluation Criteria'
  id: list-step-2-establish-evaluation-criteria
topic_fingerprint:
- audit
- fairness
- explainability
...
- runway
word_count: 473
processed_date: '2025-12-18T20:06:10.452Z'
---
