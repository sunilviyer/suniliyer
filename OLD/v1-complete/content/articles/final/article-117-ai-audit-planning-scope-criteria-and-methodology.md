...
---
title: 'Article 117: AI Audit Planning – Scope, Criteria, and Methodology'
tldr: ''
...
- type: checklist
  label: Developing Your Criteria Checklist
  section: Developing Your Criteria Checklist
  id: checklist-developing-your-criteria-checklist
- type: table
  label: Area vs What It Covers Table
  section: Elements of Audit Scope
  id: table-elements-of-audit-scope
- type: table
  label: Regulation vs Key Requirements Table
  section: Types of Audit Criteria
  id: table-types-of-audit-criteria
- type: table
...
- type: table
  ...
  id: table-types-of-audit-criteria
- type: table
  label: Category vs Criterion Table
  section: 'Example: Criteria for a Credit Scoring AI Audit'
  id: table-example-criteria-for-a-credit-scoring-ai-audit
- type: table
  label: Role vs Responsibilities Table
  section: Core Methodological Components
  id: table-core-methodological-components
- type: table
  label: Technique vs What It Involves Table
  section: Core Methodological Components
  id: table-core-methodological-components
- type: table
  label: Analysis Type vs Purpose Table
  section: Core Methodological Components
  id: table-core-methodological-components
- type: table
  label: Phase vs Duration Table
  section: Core Methodological Components
  id: table-core-methodological-components
- type: table
  label: Category vs Criterion Table
  section: 'Practical Example: Complete Audit Plan for a Healthcare AI'
  id: table-practical-example-complete-audit-plan-for-a-healthcare-ai
- type: flowchart
  label: Building Your Audit Plan Process
  section: Building Your Audit Plan
  id: flowchart-building-your-audit-plan
- type: flowchart
  label: Sources and Further Reading Process
  section: Sources and Further Reading
  id: flowchart-sources-and-further-reading
- type: template
  label: 'Example: Testing a Loan Approval AI'
  section: Core Methodological Components
  id: template-core-methodological-components
  template_link: /templates/example-testing-a-loan-approval-ai.md
- type: list
  label: 'Article 117: AI Audit Planning – Scope, Criteria, and Methodology'
  section: 'Article 117: AI Audit Planning – Scope, Criteria, and Methodology'
  id: list-article-117-ai-audit-planning-scope-criteria-and-methodology
- type: list
  label: 'Pillar 2: Establishing Audit Criteria'
  section: 'Pillar 2: Establishing Audit Criteria'
  id: list-pillar-2-establishing-audit-criteria
- type: list
  label: What Are Audit Criteria?
  section: What Are Audit Criteria?
  id: list-what-are-audit-criteria
- type: list
  label: Types of Audit Criteria
  section: Types of Audit Criteria
  id: list-types-of-audit-criteria
- type: list
  label: Developing Your Criteria Checklist
  section: Developing Your Criteria Checklist
  id: list-developing-your-criteria-checklist
- type: list
  label: 'Example: Criteria for a Credit Scoring AI Audit'
  section: 'Example: Criteria for a Credit Scoring AI Audit'
  id: list-example-criteria-for-a-credit-scoring-ai-audit
topic_fingerprint:
- audit
- fairness
- transparency
...
- nyc local law 144
word_count: 2586
processed_date: '2025-12-18T20:05:00.435Z'
---
...
| Area | What It Covers |
<!-- component:table:table-elements-of-audit-scope -->
|------|----------------|
...
<!-- component:list:list-pillar-2-establishing-audit-criteria -->

## Pillar 2: Establishing Audit Criteria

<!-- component:list:list-what-are-audit-criteria -->
...
<!-- component:list:list-types-of-audit-criteria -->
...
<!-- component:table:table-types-of-audit-criteria -->
|------------|-----------------|
...
<!-- component:list:list-developing-your-criteria-checklist -->
...
<!-- component:list:list-example-criteria-for-a-credit-scoring-ai-audit -->

### Example: Criteria for a Credit Scoring AI Audit

| Category | Criterion | Source | Threshold |
<!-- component:table:table-example-criteria-for-a-credit-scoring-ai-audit -->
|----------|-----------|--------|-----------|
...
<!-- component:table:table-core-methodological-components -->
|------|-----------------|
...
<!-- component:template:template-core-methodological-components -->
...
<!-- component:flowchart:flowchart-building-your-audit-plan -->
...
<!-- component:table:table-practical-example-complete-audit-plan-for-a-healthcare-ai -->
|----------|-----------|--------|
