...
- type: image_prompt
  ...
  prompt: organizational structure, implementation roadmap, strategic planning elements, structured framework diagram, building blocks, architectural blueprint, professional illustration, modern flat design style, clean and authoritative, high quality, blue and gray color scheme with accent colors, suitable for professional article header
  label: Article Hero Image
  section: Header
  id: image-prompt-hero
...
- type: template
  label: 'Example: The Governance Gap'
  section: Governance vs. Risk Management
  id: template-governance-vs-risk-management
  template_link: /templates/example-the-governance-gap.md
- type: template
  label: 'Example: Framework Selection'
  section: OECD AI Principles
  id: template-oecd-ai-principles
  template_link: /templates/example-framework-selection.md
- type: template
  label: 'Example: Phased Implementation'
  section: 'Step 6: Continuous Improvement'
  id: template-step-6-continuous-improvement
  template_link: /templates/example-phased-implementation.md
- type: list
...
- type: list
  ...
  section: OECD AI Principles
  id: list-oecd-ai-principles
- type: list
  label: 1. Principles and Values
  section: 1. Principles and Values
  id: list-1-principles-and-values
- type: list
  label: 'Challenge: "Requirements keep changing"'
  section: 'Challenge: "Requirements keep changing"'
  id: list-challenge-requirements-keep-changing
topic_fingerprint:
- machine learning
- risk assessment
- oversight
...
- nist
word_count: 2944
processed_date: '2025-12-18T20:04:24.006Z'
---
...
![AI Governance Frameworks – Building Your Organization's Approach]({{IMAGE_PLACEHOLDER_ai-governance-frameworks-building-your-organizations-approac}})
...
### Section 1: Defining AI - The OECD and ISO/IEC Frameworks
...
### Section 2: AI as Socio-Technical Systems
...
### Section 3: The OECD Classification Framework

* **Key points to cover:**
   * The OECD Framework for Classification of AI Systems (2022) helps policymakers characterize AI systems for governance purposes
   * Five classification dimensions:
     1. **People & Planet**: Who is affected? What are impacts on human rights, wellbeing, environment?
     2. **Economic Context**: What sector? Who deploys it? What's the business model?
     3. **Data & Input**: What data does it use? How is it collected? What's the quality?
     4. **AI Model**: What type of model? How transparent? How robust?
     5. **Task & Output**: What does it do? What decisions does it make? Can users opt out?
   * The framework links AI system characteristics to the OECD AI Principles
   * Different AI systems require different governance approaches—a restaurant recommendation and a criminal sentencing algorithm shouldn't be treated the same
...
### Section 4: AI Use Cases & Benefits
...
The OECD definition, ISO/IEC 22989 terminology, and the OECD Classification Framework give governance professionals the shared vocabulary they need to work across disciplines, organizations, and borders. As AI becomes more prevalent, these building blocks become essential tools for anyone working to ensure AI benefits society while minimizing harms.

**Next steps:** Familiarize yourself with the OECD AI Principles and the OECD Framework for Classification of AI Systems. Start thinking about AI systems you interact with daily—how would you classify them? What dimensions matter most for governance?
...
* **OECD AI Definition (Updated November 2023)**: Revised to align with latest technological developments including generative AI
  * Link: [OECD Explanatory Memorandum on Updated AI Definition](https://www.oecd.org/en/publications/explanatory-memorandum-on-the-updated-oecd-definition-of-an-ai-system_623da898-en.html)
* **OECD AI Principles (Updated May 2024)**: First intergovernmental standard on AI, now with 47 adherents
  * Link: [OECD AI Principles](https://oecd.ai/en/ai-principles)
* **ISO/IEC 22989:2022**: Artificial Intelligence Concepts and Terminology - now publicly available
  * Link: [ISO/IEC 22989](https://www.iso.org/standard/74296.html)
* **OECD Framework for Classification of AI Systems (2022)**: Five-dimension framework for policy assessment
  * Link: [OECD Classification Framework](https://oecd.ai/en/classification)
* **Socio-technical systems in AI**: Research from healthcare AI implementation showing importance of workflow integration
  * Link: [PMC Sociotechnical Systems Framework for AI in Healthcare](https://pmc.ncbi.nlm.nih.gov/articles/PMC9873227/)
* **Human-centered AI research**: Interdisciplinary approaches combining HFE, psychology, HCI
  * Link: [PMC Human-Centered AI at Work](https://pmc.ncbi.nlm.nih.gov/articles/PMC10646176/)
...
* **Primary keyword:** What is artificial intelligence definition
* **Secondary keywords:**
   * OECD AI definition
