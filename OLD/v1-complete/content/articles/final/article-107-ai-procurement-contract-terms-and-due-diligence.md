...
![Article 107: AI Procurement – Contract Terms and Due Diligence]({{IMAGE_PLACEHOLDER_article-107-ai-procurement-contract-terms-and-due-diligence}})

---
title: 'Article 107: AI Procurement – Contract Terms and Due Diligence'
tldr: ''
...
- type: checklist
  ...
  id: checklist-due-diligence-checklist
- type: table
  label: Aspect vs Traditional Software Table
  section: Traditional Software vs. AI
  id: table-traditional-software-vs-ai
- type: table
  label: Vendor Says vs You Can Respond Table
  section: Common Vendor Pushback
  id: table-common-vendor-pushback
- type: flowchart
  label: Renewal Considerations Process
  section: Renewal Considerations
  id: flowchart-renewal-considerations
- type: flowchart
...
- type: template
  label: 2. Performance Requirements
  section: 2. Performance Requirements
  id: template-2-performance-requirements
  template_link: /templates/2-performance-requirements.md
- type: template
  label: Vendor Questionnaire
  section: Vendor Questionnaire
  id: template-vendor-questionnaire
  template_link: /templates/vendor-questionnaire.md
- type: list
  label: 2. Performance Requirements
  section: 2. Performance Requirements
  id: list-2-performance-requirements
- type: list
  label: 3. Fairness and Bias Requirements
  section: 3. Fairness and Bias Requirements
  id: list-3-fairness-and-bias-requirements
topic_fingerprint:
- machine learning
- supervised learning
- neural network
...
- stanford
word_count: 896
processed_date: '2025-12-18T20:04:46.197Z'
---
...
<!-- component:table:table-traditional-software-vs-ai -->
|--------|---------------------|------------|
...
<!-- component:template:template-2-performance-requirements -->
...
<!-- component:list:list-3-fairness-and-bias-requirements -->
...
<!-- component:template:template-vendor-questionnaire -->
...
<!-- component:table:table-common-vendor-pushback -->
|-------------|-----------------|
