...
---
title: 'Article 127: Artificial General Intelligence – Hype, Hope, and Governance'
tldr: ''
...
- type: image_prompt
  ...
  prompt: futuristic technology, forward-looking perspective, emerging trends visualization,
    ...
    article header
- type: table
  label: Narrow AI (Current) vs AGI (Hypothetical) Table
  section: The Basic Definition
  id: table-the-basic-definition
- type: table
  label: Capability vs Current Best AI Table
  section: The Gap Between Current AI and AGI
  id: table-the-gap-between-current-ai-and-agi
- type: table
  label: Hype Indicators vs More Credible Indicators Table
  section: Signs You're Reading Hype (Not Analysis)
  id: table-signs-youre-reading-hype-not-analysis
- type: table
  label: Organization vs Approach Table
  section: What Organizations Are Doing
  id: table-what-organizations-are-doing
- type: table
  label: Actor vs Actions Table
  section: What Organizations Are Doing
  id: table-what-organizations-are-doing
- type: flowchart
  label: Questions Worth Asking Process
  section: Questions Worth Asking
  id: flowchart-questions-worth-asking
- type: flowchart
...
- white house
word_count: 2159
processed_date: '2025-12-18T20:05:17.533Z'
---
...
<!-- component:table:table-the-basic-definition -->
|---------------------|-------------------|
...
<!-- component:table:table-the-gap-between-current-ai-and-agi -->
|------------|-----------------|---------------------|
...
<!-- component:table:table-signs-youre-reading-hype-not-analysis -->
|-----------------|-------------------------|
...
<!-- component:table:table-what-organizations-are-doing -->
|--------------|----------|
...
<!-- component:flowchart:flowchart-questions-worth-asking -->
