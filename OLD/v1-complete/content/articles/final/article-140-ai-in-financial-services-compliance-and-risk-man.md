...
---
title: 'Article 140: AI in Financial Services – Compliance and Risk Management'
tldr: ''
...
- type: image_prompt
  ...
  prompt: industry-specific icons, sector applications, business context, shield icons,
    warning triangles, protective barriers, safety nets, legal documents, regulatory
    symbols, compliance checkmarks, professional illustration, modern flat design
...
- type: table
  label: Factor vs Implication Table
  section: Why Financial Services AI Is High-Stakes
  id: table-why-financial-services-ai-is-high-stakes
- type: table
  label: Requirement vs What It Means Table
  section: 'Banking Regulation: Model Risk Management'
  id: table-banking-regulation-model-risk-management
- type: table
  label: Area vs Key Requirements Table
  section: SEC and Trading
  id: table-sec-and-trading
- type: table
  label: Traditional Models vs AI/ML Models Table
  section: 'Challenge 1: Model Risk Management for AI'
  id: table-challenge-1-model-risk-management-for-ai
- type: table
  label: SR 11-7 Element vs AI/ML Adaptations Table
  section: 'Challenge 1: Model Risk Management for AI'
  id: table-challenge-1-model-risk-management-for-ai
- type: table
  label: Proxy Variable vs Potential Issue Table
  section: 'Challenge 2: Fair Lending Compliance'
  id: table-challenge-2-fair-lending-compliance
- type: table
  label: Test vs What It Measures Table
  section: 'Challenge 2: Fair Lending Compliance'
  id: table-challenge-2-fair-lending-compliance
- type: table
  label: Approach vs Description Table
  section: 'Challenge 3: Explainability and Adverse Actions'
  id: table-challenge-3-explainability-and-adverse-actions
- type: table
  label: Risk vs Description Table
  section: 'Challenge 4: Algorithmic Trading Risks'
  id: table-challenge-4-algorithmic-trading-risks
- type: table
  label: Line vs Role Table
  section: Governance Structure
  id: table-governance-structure
- type: table
  label: Activity vs Purpose Table
  section: AI Lifecycle Management
  id: table-ai-lifecycle-management
- type: table
  label: Activity vs Purpose Table
  section: AI Lifecycle Management
  id: table-ai-lifecycle-management
- type: table
  ...
  id: table-ai-lifecycle-management
- type: table
  label: Due Diligence Area vs Questions Table
  section: Vendor Management
  id: table-vendor-management
- type: flowchart
  label: 'Challenge 5: Fraud Detection Trade-offs Process'
  section: 'Challenge 5: Fraud Detection Trade-offs'
  id: flowchart-challenge-5-fraud-detection-trade-offs
- type: flowchart
...
- type: list
  label: Best Practices for Financial Services AI
  section: Best Practices for Financial Services AI
  id: list-best-practices-for-financial-services-ai
topic_fingerprint:
- machine learning
- generative ai
- fairness
...
word_count: 2243
processed_date: '2025-12-18T20:05:39.891Z'
---
...
| Factor | Implication |
<!-- component:table:table-why-financial-services-ai-is-high-stakes -->
|--------|-------------|
...
<!-- component:table:table-banking-regulation-model-risk-management -->
|-------------|---------------|
...
<!-- component:table:table-sec-and-trading -->
|------|-----------------|
...
<!-- component:table:table-challenge-1-model-risk-management-for-ai -->
|-------------------|--------------|
...
<!-- component:table:table-challenge-2-fair-lending-compliance -->
|----------------|-----------------|
...
<!-- component:table:table-challenge-3-explainability-and-adverse-actions -->
|----------|-------------|-------------|
...
| Risk | Description |
<!-- component:table:table-challenge-4-algorithmic-trading-risks -->
|------|-------------|
...
<!-- component:flowchart:flowchart-challenge-5-fraud-detection-trade-offs -->
...
<!-- component:list:list-best-practices-for-financial-services-ai -->
...
| Activity | Purpose |
<!-- component:table:table-ai-lifecycle-management -->
|----------|---------|
