...
![Article 94: Red Teaming AI – Adversarial Testing for Safety]({{IMAGE_PLACEHOLDER_article-94-red-teaming-ai-adversarial-testing-for-safety}})
...
- type: table
  ...
  section: Red Teaming vs. Standard Testing
  id: table-red-teaming-vs-standard-testing
- type: table
  label: Severity vs Definition Table
  section: 'Step 5: Report Findings'
  id: table-step-5-report-findings
- type: flowchart
  label: 'Step 6: Remediate and Verify Process'
  section: 'Step 6: Remediate and Verify'
  id: flowchart-step-6-remediate-and-verify
- type: flowchart
...
- type: template
  label: '*Example'
  section: 'Type 1: Prompt-Based Attacks (Generative AI)'
  id: template-type-1-prompt-based-attacks-generative-ai
  template_link: /templates/example.md
- type: template
  label: '*Example'
  section: 'Type 2: Input Perturbation Attacks'
  id: template-type-2-input-perturbation-attacks
  template_link: /templates/example.md
- type: template
  label: Information Extraction Techniques
  section: Information Extraction Techniques
  id: template-information-extraction-techniques
...
- white house
word_count: 1754
processed_date: '2025-12-18T20:07:18.482Z'
---
