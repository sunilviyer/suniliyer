...
![Article 153: How to Create an AI Ethics Review Process]({{IMAGE_PLACEHOLDER_article-153-how-to-create-an-ai-ethics-review-process}})

---
title: 'Article 153: How to Create an AI Ethics Review Process'
...
- type: table
  ...
  section: Why Establish an Ethics Review Process?
  id: table-why-establish-an-ethics-review-process
- type: table
  label: Type vs Scope Table
  section: Types of Ethics Review
  id: table-types-of-ethics-review
- type: table
  label: Role vs Name Table
  section: 1.2 Define Membership
  id: table-12-define-membership
- type: table
  label: Criterion vs Question Table
  section: 2.2 Create Evaluation Criteria
  id: table-22-create-evaluation-criteria
- type: table
  label: Criterion vs Question Table
  section: 2.2 Create Evaluation Criteria
  id: table-22-create-evaluation-criteria
- type: table
  ...
  id: table-22-create-evaluation-criteria
- type: table
  label: Score vs Meaning Table
  section: 2.2 Create Evaluation Criteria
  id: table-22-create-evaluation-criteria
- type: table
  label: Risk vs Likelihood Table
  section: 4.1 Ethics Review Request Form
  id: table-41-ethics-review-request-form
- type: table
  label: '------ vs ------------ Table'
  section: 4.1 Ethics Review Request Form
  id: table-41-ethics-review-request-form
- type: table
  label: 4.1 Ethics Review Request Form Table
  section: 4.1 Ethics Review Request Form
  id: table-41-ethics-review-request-form
- type: table
  label: 4.1 Ethics Review Request Form Table
  ...
  id: table-41-ethics-review-request-form
- type: table
  label: Criterion vs Score Table
  section: 4.2 Reviewer Evaluation Scorecard
  id: table-42-reviewer-evaluation-scorecard
- type: table
  label: Criterion vs Score Table
  section: 4.2 Reviewer Evaluation Scorecard
  id: table-42-reviewer-evaluation-scorecard
...
- type: table
  ...
  id: table-42-reviewer-evaluation-scorecard
- type: table
  label: '# vs Condition Table'
  section: 4.3 Decision Documentation Template
  id: table-43-decision-documentation-template
- type: table
  label: Audience vs Message Table
  section: 6.2 Communication Plan
  id: table-62-communication-plan
- type: table
  label: Audience vs Message Table
  section: 6.2 Communication Plan
  id: table-62-communication-plan
- type: table
  label: Metric vs Target Table
  section: 7.1 Process Metrics
  id: table-71-process-metrics
- type: table
  label: Metric vs Target Table
  section: 7.1 Process Metrics
  id: table-71-process-metrics
...
- type: table
  ...
  id: table-71-process-metrics
- type: table
  label: Date vs Issue Identified Table
  section: 7.2 Continuous Improvement
  id: table-72-continuous-improvement
- type: table
  label: '------ vs ------------------ Table'
  section: 7.2 Continuous Improvement
  id: table-72-continuous-improvement
- type: table
  label: 7.2 Continuous Improvement Table
  section: 7.2 Continuous Improvement
  id: table-72-continuous-improvement
- type: table
...
- type: template
  label: 'Step 4: Create Review Tools and Templates'
  section: 'Step 4: Create Review Tools and Templates'
  id: template-step-4-create-review-tools-and-templates
  template_link: /templates/step-4-create-review-tools-and-templates.md
- type: template
  label: 4.1 Ethics Review Request Form
  section: 4.1 Ethics Review Request Form
  id: template-41-ethics-review-request-form
  template_link: /templates/41-ethics-review-request-form.md
- type: template
  label: 4.3 Decision Documentation Template
  section: 4.3 Decision Documentation Template
  id: template-43-decision-documentation-template
  template_link: /templates/43-decision-documentation-template.md
- type: template
  label: Escalation Request Template
  section: 5.1 Escalation Process
  id: template-51-escalation-process
  template_link: /templates/escalation-request-template.md
- type: list
  label: 'Pros:'
  section: 'Model 1: Centralized Ethics Board'
  id: list-model-1-centralized-ethics-board
- type: list
  label: 'Cons:'
  section: 'Model 1: Centralized Ethics Board'
  id: list-model-1-centralized-ethics-board
- type: list
  label: 'Pros:'
  section: 'Model 2: Distributed Review with Oversight'
  id: list-model-2-distributed-review-with-oversight
- type: list
  label: 'Cons:'
  section: 'Model 2: Distributed Review with Oversight'
  id: list-model-2-distributed-review-with-oversight
- type: list
  label: 'Pros:'
  section: 'Model 3: Embedded Ethics (Ethics Champions)'
  id: list-model-3-embedded-ethics-ethics-champions
- type: list
  label: 'Cons:'
  section: 'Model 3: Embedded Ethics (Ethics Champions)'
  id: list-model-3-embedded-ethics-ethics-champions
- type: list
  label: 'Step 2: Define Ethical Principles and Criteria'
  section: 'Step 2: Define Ethical Principles and Criteria'
  id: list-step-2-define-ethical-principles-and-criteria
- type: list
  label: 2.1 Establish Ethical Principles
  section: 2.1 Establish Ethical Principles
  id: list-21-establish-ethical-principles
- type: list
  label: 2.2 Create Evaluation Criteria
  section: 2.2 Create Evaluation Criteria
  id: list-22-create-evaluation-criteria
topic_fingerprint:
- machine learning
- generative ai
- deep learning
...
named_examples: []
word_count: 568
processed_date: '2025-12-18T20:06:07.643Z'
---
...
| Reason | Benefit |
<!-- component:table:table-why-establish-an-ethics-review-process -->
|--------|---------|
...
| Type | Scope | Timing |
<!-- component:table:table-types-of-ethics-review -->
|------|-------|--------|
...
<!-- component:table:table-12-define-membership -->
|------|------|-----------|------|---------|
| Chair | | | | Yes |
| Vice Chair | | | | Yes |
| Technical Lead | | | | Yes |
...
<!-- component:list:list-step-2-define-ethical-principles-and-criteria -->

### Step 2: Define Ethical Principles and Criteria

<!-- component:list:list-21-establish-ethical-principles -->
...
<!-- component:list:list-22-create-evaluation-criteria -->
...
<!-- component:table:table-22-create-evaluation-criteria -->
|-----------|----------|-------------------|
...
<!-- component:template:template-step-4-create-review-tools-and-templates -->

### Step 4: Create Review Tools and Templates

<!-- component:template:template-41-ethics-review-request-form -->
...
<!-- component:table:table-41-ethics-review-request-form -->
|------|------------|----------|------------|
<!-- component:table:table-41-ethics-review-request-form -->
|      |            |          |            |
<!-- component:table:table-41-ethics-review-request-form -->
...
<!-- component:table:table-42-reviewer-evaluation-scorecard -->
|-----------|-------|----------|----------|
...
<!-- component:template:template-43-decision-documentation-template -->
...
<!-- component:table:table-43-decision-documentation-template -->
|---|-----------|----------|---------------------|
| 1 |           |          |                     |
| 2 |           |          |                     |
| 3 |           |          |                     |
...
<!-- component:template:template-51-escalation-process -->
...
<!-- component:table:table-62-communication-plan -->
|----------|---------|---------|-----------|
...
<!-- component:table:table-71-process-metrics -->
|--------|--------|--------|-------|
...
<!-- component:table:table-72-continuous-improvement -->
|------|------------------|-------------|---------|
<!-- component:table:table-72-continuous-improvement -->
|      |                  |             |         |
<!-- component:table:table-72-continuous-improvement -->
