...
![Article 79: Before You Build – AI System Planning Essentials]({{IMAGE_PLACEHOLDER_article-79-before-you-build-ai-system-planning-essentials}})
...
- type: image_prompt
  ...
  prompt: organizational structure, implementation roadmap, strategic planning elements,
    ...
    article header
- type: checklist
  label: 'Bringing It Together: The Planning Checklist'
  section: 'Bringing It Together: The Planning Checklist'
  id: checklist-bringing-it-together-the-planning-checklist
- type: checklist
  label: 'Bringing It Together: The Planning Checklist'
  section: Problem Definition ✓
  id: checklist-problem-definition-
- type: checklist
  label: Stakeholders ✓
  section: Stakeholders ✓
  id: checklist-stakeholders-
- type: checklist
  label: Feasibility ✓
  section: Feasibility ✓
  id: checklist-feasibility-
- type: checklist
  label: Ethical Pre-Screening ✓
  section: Ethical Pre-Screening ✓
  id: checklist-ethical-pre-screening-
- type: checklist
  label: Governance ✓
  section: Governance ✓
  id: checklist-governance-
- type: table
  label: Stakeholder vs Interest/Concern Table
  section: Stakeholder Analysis Template
  id: table-stakeholder-analysis-template
- type: table
  label: Factor vs Assessment Table
  section: Feasibility Decision Matrix
  id: table-feasibility-decision-matrix
- type: table
  label: Dimension vs Low Risk Table
  section: Pre-Screening Assessment
  id: table-pre-screening-assessment
- type: flowchart
...
- type: template
  label: '*Example'
  section: The Problem Definition Process
  id: template-the-problem-definition-process
  template_link: /templates/example.md
- type: template
  label: '*Example'
  section: Is AI Even the Right Solution?
  id: template-is-ai-even-the-right-solution
  template_link: /templates/example.md
- type: template
  label: Stakeholder Analysis Template
  section: Stakeholder Analysis Template
  id: template-stakeholder-analysis-template
  template_link: /templates/stakeholder-analysis-template.md
- type: template
  label: '*Example'
  section: The "Affected But Not Consulted" Problem
  id: template-the-affected-but-not-consulted-problem
  template_link: /templates/example.md
- type: template
  label: '*Example'
  section: Technical Feasibility
  id: template-technical-feasibility
  template_link: /templates/example.md
topic_fingerprint:
- machine learning
- transparency
...
- stanford
word_count: 2534
processed_date: '2025-12-18T02:16:50.435Z'
---
