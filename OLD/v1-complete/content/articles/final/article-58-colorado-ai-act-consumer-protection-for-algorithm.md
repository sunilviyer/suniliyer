...
![Article 58: Colorado AI Act – Consumer Protection for Algorithmic Decisions]({{IMAGE_PLACEHOLDER_article-58-colorado-ai-act-consumer-protection-for-algorithm}})

---
title: 'Article 58: Colorado AI Act – Consumer Protection for Algorithmic Decisions'
tldr: ''
...
- type: table
  label: Assessment Area vs What to Evaluate Table
  section: 2. Impact Assessments
  id: table-2-impact-assessments
- type: table
  label: Date vs Milestone Table
  section: Implementation Timeline
  id: table-implementation-timeline
- type: table
  label: Aspect vs Colorado AI Act Table
  section: Colorado vs. EU AI Act
  id: table-colorado-vs-eu-ai-act
- type: table
  label: Aspect vs Colorado AI Act Table
  section: Colorado vs. NYC Local Law 144
  id: table-colorado-vs-nyc-local-law-144
- type: flowchart
  label: Covered Entities Process
  section: Covered Entities
  id: flowchart-covered-entities
- type: flowchart
...
- type: list
  label: Key Requirements for Developers
  section: Key Requirements for Developers
  id: list-key-requirements-for-developers
- type: list
  label: 3. Disclosure Requirements
  section: 3. Disclosure Requirements
  id: list-3-disclosure-requirements
- type: list
  label: Key Requirements for Deployers
  section: Key Requirements for Deployers
  id: list-key-requirements-for-deployers
topic_fingerprint:
- transparency
- oversight
- impact assessment
...
- nyc local law 144
word_count: 2247
processed_date: '2025-12-18T20:06:47.427Z'
---
...
<!-- component:flowchart:flowchart-covered-entities -->
...
<!-- component:list:list-key-requirements-for-developers -->
...
<!-- component:list:list-3-disclosure-requirements -->
...
<!-- component:list:list-key-requirements-for-deployers -->
...
<!-- component:table:table-2-impact-assessments -->
|-----------------|------------------|
...
| Date | Milestone |
<!-- component:table:table-implementation-timeline -->
|------|-----------|
...
<!-- component:table:table-colorado-vs-eu-ai-act -->
|--------|-----------------|-----------|
...
<!-- component:table:table-colorado-vs-nyc-local-law-144 -->
|--------|-----------------|------------|
