...
![Article 146: AI in Government – Public Sector Implementation]({{IMAGE_PLACEHOLDER_article-146-ai-in-government-public-sector-implementation}})

---
title: 'Article 146: AI in Government – Public Sector Implementation'
tldr: ''
...
- type: image_prompt
  ...
  prompt: industry-specific icons, sector applications, business context, deployment
...
- type: table
  label: Level vs Examples Table
  section: State and Local (U.S.)
  id: table-state-and-local-us
- type: table
  label: Country vs Approach Table
  section: International
  id: table-international
- type: table
  label: Element vs AI Challenge Table
  section: 'Challenge 2: Due Process'
  id: table-challenge-2-due-process
- type: table
  label: Challenge vs Issue Table
  section: 'Challenge 5: Procurement Challenges'
  id: table-challenge-5-procurement-challenges
- type: table
  label: Risk Level vs Criteria Table
  section: Risk-Based Approach
  id: table-risk-based-approach
- type: table
  label: Assessment Area vs Questions Table
  section: Impact Assessments
  id: table-impact-assessments
- type: table
  label: Risk Level vs Human Role Table
...
- type: list
  label: Best Practices for Public Sector AI
  section: Best Practices for Public Sector AI
  id: list-best-practices-for-public-sector-ai
- type: list
...
- white house
word_count: 2095
processed_date: '2025-12-18T20:05:49.695Z'
---
...
| Level | Examples |
<!-- component:table:table-state-and-local-us -->
|-------|----------|
...
| Country | Approach |
<!-- component:table:table-international -->
|---------|----------|
...
<!-- component:table:table-challenge-2-due-process -->
|---------|--------------|
...
| Challenge | Issue |
<!-- component:table:table-challenge-5-procurement-challenges -->
|-----------|-------|
...
<!-- component:list:list-best-practices-for-public-sector-ai -->
...
<!-- component:table:table-risk-based-approach -->
|------------|----------|--------------|
...
<!-- component:table:table-impact-assessments -->
|-----------------|-----------|
