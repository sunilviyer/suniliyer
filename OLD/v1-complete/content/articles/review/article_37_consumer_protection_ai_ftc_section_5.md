# Article 37: Consumer Protection and AI – FTC Section 5 Explained

## TL;DR

The Federal Trade Commission (FTC) uses Section 5 of the FTC Act—a 1914 law prohibiting "unfair or deceptive acts or practices"—as its primary tool for regulating AI. The FTC has taken action against companies for making false claims about AI capabilities ("AI washing"), using AI that produces discriminatory outcomes, deploying facial recognition that harms consumers, and collecting data for AI training without proper consent. Companies don't need to wait for new AI laws—the FTC is already enforcing consumer protection principles against AI harms today.

---

## Introduction

In 1914, when Congress passed the Federal Trade Commission Act, artificial intelligence was pure science fiction. The word "robot" wouldn't even be coined for another six years. Yet today, this century-old law has become one of the most powerful tools for regulating AI in the United States.

Section 5 of the FTC Act contains just fifteen words that matter: the Commission is empowered to prevent "unfair or deceptive acts or practices in or affecting commerce."

That's it. No mention of algorithms, machine learning, neural networks, or automated decision-making. Just "unfair or deceptive acts or practices."

And that's exactly why it works so well for AI regulation.

The FTC doesn't need Congress to pass a new law every time technology changes. The principles of consumer protection—don't lie to people, don't harm them unfairly—apply regardless of whether you're using a telegraph, a telephone, or a transformer-based large language model.

For business leaders and HR professionals, understanding how the FTC applies Section 5 to AI isn't optional. The Commission has made AI enforcement a priority, and the penalties for violations can include not just fines, but requirements to delete AI models entirely—a corporate death sentence for companies whose value depends on their AI.
