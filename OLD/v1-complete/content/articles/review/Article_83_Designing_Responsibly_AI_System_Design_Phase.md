# Article 83: Designing Responsibly – The AI System Design Phase

## TL;DR

The design phase is where responsible AI becomes (or doesn't become) reality. This is when you make crucial decisions about data (what to use, what to exclude, how to handle quality issues), model architecture (simple vs. complex, accurate vs. explainable), and human oversight (how much, when, by whom). Design decisions are hard to reverse later—bias built into training data, opacity baked into model architecture, and missing human checkpoints compound through development and deployment. This article covers the key design decisions that determine whether your AI will be trustworthy: data strategy, model selection, fairness by design, transparency planning, and human oversight architecture.

---

## Introduction

Imagine designing a building. During design, you decide where the foundation goes, how the structure is supported, where doors and windows are placed. Once construction starts, changing these decisions is expensive. Once the building is occupied, it's nearly impossible.

AI is similar. The design phase is when you make foundational decisions:
- What data will train the model?
- What type of model will you use?
- How will fairness be addressed?
- How explainable will decisions be?
- Where will humans intervene?

Get these right, and you've set up for success. Get them wrong, and you've created problems that are expensive or impossible to fix later.

This article covers responsible design—making design decisions that produce AI systems that are not just technically functional, but trustworthy, fair, and governable.
