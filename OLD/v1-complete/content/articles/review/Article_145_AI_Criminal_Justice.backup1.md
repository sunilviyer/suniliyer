# Article 145: AI in Criminal Justice – Risk Assessment and Civil Liberties

## TL;DR

AI is increasingly used throughout the criminal justice system—from predictive policing and facial recognition to bail decisions and sentencing recommendations. Proponents argue AI can reduce human bias and improve efficiency. Critics warn it automates and amplifies existing discrimination, threatens civil liberties, and makes consequential decisions without adequate transparency or accountability. This is one of the most contested areas of AI governance. This article covers AI applications in criminal justice (policing, courts, corrections), the regulatory landscape, key concerns (bias, due process, surveillance), and the ongoing debate about whether and how AI should be used when freedom is at stake.

---

## Introduction

In 2016, ProPublica published an investigation of COMPAS, a widely used algorithm that predicts whether defendants will reoffend. Their analysis found the algorithm was biased against Black defendants—they were almost twice as likely as white defendants to be incorrectly labeled as high risk for violent recidivism.

The company disputed the findings. Academics debated methodologies. But one thing was clear: algorithms were making consequential recommendations about people's freedom, and few people understood how they worked.

Criminal justice is where AI governance stakes are highest. We're not talking about movie recommendations or targeted ads—we're talking about who gets stopped by police, who gets bail, how long people spend in prison. Errors don't mean a wrong product suggestion; they mean wrongful arrests, denied freedom, destroyed lives.

Yet AI is expanding rapidly in this space. Police departments use predictive policing. Courts use risk assessments. Prisons use algorithms for housing and parole decisions. The question isn't whether AI is being used in criminal justice—it's whether it should be, and if so, how to govern it.
