# Article 99: AI Incident Response – When Things Go Wrong

## TL;DR

AI incidents are different from traditional software incidents. When an AI system fails, it might not crash—it might silently produce harmful outputs, discriminate against users, or make decisions that damage your business before anyone notices. AI incident response requires detecting problems that don't look like problems, understanding root causes that involve data and models (not just code), communicating about systems that are hard to explain, and preventing recurrence in systems that learn from data. This article covers how to prepare for AI incidents, respond when they happen, and learn from them to prevent future failures.

---

## Introduction

At 2:47 PM on a Tuesday, your AI-powered customer service chatbot starts telling customers that your company is going out of business. It's confidently providing detailed (and completely false) information about store closings and liquidation sales. By the time someone notices, screenshots are spreading on social media.

Or: Your hiring AI has been systematically rating female candidates lower for six months. You find out when a rejected candidate files a discrimination complaint.

Or: Your fraud detection system suddenly starts blocking 40% of legitimate transactions. You discover it three days later when customer complaints spike.

These are AI incidents. They're different from traditional software incidents because:
- The system might be "working" (no errors, good uptime)
- The problem might not be obvious
- The root cause might be data, not code
- The impact might be fairness or reputation, not just availability

This article covers how to respond when AI goes wrong.
