# Article 40: Product Liability for AI – When Software Causes Harm

## TL;DR

When AI causes harm—a self-driving car crashes, a medical AI misdiagnoses cancer, a robotic arm injures a worker—who is legally responsible? Traditional product liability law, designed for physical products like toasters and cars, struggles to address AI's unique characteristics: software that learns and changes, systems too complex for anyone to fully understand, and harm that may emerge from the interaction of many components. Courts and regulators are grappling with fundamental questions about whether AI is a "product," who counts as the "manufacturer," and how to prove an AI system was "defective." For businesses deploying AI, understanding these evolving liability rules is essential for managing risk.

---

## Introduction

In March 2018, an Uber self-driving car struck and killed a pedestrian in Tempe, Arizona. It was the first known death of a pedestrian caused by an autonomous vehicle.

The subsequent investigation revealed a cascade of failures. The car's sensors detected the pedestrian six seconds before impact but classified her as an "unknown object," then as a vehicle, then as a bicycle—each misclassification resetting the prediction of her path. The system decided not to alert the human safety driver or engage emergency braking because it was programmed to avoid "erratic behavior." By the time the safety driver (who was watching a video on her phone) looked up, it was too late.

Who was responsible for this death?

Was it Uber, which developed and deployed the autonomous driving system? Volvo, which manufactured the vehicle? The safety driver, who wasn't paying attention? The engineers who wrote the code? The managers who decided not to enable automatic emergency braking? Arizona regulators who allowed testing without adequate safety requirements?

This tragic case illustrates the fundamental challenge of AI product liability: when complex systems cause harm, traditional legal frameworks struggle to assign responsibility.

Product liability law was designed for a simpler world—a world where products were physical objects, manufacturers were identifiable, and defects were discoverable. AI disrupts all of these assumptions. And as AI becomes embedded in everything from cars to medical devices to household appliances, the stakes of getting liability rules right have never been higher.
