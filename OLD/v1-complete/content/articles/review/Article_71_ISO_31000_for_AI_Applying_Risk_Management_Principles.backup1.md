# Article 71: ISO 31000 for AI – Applying Risk Management Principles

## TL;DR

ISO 31000 is the international standard for risk management—not specific to AI, but applicable to any risk. It provides a universal framework: establish context, identify risks, analyze them, evaluate them, and treat them. For AI governance professionals, ISO 31000 offers a proven foundation that works alongside AI-specific frameworks like the NIST AI RMF. The standard emphasizes that risk management should be integrated into everything an organization does, not bolted on as a separate activity. Think of ISO 31000 as the "operating system" for risk management, and AI-specific frameworks as "applications" running on top of it.

---

## Introduction

Before there was AI risk management, there was just risk management.

Organizations have been managing risks for centuries—financial risks, operational risks, safety risks, reputational risks. Along the way, they developed principles and practices that work across different types of risks.

ISO 31000 captures this accumulated wisdom. First published in 2009 and updated in 2018, it's the international standard for risk management. It doesn't tell you specifically how to manage AI risks—but it tells you how to manage any risk effectively.

Why does this matter for AI governance?

Because AI risk isn't fundamentally different from other risks. Yes, AI has unique characteristics (opacity, scale, rapid change), but the basic process of identifying, assessing, and treating risks applies. Organizations that understand general risk management will find AI risk management more intuitive.

Think of it like cooking. ISO 31000 teaches you fundamental techniques—knife skills, heat control, flavor balancing. AI risk management is a specific cuisine. Knowing the fundamentals makes learning the specialty much easier.

This article explains ISO 31000's principles and process, then shows how to apply them specifically to AI risks.
