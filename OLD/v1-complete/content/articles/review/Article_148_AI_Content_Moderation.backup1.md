# Article 148: AI in Content Moderation – Platforms and Free Speech

## TL;DR

Social media platforms use AI to moderate billions of posts daily—removing hate speech, violence, misinformation, and other harmful content. Without AI, moderation at scale would be impossible. But AI content moderation raises serious concerns: false positives silencing legitimate speech, inconsistent enforcement, lack of transparency, cultural and linguistic blind spots, and the outsourcing of free speech decisions to algorithms. The EU Digital Services Act and other regulations now require platforms to be transparent about their moderation systems. This article covers how AI moderation works, its limitations, the regulatory landscape, free speech tensions, and best practices for balancing safety with expression.

---

## Introduction

In 2020, Facebook's AI moderation system removed a post by a Plymouth, UK resident sharing a photo of historic Hoe Road. The AI flagged "Hoe" as offensive. That same year, Facebook's AI removed a historic photo of Black civil rights protesters being attacked—classifying it as hate speech.

These aren't rare glitches. They're symptoms of a fundamental challenge: teaching AI to understand context, nuance, irony, cultural differences, and the vast complexity of human communication.

Social media platforms face an impossible task. Billions of posts are created daily. Hate speech, violence, child exploitation, terrorism, and misinformation spread rapidly. Human moderators alone can't keep up—and the psychological toll on them is severe. AI is essential for moderation at scale.

But AI moderation also raises profound questions about free expression. When algorithms decide what speech is allowed, they become the de facto speech regulators for billions of people. Their errors can silence dissent, remove important journalism, or fail to catch genuine harm.

This article explores AI content moderation: how it works, where it fails, the regulatory requirements emerging, and how platforms can balance safety with free expression.
