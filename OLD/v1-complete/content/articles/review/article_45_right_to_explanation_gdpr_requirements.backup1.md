# Article 45: The Right to Explanation – What GDPR Actually Requires

## TL;DR

Does GDPR give you the right to an explanation of AI decisions? The answer is complicated. GDPR requires organizations to provide "meaningful information about the logic involved" in automated decision-making, but it doesn't explicitly create a "right to explanation" of individual decisions. What's actually required: transparency about how AI systems work in general, information about the significance and consequences of automated processing, and safeguards including the ability to contest decisions and obtain human intervention. The debate continues about whether this amounts to a true right to explanation—but organizations should focus less on legal technicalities and more on providing genuinely useful information to people affected by AI decisions.

---

## Introduction

You've been denied a loan. The decision was made by an algorithm. You want to know why.

Can you demand an explanation? Does the law require the bank to tell you which factors led to the denial? Must they explain how the algorithm weighed your income against your debt, or why your zip code mattered, or what the model predicted about your likelihood of default?

This is the question at the heart of one of GDPR's most debated provisions. Scholars, regulators, and practitioners have argued for years about whether GDPR creates a "right to explanation" for automated decisions—and if so, what that right actually requires.

The stakes are high. As AI makes more consequential decisions about people's lives—who gets hired, who gets credit, who gets insurance, who gets released on bail—the ability to understand and challenge those decisions becomes essential to fairness, accountability, and human dignity.

This article cuts through the legal debate to explain what GDPR actually requires regarding explanations of AI decisions, what organizations must provide, and what individuals can expect.
