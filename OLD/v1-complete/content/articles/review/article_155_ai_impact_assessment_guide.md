# Article 150: How to Conduct an AI Impact Assessment — Step by Step
...
An AI Impact Assessment (AIA) is a systematic process for identifying, evaluating, and mitigating the potential impacts of an AI system before and during its deployment. Think of it as a "health check" for your AI — examining not just whether it works, but whether it works fairly, safely, and responsibly.

This guide walks you through conducting a complete AIA from start to finish, with templates, examples, and practical guidance at every step.
