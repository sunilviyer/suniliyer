# Article 38: Anti-Discrimination Laws and AI – Civil Rights in the Algorithm Age

## TL;DR

Civil rights laws passed decades before AI existed still apply to algorithmic decision-making. Title VII prohibits employment discrimination. The Equal Credit Opportunity Act bans lending discrimination. The Fair Housing Act outlaws housing discrimination. These laws don't require proof of intent—if an AI produces discriminatory outcomes without business justification, it may be illegal. The key concept is "disparate impact": a neutral-seeming practice that disproportionately harms protected groups. AI systems are particularly vulnerable to disparate impact claims because they learn from historical data that reflects past discrimination. Organizations using AI must understand these laws and actively test their systems for discriminatory outcomes.

---

## Introduction

In 1964, when President Lyndon B. Johnson signed the Civil Rights Act into law, the most advanced computers filled entire rooms and had less processing power than a modern calculator. Machine learning, neural networks, and algorithmic decision-making were decades away.

Yet the principles embedded in that landmark legislation—and the anti-discrimination laws that followed—remain remarkably relevant to artificial intelligence.

Here's why: discrimination doesn't require a human to pull the trigger.

When a bank's AI denies loans to Black applicants at higher rates than white applicants with similar credit profiles, that's discrimination—regardless of whether a human intended it. When a hiring algorithm screens out women because it learned from a male-dominated workforce, that's discrimination—even though the algorithm never "sees" gender. When an apartment-hunting platform steers families with children away from certain neighborhoods, that's discrimination—whether a person or a machine makes the decision.

Civil rights laws prohibit discriminatory outcomes, not just discriminatory intent. This distinction is critical for understanding how these laws apply to AI.

For business leaders and HR professionals, this isn't academic. If your organization uses AI for hiring, lending, housing, insurance, or other consequential decisions, you're operating in a legal minefield. The good news: understanding the legal framework helps you navigate it. The bad news: many organizations are using AI without fully appreciating the risks.

---

## The Foundation: Understanding Disparate Impact

### Two Types of Discrimination

Anti-discrimination law recognizes two fundamentally different types of discrimination:

**Disparate Treatment:** Intentionally treating people differently because of a protected characteristic. This is the obvious kind of discrimination—refusing to hire someone because of their race, or charging women more for insurance because of their sex.

**Disparate Impact:** Using practices that appear neutral but disproportionately harm protected groups without adequate justification. This is the subtle kind of discrimination—and the kind most relevant to AI.

The disparate impact doctrine recognizes that discrimination can occur without anyone intending it. A company might genuinely believe its practices are fair, yet still violate civil rights laws if those practices produce unjustified discriminatory outcomes.

### The Griggs Decision: Where It All Started

The concept of disparate impact emerged from a 1971 Supreme Court case, Griggs v. Duke Power Co.

Duke Power required employees to have a high school diploma and pass intelligence tests to transfer to higher-paying departments. The requirements weren't explicitly racial. But because Black workers in that era had less access to education, the requirements disproportionately excluded Black employees.

The Supreme Court held that Title VII "proscribes not only overt discrimination but also practices that are fair in form, but discriminatory in operation." The Court emphasized that the tests and diploma requirements weren't shown to be related to job performance.

**The key principle:** If a practice has disparate impact on a protected group and isn't justified by business necessity, it violates civil rights law—regardless of intent.

### Why Disparate Impact Matters for AI

AI systems are uniquely susceptible to disparate impact for several reasons:

**Historical bias in training data:** AI learns from historical data. If that data reflects past discrimination, the AI learns discriminatory patterns. A hiring AI trained on decades of mostly-male engineers learns that male characteristics predict success. A lending AI trained during an era of redlining learns that certain zip codes predict default.

**Proxy discrimination:** Even if an AI doesn't use protected characteristics directly, it may use proxies that correlate with them. Zip code correlates with race. Name correlates with ethnicity and gender. Employment gaps correlate with gender and disability. The AI doesn't "see" the protected characteristic, but the effect is the same.

**Opacity:** Many AI systems are "black boxes"—even their developers can't fully explain why they make particular predictions. This makes it difficult to identify and correct discriminatory patterns.

**Scale:** AI can make millions of decisions faster than any human could. If the algorithm is biased, discrimination happens at scale.
