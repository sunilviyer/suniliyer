# Article 118: AI Audit Evidence – What to Collect and Analyze

## TL;DR

AI audit evidence is the information you gather to support your findings—think of it like evidence in a court case. Without solid evidence, your audit conclusions are just opinions. The four types of evidence you need are: (1) Documentation—policies, technical specs, and records; (2) Testimonial—what people tell you in interviews; (3) Quantitative—numbers from testing and analysis; and (4) Observational—what you see happening in practice. Good evidence is relevant, reliable, and sufficient. Weak evidence leads to weak conclusions that can be challenged or ignored. This article explains what to collect, how to collect it, and how to analyze it effectively.

---

## Introduction

Imagine you're a detective investigating a case. You wouldn't walk into court and say, "I think the suspect did it because they seem suspicious." You'd bring fingerprints, witness statements, security footage, and phone records.

AI auditing works the same way. Your findings are only as strong as the evidence supporting them.

When you conclude that an AI system discriminates against older workers, or that it lacks proper documentation, or that operators aren't trained to use it correctly—you need evidence to back those claims. Otherwise, developers will push back, executives will question your conclusions, and your audit report will gather dust.

This article covers the four types of audit evidence, explains how to collect each type effectively, and shows you how to analyze what you've gathered to reach defensible conclusions.
