# Article 69: NIST AI RMF Core Functions – Govern, Map, Measure, Manage

## TL;DR

The NIST AI RMF has four core functions that work together: GOVERN (set up your AI governance foundation—leadership, policies, culture), MAP (understand your AI systems and their context—what you have, who's affected, what could go wrong), MEASURE (assess and monitor risks—test for bias, check security, track performance), and MANAGE (take action on risks—prioritize, fix issues, communicate). Think of it like running a restaurant: GOVERN is setting up your health and safety policies, MAP is knowing your menu and suppliers, MEASURE is checking food temperatures and cleanliness, and MANAGE is actually fixing problems when inspectors find them. This article dives deep into each function with practical examples.

---

## Introduction

You've heard about the NIST AI Risk Management Framework. You know it has four functions: Govern, Map, Measure, Manage. But what do these actually mean in practice?

This is where many organizations get stuck. The framework sounds great in theory, but when you sit down to implement it, questions multiply:

- What does "governance" actually look like day-to-day?
- How detailed does our AI inventory need to be?
- What exactly should we be measuring?
- When is a risk managed enough?

This article breaks down each function into practical components. We'll go beyond definitions to show what each function looks like in action, what questions you should be asking, and how to know if you're doing it right.

Think of the four functions like the four legs of a table. Each is essential, and they support each other. A table with three legs might stand, but it's unstable. Similarly, an AI risk management program that skips a function will wobble.
