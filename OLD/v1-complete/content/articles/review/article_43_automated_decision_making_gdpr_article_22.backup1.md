# Article 43: Automated Decision-Making – Understanding GDPR Article 22

## TL;DR

GDPR Article 22 gives individuals the right not to be subject to decisions made entirely by automated systems—including AI—when those decisions have legal or similarly significant effects. This means AI can't automatically deny your loan, reject your job application, or cancel your insurance without meaningful human involvement (unless specific exceptions apply). When automation is permitted, individuals have the right to obtain human intervention, express their views, and contest the decision. For organizations using AI for consequential decisions, Article 22 requires either genuine human oversight or explicit consent—and robust safeguards in either case. Getting this wrong exposes organizations to regulatory enforcement and individual lawsuits.

---

## Introduction

Imagine this scenario: You apply for a mortgage. Within seconds, an algorithm analyzes your credit history, income, spending patterns, and dozens of other data points. It generates a score. Based on that score—and that score alone—you're rejected. No human ever looked at your application. No one considered your explanation for that late payment during your divorce. No one weighed your recent promotion or your consistent rent payments for the past decade.

This is exactly the kind of situation GDPR Article 22 was designed to address.

In a world where algorithms increasingly make decisions that affect people's lives—who gets a loan, who gets a job, who gets insurance, who gets released on bail—European lawmakers decided that humans shouldn't be entirely cut out of the loop. At least not for decisions that really matter.

Article 22 is one of the most AI-relevant provisions in all of GDPR. It directly confronts the question: When can machines make important decisions about people without human involvement?

The answer, in short, is: rarely. And when they do, significant safeguards must apply.

For organizations deploying AI, understanding Article 22 is essential. It affects how you design AI systems, how you integrate human oversight, and how you communicate with individuals affected by automated decisions. Get it wrong, and you face not just regulatory penalties, but also the possibility that affected individuals can challenge decisions and demand human review.

This article provides a deep dive into Article 22—what it says, what it means, and how to comply.
