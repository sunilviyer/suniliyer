# Article 79: Before You Build – AI System Planning Essentials

## TL;DR

The planning phase is where AI projects succeed or fail—usually before any code is written. Good planning means clearly defining the problem you're solving (not just jumping to "let's use AI"), understanding who's affected, assessing whether AI is even the right solution, and setting up governance from day one. This article walks through the essential planning activities: problem definition, stakeholder identification, feasibility assessment, ethical pre-screening, and governance setup. Skip these steps, and you'll likely end up with an expensive AI system that doesn't solve the right problem—or causes problems you didn't anticipate.

---

## Introduction

Here's a story that plays out in organizations everywhere:

A leadership team gets excited about AI. They've read the articles, seen the demos, heard the success stories. "We need to use AI for our customer service," someone declares. The team nods enthusiastically. A project starts. Engineers begin building. Months later, they have an AI system that... doesn't quite fit the actual problem. Or creates new problems nobody anticipated. Or works technically but nobody wants to use.

What went wrong? Usually, insufficient planning.

The impulse to start building is strong—especially with AI, where the technology is exciting and the pressure to innovate is intense. But AI projects that skip proper planning fail at alarming rates. Various studies put AI project failure rates between 50% and 87%, depending on how you define failure.

Most of these failures aren't technical. The algorithms work fine. The failures are strategic: solving the wrong problem, ignoring stakeholder needs, underestimating organizational change, or creating ethical issues that could have been foreseen.

This article covers what happens before you build—the planning essentials that set AI projects up for success.
