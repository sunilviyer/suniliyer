...
You can't govern what you don't know about. An AI inventory (also called an AI registry or algorithm register) is a comprehensive catalog of all AI systems in your organization—what they do, who owns them, what data they use, and what risks they pose. Without an inventory, AI governance is guesswork: you don't know what's deployed, where the risks are, or what needs attention. This article covers why you need an AI inventory, what information to capture, how to build and maintain it, and how to use it for effective governance—because the first step in managing AI is knowing what AI you actually have.

---

## Introduction

A financial services company was preparing for a regulatory examination focused on AI and algorithmic decision-making. The regulators asked a simple question: "How many AI systems do you have in production?"

The company couldn't answer.

Different teams had built different systems. Some were called "AI," some were called "models," some were called "algorithms," and some were just "automated rules." Nobody had a complete list.

After weeks of scrambling—surveying teams, digging through systems, reviewing vendor contracts—they discovered 47 AI systems in production. Twelve of them made decisions affecting customers. Three of them nobody could identify an owner for.

This is why AI inventory matters. You cannot:
- Assess risks you don't know exist
- Ensure compliance for systems you can't identify
- Respond to incidents in systems you can't find
- Make governance decisions without knowing what you're governing

An AI inventory is the foundation of AI governance.
