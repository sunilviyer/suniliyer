# Article 140: AI in Financial Services – Compliance and Risk Management

## TL;DR

Financial services was one of the earliest adopters of AI—credit scoring, fraud detection, and algorithmic trading have used machine learning for decades. But regulatory expectations are catching up, and the stakes are high. Banking regulators expect robust model risk management (SR 11-7), fair lending laws apply to AI credit decisions, and new AI-specific regulations add additional requirements. Financial institutions must balance innovation with compliance, managing risks from model failures, bias and fair lending violations, market manipulation, and operational resilience. This article covers the regulatory landscape, key governance challenges, and best practices for AI in banking, lending, trading, and customer service.

---

## Introduction

In 2019, Apple launched its credit card in partnership with Goldman Sachs. Within weeks, users on social media reported that the algorithm seemed to give men higher credit limits than women—even when the women had better credit profiles. The company denied discrimination, but the New York Department of Financial Services launched an investigation.

This incident illustrates the challenge of AI in financial services: even well-intentioned AI systems can produce outcomes that look discriminatory, trigger regulatory scrutiny, and damage reputation. And in financial services, the stakes include not just fairness to individuals, but systemic stability of markets.

Financial institutions were AI pioneers, but they're now navigating an increasingly complex regulatory environment. Traditional model risk management meets new AI governance requirements. Fair lending laws written for humans must be applied to algorithms. And the speed and scale of AI decision-making means errors can have massive consequences.

This article provides a comprehensive guide to AI governance in financial services: what regulations apply, what risks need management, and what practices lead to safe, fair, and compliant AI deployment.
