# Article 147: AI in Autonomous Vehicles – Safety, Liability, and Regulation

## TL;DR

Autonomous vehicles represent one of the most complex AI governance challenges. Lives are literally at stake. The technology promises to reduce the 40,000+ annual U.S. traffic deaths (most caused by human error), but it introduces new risks: software failures, sensor limitations, edge cases the AI wasn't trained for, and cybersecurity vulnerabilities. The regulatory framework is still evolving—a patchwork of federal guidance, state laws, and international approaches. Liability questions are unresolved: when an autonomous vehicle crashes, is the "driver" responsible? The manufacturer? The software developer? This article covers the technology, the regulatory landscape, safety challenges, liability questions, and the governance frameworks emerging for this transformative technology.

---

## Introduction

In March 2018, an Uber autonomous test vehicle struck and killed a pedestrian in Tempe, Arizona. Elaine Herzberg became the first known pedestrian killed by a self-driving car. The vehicle's AI detected her but classified her as a "false positive" and didn't brake. The human safety driver wasn't watching the road.

The incident highlighted everything complex about autonomous vehicles: AI systems that can fail in unexpected ways, the challenge of edge cases, the question of human oversight, the unclear liability, and the life-and-death stakes.

Autonomous vehicles promise enormous benefits. Human error causes roughly 94% of serious crashes. A fully autonomous future could save tens of thousands of lives annually, give mobility to the elderly and disabled, reduce traffic, and transform transportation. But getting there safely requires solving some of the hardest problems in AI governance.

This article explores AI in autonomous vehicles: the technology, the safety challenges, the regulatory landscape, the liability questions, and how governance frameworks are developing for vehicles that drive themselves.
