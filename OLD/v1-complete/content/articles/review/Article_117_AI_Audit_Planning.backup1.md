# Article 117: AI Audit Planning – Scope, Criteria, and Methodology

## TL;DR

Planning an AI audit is like planning a home inspection before buying a house—you need to decide what to look at, what standards to measure against, and how to conduct the examination. The three pillars of AI audit planning are: (1) Scope—which AI system, which aspects, and how deep to go; (2) Criteria—the standards and benchmarks you'll measure against; and (3) Methodology—the step-by-step approach you'll follow. A well-planned audit saves time, reduces costs, and produces more useful findings. Rush the planning, and you'll waste effort examining things that don't matter while missing problems that do.

---

## Introduction

Picture yourself as a restaurant health inspector. You wouldn't just walk into a kitchen and start looking around randomly. Before you arrive, you'd know exactly what you're checking (food storage temperatures, hand-washing facilities, pest control), what standards apply (local health codes), and how you'll conduct the inspection (visual checks, temperature readings, document reviews).

AI auditing works the same way. The planning phase determines whether your audit will be thorough and valuable—or scattered and superficial.

Many organizations make the mistake of jumping straight into technical testing without proper planning. They end up drowning in data without knowing what matters, measuring against vague standards, and producing reports that executives can't act upon.

This article walks you through the three pillars of audit planning: defining your scope, establishing your criteria, and designing your methodology. By the end, you'll understand how to structure an AI audit that produces clear, actionable findings.
