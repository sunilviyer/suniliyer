# Article 131: Open Source AI – Benefits, Risks, and Governance

## TL;DR

Open source AI makes AI models freely available for anyone to use, modify, and distribute. This democratizes access, enables innovation, and provides transparency into how AI systems work. But it also creates risks: bad actors can use open AI for harm, safety guardrails can be removed, and there's no central authority controlling how the technology is used. The governance challenge is balancing the real benefits of openness against the real risks. Different models exist—from fully open (weights, code, and training data) to "open weights" (model available but training details private). Organizations using open source AI need governance frameworks addressing security, compliance, and responsible use.

---

## Introduction

In February 2023, Meta released Llama, a powerful language model, to the research community. Within days, it leaked online and became available to anyone. Within weeks, people around the world were running their own AI systems, building applications, and—in some cases—removing the safety restrictions Meta had built in.

This wasn't entirely what Meta planned, but they later embraced it. Llama 2 and Llama 3 were released openly, with Meta arguing that open access to AI benefits everyone.

Meanwhile, companies like OpenAI (which, despite its name, keeps its most powerful models proprietary) argue that some AI is too dangerous to release openly. They believe controlled access is necessary for safety.

This debate sits at the heart of AI governance: Should powerful AI be open for everyone, or controlled by a few? The answer affects innovation, safety, competition, and who benefits from AI.

This article explores what open source AI actually means, its genuine benefits and risks, and how organizations should govern their use of open AI systems.
