# Autonomous Weapons – The AI Arms Race

## TL;DR

Autonomous weapons systems (AWS)—weapons that can select and engage targets without human intervention—represent one of the most consequential applications of AI. These aren't science fiction; they're being developed and deployed today. The technology raises profound ethical questions: Should machines make life-and-death decisions? Can autonomous weapons comply with international humanitarian law? What happens when AI makes mistakes in combat? A global arms race is underway, with major powers investing billions in autonomous military systems. International efforts to regulate these weapons have stalled, leaving a governance vacuum. While most business leaders won't directly develop weapons, understanding this issue matters: it shapes public perception of AI, influences regulation, and raises questions about dual-use technology that affects every organization working with AI.

---

## Introduction

In March 2020, a Turkish-made Kargu-2 drone allegedly hunted down and attacked retreating soldiers in Libya without any human command. According to a United Nations report, the autonomous drone used its onboard AI to identify, track, and engage targets on its own.

If confirmed, this would mark a threshold moment in military history: the first time an autonomous weapon killed humans without human authorization.

The incident remains disputed—Turkish officials deny the drone operated autonomously. But the debate itself reveals how close we are to a world where machines decide who lives and dies.

Autonomous weapons systems (AWS) represent the sharpest edge of AI's dual-use dilemma. The same computer vision that enables self-driving cars can guide missiles. The same decision-making algorithms that recommend products can select targets. The same AI that transforms business can transform warfare—with consequences that extend far beyond the battlefield.

This article examines autonomous weapons: what they are, who's developing them, why they matter, and what's being done—or not done—to govern them. Even if you never work on military applications, understanding this issue is essential for anyone working with AI.
