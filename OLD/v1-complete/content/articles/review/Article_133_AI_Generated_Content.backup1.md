# Article 133: AI-Generated Content – Authenticity and Attribution

## TL;DR

AI can now create text, images, audio, and video that's increasingly hard to distinguish from human-made content. This creates serious problems: How do we know what's real? Who made this content? Should AI-generated material be labeled? The stakes range from annoying (fake reviews) to dangerous (election disinformation). Solutions include disclosure requirements (labeling AI content), technical approaches (watermarking, detection tools), and platform policies. The EU AI Act and other regulations are starting to mandate disclosure. For organizations, this means developing policies on when and how to label AI-generated content, and being prepared for a world where authenticity is harder to verify.

---

## Introduction

In March 2023, an image of Pope Francis wearing a puffy white designer jacket went viral. Millions of people saw it. Many believed it was real. It wasn't—it was generated by Midjourney, an AI image tool.

The Pope jacket was harmless fun. But the same technology can create:
- Fake statements from political leaders
- Fabricated evidence in legal cases
- Non-consensual intimate images of real people
- Fraudulent product reviews and testimonials
- Fabricated news stories and photographs

We're entering an era where seeing is no longer believing. AI can generate content that looks authentic but isn't—and the technology is getting better fast.

This article explores the challenges of authenticity and attribution in an age of AI-generated content, the emerging regulatory and technical responses, and what organizations need to do.
