# Article 54: Foundation Model Obligations – What the EU AI Act Requires

## TL;DR
Foundation models (like GPT, Claude, or Gemini) get special rules under the EU AI Act because they can be used for almost anything. All foundation model providers must document their models and comply with copyright law. The most powerful ones (those with "systemic risk") face extra requirements: evaluations, safety testing, incident reporting, and cybersecurity standards. If you build on top of a foundation model, you inherit some of these obligations too. The rules kicked in August 2025.

---

## Introduction

Here's a puzzle the EU faced: How do you regulate an AI system when you don't know what it will be used for?

Traditional AI systems have specific purposes. A hiring algorithm screens resumes. A credit scoring system evaluates loan applications. You can assess the risks based on how it's used.

But foundation models—the large AI systems that power tools like ChatGPT, Claude, and Gemini—are different. They're trained on massive datasets to be general-purpose. Someone can use them to write poetry, debug code, answer customer questions, or generate legal contracts.

The same model might be low-risk (helping with creative writing) or high-risk (assisting with medical diagnosis) depending entirely on how it's deployed.

The EU's solution was to create special rules for these "General-Purpose AI" (GPAI) models, with extra obligations for the most powerful ones. This article explains what those rules are and who they apply to.
