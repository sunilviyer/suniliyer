# Article 132: AI and Copyright – The Unresolved Legal Questions

## TL;DR

AI and copyright law are on a collision course. Three big unresolved questions dominate: (1) Can AI companies use copyrighted material to train AI systems without permission? (2) Who owns what AI creates—the AI company, the user, or no one? (3) Does AI-generated content infringe copyright if it resembles existing works? Courts and legislatures worldwide are wrestling with these questions, with major lawsuits pending against OpenAI, Stability AI, and others. The answers will reshape creative industries, AI development, and how businesses use AI. Right now, there's significant legal uncertainty—organizations using AI need to understand the risks and watch for developing case law.

---

## Introduction

In January 2023, a group of artists filed a lawsuit against Stability AI, Midjourney, and DeviantArt. Their claim: these AI image generators had been trained on billions of images scraped from the internet—including the artists' copyrighted work—without permission or compensation.

A few months later, the New York Times sued OpenAI and Microsoft, alleging that ChatGPT was trained on millions of Times articles and can reproduce substantial portions of their content.

These lawsuits represent a fundamental clash between two worlds: the copyright system that has protected creative works for centuries, and AI systems that learn by consuming vast quantities of existing content.

The stakes are enormous. If AI companies must license all training data, the cost of AI development could become prohibitive. If they don't, creative professionals might see their work used to train systems that compete with them—without compensation.

This article explains the key legal questions, the major lawsuits and their implications, and what organizations should know while navigating this uncertainty.
