# Article 119: AI Audit Findings – Writing Effective Reports

## TL;DR

An AI audit report is only valuable if people read it and act on it. The best audit findings follow the "Condition-Criteria-Cause-Consequence-Recommendation" (5C) structure: what you found, what should have happened, why it happened, what could go wrong, and what to do about it. Write for your audience—executives want summaries and business impact, technical teams want details and specifics. Rate findings by severity to help prioritize action. Avoid common pitfalls like burying the lead, using jargon, making vague recommendations, or presenting opinions as facts. A well-written report turns audit findings into organizational change.

---

## Introduction

You've spent weeks planning your AI audit, collecting evidence, and analyzing data. You've discovered important problems—the hiring AI discriminates against older applicants, documentation is missing, operators aren't properly trained.

Now comes the moment that determines whether all that work matters: writing the report.

A poorly written report gets skimmed and filed away. A well-written report gets discussed in boardrooms, drives budget allocation, and changes how the organization uses AI.

The difference isn't about fancy language or impressive charts. It's about clear structure, appropriate detail, and actionable recommendations. This article shows you how to turn your findings into reports that people actually read and act upon.
