# Article 141: AI in Insurance – Fairness, Pricing, and Claims

## TL;DR

Insurance is built on risk assessment—and AI promises to revolutionize how insurers evaluate and price risk. But this creates profound fairness questions. Can insurers use AI to predict individual risk with unprecedented accuracy? Should they? What happens when AI pricing correlates with protected characteristics? This article covers how AI is used in insurance (underwriting, pricing, claims, fraud detection), the regulatory landscape (state insurance commissioners, NAIC guidance, EU requirements), key fairness challenges (proxy discrimination, access to insurance, algorithmic redlining), and governance best practices. Insurance AI sits at the intersection of actuarial science, civil rights, and emerging technology—understanding this landscape is essential for anyone in the industry.

---

## Introduction

Imagine an auto insurer that can predict your likelihood of an accident better than any traditional model—by analyzing your driving behavior, smartphone data, social connections, and hundreds of other variables. Sounds efficient, right?

Now imagine that same AI discovers that people in certain neighborhoods, or with certain names, or who shop at certain stores, are statistically more likely to file claims. The AI doesn't explicitly use race—but the variables it uses correlate with race. Is that discrimination? Is it accurate risk assessment? Is there a difference?

These aren't hypothetical questions. They're the daily reality of AI in insurance.

Insurance has always been about risk discrimination—charging more to higher-risk customers is the fundamental business model. But AI changes the game. It can find patterns humans never could. It can price risk at individual, not just group, levels. And it can perpetuate or amplify historical biases embedded in the data it learns from.

This article explores AI in insurance: where it's used, how it's regulated, what fairness challenges arise, and how to govern it responsibly.
