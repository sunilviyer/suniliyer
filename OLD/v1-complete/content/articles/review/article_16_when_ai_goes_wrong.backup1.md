...
AI systems can cause harm in five main ways: (1) harms to individuals like discrimination or safety risks, (2) harms to specific groups through bias amplification, (3) harms to society like threats to democracy or job displacement, (4) harms to organizations through reputation damage or legal liability, and (5) harms to the broader ecosystem including environmental damage. Understanding this taxonomy helps organizations anticipate, prevent, and respond to AI-related problems before they become crises.

---

## Introduction

In March 2018, an Uber self-driving car struck and killed a pedestrian in Arizona. The AI system detected the woman six seconds before impact but failed to identify her as a person crossing the street. This tragedy wasn't just a technical failure—it was a devastating reminder that when AI systems go wrong, the consequences can be fatal.

But death is just one extreme on a spectrum of AI harms. Every day, less dramatic but equally important harms occur: a job applicant rejected by a biased hiring algorithm, a patient misdiagnosed by a medical AI, a person denied a loan because of their zip code. These harms don't make headlines, but they affect millions of people.

If you're a CEO, HR leader, or anyone responsible for deploying AI in your organization, understanding how AI can cause harm is no longer optional—it's essential. This article provides a practical framework for categorizing AI harms, complete with real-world examples that will help you identify risks in your own AI initiatives.

Think of this as a field guide to AI failures. By understanding the different ways AI can go wrong, you'll be better equipped to prevent these failures in your organization.
