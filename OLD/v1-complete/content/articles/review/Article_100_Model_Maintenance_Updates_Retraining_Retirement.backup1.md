# Article 100: Model Maintenance – Updates, Retraining, and Retirement

## TL;DR

Deploying an AI model isn't the finish line—it's the starting line for ongoing maintenance. Models degrade over time as data patterns change, requiring updates, retraining, or eventually retirement. Model maintenance includes scheduled retraining (refreshing the model with new data), triggered retraining (responding to drift or degradation), updates (improving features or architecture), and retirement (gracefully ending a model's life when it's no longer viable). This article covers when and how to maintain models, how to decide between updating and replacing, and how to retire models responsibly—because most AI governance failures happen not at deployment, but in the months and years that follow.

---

## Introduction

A credit scoring model was deployed in 2019 with excellent performance. It was still running in 2024—same model, same weights, same features—but the world had changed. COVID had shifted credit patterns. Inflation changed income dynamics. New financial products had emerged.

The model was still producing scores. It was still "working." But it was making decisions based on a 2019 view of a 2024 world. Nobody had maintained it because nobody had a maintenance plan.

AI models aren't "set and forget." They're more like cars than calculators:
- They need regular maintenance
- Performance degrades over time
- Components may need replacement
- Eventually, they reach end of life

This article covers the full lifecycle of model maintenance—from routine updates to final retirement.
