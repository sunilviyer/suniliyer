# Article 77: Building an AI Risk Register – What to Track and Why

## TL;DR

An AI risk register is a living document that tracks all identified AI risks across your organization—what they are, how severe they are, who owns them, and what you're doing about them. It's the central nervous system of your AI governance program. This article shows you how to build one from scratch: what fields to include, how to categorize AI-specific risks, how to maintain it over time, and how to use it for reporting and decision-making. A good risk register turns abstract AI concerns into manageable, trackable items that drive real action.

---

## Introduction

You've done risk assessments on your AI systems. You've identified concerning issues—potential bias here, explainability problems there, a third-party AI with unknown training data.

Now what?

Without a system to track these risks, they live in scattered documents, individual memories, and meeting notes. Some get addressed; others are forgotten. New team members don't know what risks exist. Leaders can't see the full picture.

This is where an AI risk register comes in.

A risk register is simply a structured list of risks with consistent information about each one. But simplicity doesn't mean unimportant—it's one of the most valuable tools in risk management. Financial services has used them for decades. Cybersecurity teams live by them. AI governance needs them too.

Think of your risk register as:
- An inventory of everything that could go wrong
- A tracking system for what you're doing about it
- A reporting tool for leadership
- An institutional memory that survives staff turnover

This article shows you how to build and maintain an effective AI risk register.
