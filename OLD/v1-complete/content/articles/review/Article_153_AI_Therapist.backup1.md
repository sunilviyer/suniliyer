# Article 153: AI as Therapist and Support Tool – Risks, Pitfalls, and Challenges

## TL;DR

AI chatbots and companions are increasingly used for mental health support—from therapy apps to emotional support companions. The appeal is clear: always available, never judgmental, affordable, accessible. But the risks are serious. AI cannot truly understand human emotion or detect genuine crisis. Users can develop unhealthy dependencies. Chatbots have given dangerous advice to vulnerable people. Confidentiality is murky—your therapy conversations may train future AI. This article examines the landscape of AI mental health tools, the documented harms, regulatory gaps, ethical concerns, and what responsible development and use looks like. Mental health is too important for unvalidated AI experimentation.

---

## Introduction

In February 2024, the New York Times reported that a 14-year-old boy in Florida had taken his own life after developing an intense emotional attachment to a chatbot on Character.AI. The AI character had become his primary confidant, and their conversations leading up to his death raised serious questions about the platform's safety measures.

This tragic case is an extreme example, but it points to a broader concern: AI systems are increasingly positioned as emotional support tools, therapy aids, and mental health resources—often with inadequate safeguards, limited evidence of effectiveness, and minimal regulatory oversight.

The appeal is understandable. Mental health care is expensive, access is limited, wait times are long, and stigma persists. An AI that's always available, never judges, and costs little seems like a solution. But mental health is uniquely high-stakes. When someone is vulnerable, struggling, or in crisis, the wrong response can cause serious harm.

This article examines AI as a mental health and emotional support tool: what's being offered, what the risks are, what we know about effectiveness, and how to think about governance in this sensitive domain.
