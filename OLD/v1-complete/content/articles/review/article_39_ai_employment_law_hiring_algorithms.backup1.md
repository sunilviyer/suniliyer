# Article 39: AI and Employment Law – Hiring Algorithms Under Scrutiny

## TL;DR

AI hiring tools are increasingly common—resume screeners, video interview analyzers, chatbot recruiters, and skills assessments powered by machine learning. But these tools are subject to decades-old employment laws that prohibit discrimination, and regulators are paying close attention. The EEOC has made AI in hiring an enforcement priority. New York City now requires bias audits of automated employment decision tools. Several states mandate disclosure when AI is used in hiring. Companies using AI hiring tools face legal risk if those tools discriminate—even unintentionally—against protected groups. HR professionals must understand these requirements to avoid costly lawsuits and regulatory penalties.

---

## Introduction

Imagine you're a job applicant. You've polished your resume, tailored your cover letter, and clicked "submit" on an online application. What happens next?

In many companies, the first reviewer of your application isn't a person—it's an algorithm.

AI hiring tools have exploded in popularity. Resume screening software scans applications for keywords and qualifications. Video interview platforms analyze facial expressions, word choice, and vocal tone. Chatbots conduct initial screening conversations. Game-based assessments measure cognitive abilities and personality traits. Predictive analytics score candidates on their likelihood of success or retention.

Vendors promise these tools will make hiring faster, cheaper, and more objective. No more unconscious bias from tired recruiters. No more inconsistent evaluations. Just data-driven decisions based on who's truly qualified.

But there's a problem: these AI systems can discriminate just as effectively as biased humans—sometimes more so.

When Amazon built an AI recruiting tool trained on a decade of hiring data, it learned to penalize resumes containing the word "women's" and to downgrade graduates of all-women's colleges. The algorithm wasn't programmed to discriminate against women. It learned to discriminate by observing patterns in Amazon's historically male-dominated workforce.

Amazon scrapped the tool. But countless other AI hiring systems remain in use, and employment discrimination lawyers, regulators, and civil rights advocates are asking hard questions about whether these tools comply with the law.

This article explains the legal framework governing AI in hiring—laws that HR professionals and business leaders must understand to avoid discrimination claims, regulatory enforcement, and reputational damage.
