# Article 75: AI Risk Assessment Templates – Tools for Practitioners

## TL;DR

This article provides ready-to-use templates for AI risk assessment. You'll find templates for: initial risk screening (quick triage), comprehensive risk assessment (detailed analysis), risk registers (ongoing tracking), and specialized assessments (bias, privacy, safety). Each template is designed for practitioners—fill in the blanks, follow the process, and produce professional documentation. Templates are based on NIST AI RMF, ISO 31000, and EU AI Act requirements. Copy, adapt, and use them immediately in your organization.

---

## Introduction

You've read about AI risk management frameworks. You understand the principles. But when you sit down to actually assess an AI system, where do you start?

This is the blank page problem. Frameworks tell you what to consider, but not exactly what to write down. Guidelines explain principles, but not the specific questions to answer.

What you need are templates.

Good templates save time, ensure consistency, and help you cover all the important areas. They turn abstract guidance into concrete documentation.

This article provides a collection of practical AI risk assessment templates. These aren't theoretical—they're designed for practitioners who need to document real AI systems. Each template includes:
...
Take what works, adapt what doesn't, and build your own toolkit.
