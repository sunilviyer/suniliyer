# Article 52: EU AI Act Risk Classification – Prohibited, High-Risk, and Beyond

## TL;DR
The EU AI Act sorts AI systems into four risk categories like a traffic light system. Red light (Prohibited): completely banned AI practices like social scoring. Yellow light (High-Risk): heavily regulated AI like hiring tools and credit scoring. Amber light (Limited Risk): requires transparency, like telling people they're talking to a chatbot. Green light (Minimal Risk): most AI with no special rules. Your first job under the EU AI Act is figuring out where your AI sits on this spectrum.

---

## Introduction

Imagine you're at an airport security checkpoint. Not everyone gets the same level of screening. A passenger with a small carry-on might walk through a metal detector. Someone with checked luggage gets their bags X-rayed. A flagged individual might face additional questioning.

The EU AI Act works the same way. Not all AI systems are treated equally—because not all AI systems pose the same risks.

A spam filter that misdirects an email is annoying. An AI that wrongly denies someone a job, a loan, or their freedom is devastating. The EU recognized this and built its entire regulatory framework around one central concept: **risk classification**.

Understanding where your AI system falls in this classification is the most critical first step for compliance. Get it wrong, and you might be treating a high-risk system like it's no big deal—or wasting resources over-complying with rules that don't apply to you.

Let's walk through each category in plain English, with real examples you'll recognize.
...
```
   ...
   /--------------\
  /     ✓         \  MINIMAL RISK (No AI-specific rules)
 /------------------\
```

The higher you go on the pyramid, the fewer AI systems there are—but the stricter the rules.

---

## Level 1: Prohibited AI Practices (The Red Zone)

Some AI applications are considered so dangerous to fundamental rights and democratic values that the EU banned them outright. These aren't just heavily regulated—they're **illegal**.
...
*Limited exceptions*: Finding kidnapping victims, preventing imminent terrorist attacks, or locating suspects in serious crimes—but only with judicial authorization and strict safeguards.
...
*Note*: Remember, emotion recognition in workplaces and schools is banned entirely—this applies to other contexts where it's permitted.
...
These systems pose minimal risk to fundamental rights. If something goes wrong—your spam filter misses an email, or your game's AI opponent does something weird—the consequences are minor.
...
Risk classification is the foundation of EU AI Act compliance. Everything else—documentation, conformity assessment, monitoring—flows from how your AI system is classified.
...
The challenge: you need to honestly assess your AI systems against these criteria. Wishful thinking doesn't change your classification—and regulators will eventually check.
