# Article 65: Global AI Law Tracker – Who's Regulating What

## TL;DR

AI regulation is happening everywhere, but every country is doing it differently. The EU has comprehensive rules (AI Act), the US has a patchwork of state laws and federal guidance, China controls AI tightly with content requirements, and many other countries are somewhere in between. For global businesses, this means keeping track of dozens of different requirements. Key patterns: most countries focus on high-risk AI, transparency requirements are nearly universal, and enforcement is ramping up worldwide. This article maps out who's regulating what, so you can understand the global landscape at a glance.

---

## Introduction

Imagine you're running a global company that uses AI for customer service, hiring, and fraud detection. Your AI systems serve customers in 50 countries. How many different AI laws do you need to follow?

The answer is: a lot, and the number keeps growing.

AI regulation has exploded from a niche topic to a global priority in just a few years. In 2020, only a handful of countries had anything resembling AI rules. By 2024, over 60 countries have either passed AI laws, proposed legislation, or issued binding guidance.

This creates a challenge for anyone working in AI governance. You can't just learn one set of rules—you need to understand a constantly shifting global landscape.

Think of it like international trade regulations, but messier. At least with trade, there are decades of established frameworks. AI regulation is being invented in real-time, with different countries making different choices based on their own priorities, cultures, and economic interests.

This article gives you a comprehensive map of who's doing what in AI regulation worldwide. We'll cover the major players, regional trends, and patterns that help make sense of this complex landscape.
