# Article 13: Multimodal AI – When Machines See, Hear, and Speak

## Introduction

For decades, AI systems were specialists. One system understood text. Another recognized images. A third processed audio. They were like sensory-deprived experts—brilliant in their narrow domain, completely blind to everything else. A language model could write eloquently about the Mona Lisa but couldn't actually see the painting.

That's changing. The latest generation of AI systems are multimodal—they can process and generate multiple types of data: text, images, audio, and video. GPT-4V can look at a photograph and discuss what it sees. Gemini can watch a video and answer questions about it. DALL-E can create images from text descriptions. These systems don't just process different modalities separately; they understand the relationships between them.

For governance professionals, multimodality creates new capabilities and new risks. An AI that can see raises different concerns than one that can only read. An AI that generates images creates different liability questions than one that generates text. This article explains how multimodal AI works, what it can do, and what governance challenges it presents.
...
Multimodal AI refers to systems that can process, understand, or generate multiple types of data (modalities). The most common modalities are:
...
|-------|--------|---------|
| Text | Image | "Generate an image of a sunset over mountains" |
| Image | Text | "Describe what's in this photograph" |
| Text + Image | Text | "Answer questions about this chart" |
| Audio | Text | Speech transcription |
| Text | Audio | Text-to-speech synthesis |
| Video | Text | "Summarize what happens in this video" |

### Unimodal vs. Multimodal

**Unimodal systems:**
- Process one type of data
- Text-only: GPT-3, original ChatGPT
- Image-only: Earlier image classifiers
- Audio-only: Speech recognition systems

**Multimodal systems:**
- Process multiple types of data
- Can translate between modalities
- Understand cross-modal relationships
- GPT-4V, Claude 3 (with vision), Gemini

**Why multimodality matters:**
- The world is multimodal—humans communicate through text, images, and speech
- Documents contain text and images together
- Videos combine visual and audio information
- Many tasks require understanding multiple modalities
