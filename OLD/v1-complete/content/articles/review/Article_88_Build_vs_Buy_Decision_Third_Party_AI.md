# Article 88: The Build vs. Buy Decision – When to Use Third-Party AI

## TL;DR

When you need AI, you have three main paths: build it yourself, buy a ready-made solution, or use AI APIs/platforms as building blocks. Building gives you full control and customization but requires significant investment in talent, time, and infrastructure. Buying is faster and often cheaper initially but limits customization and creates vendor dependency. APIs offer middle ground—quick to start, flexible—but you're dependent on someone else's model. The right choice depends on how strategic the AI is to your business, how unique your requirements are, what resources you have, and what risks you can accept. This article provides a framework for making this decision well.

---

## Introduction

A company I know wanted to add AI-powered customer service. They faced a choice:

**Option A: Build it themselves**
Hire data scientists, collect training data, develop models, build infrastructure, maintain everything. Estimated time: 12-18 months. Cost: $2-3 million first year.

**Option B: Buy a vendor solution**
Select from established customer service AI platforms, configure it, integrate it. Estimated time: 2-3 months. Cost: $200K-500K first year.

**Option C: Use AI APIs**
Build on top of an LLM API (like GPT or Claude), develop custom logic, handle integration. Estimated time: 3-6 months. Cost: $300K-800K first year depending on usage.

They chose Option B. Was that right?

It depends. For them, customer service AI wasn't a competitive differentiator—it was operational efficiency. Speed mattered more than customization. They didn't have AI talent. Option B was right.

But for another company—one where AI is the core product, where unique capabilities matter—Option A might be essential.

This article helps you make that decision for your situation.
