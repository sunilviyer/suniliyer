# Article 60: California AI Regulations – The Golden State's Approach

## TL;DR

California, home to Silicon Valley and many of the world's leading AI companies, is taking a multi-pronged approach to AI regulation. Rather than passing one comprehensive law, California has enacted multiple targeted measures: transparency requirements for generative AI training data (AB 2013), deepfake regulations, bot disclosure laws, and proposed safety requirements for large AI models (SB 1047, vetoed but influential). California's approach matters because the state often sets national trends—just as CCPA influenced privacy laws nationwide, California's AI laws may preview what's coming across the US.

---

## Introduction

California is an AI paradox. It's home to Silicon Valley, OpenAI, Anthropic, Google DeepMind, Meta AI, and countless AI startups. It produces more AI research and development than most countries. And yet, California is also increasingly skeptical of letting AI develop without guardrails.

For executives and governance professionals, understanding California matters for three reasons:

1. **Direct application**: If you do business with Californians (about 12% of Americans), California law often applies to you
2. **Trendsetting**: California's regulations frequently become de facto national standards
3. **Innovation center**: What's happening in California's AI labs today becomes tomorrow's workplace tools

Unlike some jurisdictions pursuing comprehensive AI legislation (like the EU or Colorado), California has taken a piecemeal approach—passing multiple laws targeting specific AI issues. This article unpacks California's AI regulatory landscape and what it means for your business.
