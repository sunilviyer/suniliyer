# Article 59: NYC Local Law 144 – Automated Employment Decision Tools

## TL;DR

New York City's Local Law 144 is the first US law specifically regulating AI in hiring. Effective since July 2023, it requires employers using "automated employment decision tools" (AEDTs) to conduct annual bias audits, publish the results, and notify job candidates when AI is evaluating them. If your company uses AI to screen resumes, score interviews, or filter applicants for NYC jobs, you must comply. The law has faced criticism for being both too weak (easy to comply technically) and too burdensome (expensive audits), but it's already influencing how companies nationwide approach hiring AI.

---

## Introduction

You just applied for your dream job in New York City. You spent hours perfecting your resume, crafting a tailored cover letter, and double-checking every detail. You click "submit" and wait anxiously for a response.

What you don't realize is that before any human sees your application, an AI system has already scored you. Based on patterns in your resume, keywords in your cover letter, and perhaps even your video interview, the algorithm has decided whether you're worth a recruiter's time.

This scenario plays out millions of times every day across American companies. And in New York City, lawmakers decided that if AI is making these gatekeeping decisions, there should be some basic protections for job seekers.

Local Law 144 (LL 144) is New York City's answer to AI in hiring. It's the first law in the US specifically targeting automated employment decision tools, and it's already shaping how companies nationwide think about AI-powered recruiting.

This article explains what the law requires, how companies are responding, and what it means for the future of hiring technology.
