...
async function validateHistoryArticles() {
  const issues: ValidationIssue[] = [];

  console.log('\n╔══════════════════════════════════════════════════════════════╗');
  console.log('║         HISTORY ARTICLES VALIDATION REPORT                   ║');
  console.log('╚══════════════════════════════════════════════════════════════╝\n');

  // Get all history articles
  ...
  console.log(`Found ${articles.length} history articles\n`);
  ...
  if (errors.length === 0 && warnings.length === 0) {
    console.log('✅ All history articles are valid!\n');
  }
...
validateHistoryArticles().catch(console.error);
