...
export default async function WhatAIActuallyIsPage() {
  ...
  const cards = await getCardsByArticle('what-ai-actually-is');
  ...
  return (
    <ArticlePageWrapper
      ...
      cards={cards}
    >
      <WhatAIActuallyIsContent />
    </ArticlePageWrapper>
  );
}

function WhatAIActuallyIsContent() {
  return (
    <>
      {/* Main Content */}
      ...
      <div className="content-p">
        ...
        <InlineContextCard cardId="ex-dartmouth-workshop" trigger="1956 Dartmouth Workshop" />, where the term &quot;artificial intelligence&quot; was first coined by scientists who were perhaps a bit too optimistic about how fast we would solve it.
      </div>
      ...
      <div className="content-p">
        ...
        <InlineContextCard cardId="fw-eu-ai-act" trigger="EU AI Act" />, now point to a shared map.
      </div>
      ...
      <div className="content-p">
        ...
        <InlineContextCard cardId="fw-oecd-ai-principles" trigger="OECD AI Principles" />{' '}
      ...
      <WhatAIActuallyIsFooter />
    </>
  );
}

function WhatAIActuallyIsFooter() {
  return (
    <>
      {/* Key Learnings */}
      <KeyLearnings
      ...
      <div style={{ marginTop: '60px' }}>
        <div style={{ marginTop: '20px' }}>
          <Accordion title="Additional Resources">
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              <li style={{ fontFamily: 'Crimson Pro, Georgia, serif', fontSize: '17px', lineHeight: '1.7', padding: '12px 0', borderBottom: '1px solid rgba(26, 26, 26, 0.06)' }}>OECD AI Principles - Official Framework Documentation</li>
              <li style={{ fontFamily: 'Crimson Pro, Georgia, serif', fontSize: '17px', lineHeight: '1.7', padding: '12px 0', borderBottom: '1px solid rgba(26, 26, 26, 0.06)' }}>EU AI Act - Complete Regulation Text (EU 2024/1689)</li>
              <li style={{ fontFamily: 'Crimson Pro, Georgia, serif', fontSize: '17px', lineHeight: '1.7', padding: '12px 0', borderBottom: '1px solid rgba(26, 26, 26, 0.06)' }}>ISO/IEC 22989:2022 - Artificial Intelligence Concepts and Terminology</li>
              <li style={{ fontFamily: 'Crimson Pro, Georgia, serif', fontSize: '17px', lineHeight: '1.7', padding: '12px 0', borderBottom: '1px solid rgba(26, 26, 26, 0.06)' }}>The Master Algorithm - Pedro Domingos (Book on ML fundamentals)</li>
              <li style={{ fontFamily: 'Crimson Pro, Georgia, serif', fontSize: '17px', lineHeight: '1.7', padding: '12px 0' }}>AI Governance in Practice - MIT Sloan Management Review</li>
            </ul>
          </Accordion>
        </div>
        ...
        <div style={{ marginTop: '20px' }}>
          <Accordion title="Sources & References">
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              <li style={{ fontFamily: 'Crimson Pro, Georgia, serif', fontSize: '17px', lineHeight: '1.7', padding: '12px 0', borderBottom: '1px solid rgba(26, 26, 26, 0.06)' }}>OECD (2024). OECD AI Principles - Recommendation of the Council on Artificial Intelligence</li>
              <li style={{ fontFamily: 'Crimson Pro, Georgia, serif', fontSize: '17px', lineHeight: '1.7', padding: '12px 0', borderBottom: '1px solid rgba(26, 26, 26, 0.06)' }}>European Commission (2024). Regulation (EU) 2024/1689 - EU AI Act</li>
              <li style={{ fontFamily: 'Crimson Pro, Georgia, serif', fontSize: '17px', lineHeight: '1.7', padding: '12px 0', borderBottom: '1px solid rgba(26, 26, 26, 0.06)' }}>ISO/IEC (2022). ISO/IEC 22989:2022 - Information Technology — Artificial Intelligence — Concepts and Terminology</li>
              <li style={{ fontFamily: 'Crimson Pro, Georgia, serif', fontSize: '17px', lineHeight: '1.7', padding: '12px 0', borderBottom: '1px solid rgba(26, 26, 26, 0.06)' }}>McCarthy, J., Minsky, M., Rochester, N., Shannon, C. (1956). A Proposal for the Dartmouth Summer Research Project on Artificial Intelligence</li>
              <li style={{ fontFamily: 'Crimson Pro, Georgia, serif', fontSize: '17px', lineHeight: '1.7', padding: '12px 0' }}>Russell, S., Norvig, P. (2020). Artificial Intelligence: A Modern Approach (4th Edition)</li>
            </ul>
          </Accordion>
        </div>
      </div>
