...
const historyCards = [
  {
    ...
    tldr: 'Demystifying artificial intelligence: Understanding the technology reshaping our world',
    image: 'what-ai-actually-is.webp',
    era: '1950s',
  ...
  },
  {
    ...
    image: 'generative-ai-explained.webp',
    era: '2022-Present',
        ...
        <div className="headline-grid">
          ...
          <div className="headline-sidebar">
            ...
            <nav className="paths-nav">
              <Link href="/history" className="path-link active">
                History
              </Link>
          ...
          <div className="headline-content">
            <div className="headline-image-card">
              ...
              <div className="headline-overlay">
                ...
                <p>Trace AI&apos;s evolution from 1950s academic conferences to today&apos;s foundation models. Understand what AI is, how it works, and why it matters.</p>
              </div>
            </div>
          </div>
        </div>
