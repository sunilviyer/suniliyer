...
export async function generateMetadata() {
  return {
    title: 'How Machines Learn - History - Sunil Iyer',
    description: 'The fundamentals of machine learning: Supervised, unsupervised, and reinforcement learning explained',
  };
}
