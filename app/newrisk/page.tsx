...
const riskCards = [
  {
    ...
    tldr: 'Fooling AI systems: understanding attacks that manipulate model predictions with subtle inputs',
    image: 'adversarial-attacks.webp',
    era: 'Security Risk',
  ...
  },
  {
    ...
    title: 'Model Safety',
    slug: 'model-safety',
    tldr: 'Preventing harmful outputs: ensuring AI systems behave safely and as intended',
    image: 'model-safety.webp',
    era: 'Safety Risk',
  ...
  },
  {
    ...
    tldr: 'Synthetic media threats: AI-generated content that spreads false information',
    image: 'deepfakes.webp',
    era: 'Misuse Risk',
  ...
  },
  {
    ...
    title: 'AI Alignment',
    slug: 'ai-alignment',
    tldr: 'Controlling powerful AI: ensuring advanced systems pursue human-aligned goals',
    image: 'ai-alignment.webp',
  ...
  },
  {
    ...
    slug: 'regulatory-challenges',
    tldr: 'Governing AI: navigating policy, regulation, and accountability frameworks',
        ...
        <div className="headline-grid">
          ...
          <div className="headline-sidebar">
            ...
            <nav className="paths-nav">
              ...
              <Link href="/newrisk" className="path-link active">
                Risk
              </Link>
              <Link href="/newresponsibility" className="path-link">
                Responsibility
              </Link>
          ...
          <div className="headline-content">
            <div className="headline-image-card">
              ...
              <div className="headline-overlay">
                ...
                <p>Understanding AI risks from security vulnerabilities to algorithmic bias. Learn about adversarial attacks, data privacy, model safety, and ethical concerns.</p>
              </div>
            </div>
          </div>
        </div>
