...
const terminologyCards = [
  ...
  },
  {
    ...
    tldr: 'Learning from labeled examples: training AI with input-output pairs',
    image: 'supervised-learning.webp',
    era: 'Learning Type',
  ...
  },
  {
    ...
    tldr: 'Finding hidden patterns: AI discovers structure in unlabeled data',
    image: 'unsupervised-learning.webp',
    era: 'Learning Type',
    tags: ['Clustering', 'Patterns']
  },
  {
    id: '5',
    title: 'Natural Language Processing',
    slug: 'natural-language-processing',
    tldr: 'Teaching machines to understand human language: from text analysis to conversation',
    image: 'nlp.webp',
    era: 'Domain',
    tags: ['NLP', 'Language']
  },
  {
    ...
    tldr: 'Enabling machines to see: image recognition, object detection, and visual understanding',
  ...
  },
  {
    ...
    tldr: 'Learning through trial and error: AI agents that optimize decisions through rewards',
  ...
  },
  {
    ...
    tldr: 'Knowledge reuse: applying learnings from one task to accelerate learning in another',
    image: 'transfer-learning.webp',
    era: 'Technique',
    tags: ['Efficiency', 'Adaptation']
  }
];

export default function NewTerminologyPage() {
        ...
        <div className="headline-grid">
          ...
          <div className="headline-sidebar">
            ...
            <nav className="paths-nav">
              ...
              <Link href="/terminology" className="path-link active">
                Terminology
              </Link>
              ...
              <Link href="/future" className="path-link">
                Future
              </Link>
            </nav>
          </div>
          ...
          <div className="headline-content">
            <div className="headline-image-card">
              ...
              <div className="headline-overlay">
                ...
                <p>Master AI terminology from machine learning to neural networks. Understand supervised vs. unsupervised learning, deep learning architectures, and foundation models.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="timeline-section">
        <div className="container">
          ...
          <div className="history-cards">
            {terminologyCards.map((card, index) => (
              <article
                key={card.id}
                ...
                <Link href={`/articles/${card.slug}`} className="card-link">
                  <div className="card-media">
                    <div className="card-image-wrapper">
                      <Image
                        src={`/images/terminology/${card.image}`}
                        alt={card.title}
                        fill
