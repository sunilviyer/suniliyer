...
export default function GitaExperience() {
  ...
  // Sample image - this will show as background
  const sampleImage = "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1920&q=80";
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Image layer - shows the uploaded image position */}
                ...
                {activeLayer < 3 && (
                  <div style={{ textAlign: 'center', marginTop: 20 }}>
                    <button
                      ...
                      onMouseOver={(e) => {
                        e.target.style.backgroundColor = selectedMoment.accentColor;
