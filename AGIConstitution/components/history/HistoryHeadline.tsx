...
interface HistoryHeadlineProps {
  title: string;
  description: string;
}

export function HistoryHeadline({ title, description }: HistoryHeadlineProps) {
  return (
    <section className="inner-headline-section">
      <div className="headline-grid">
        ...
        <div className="headline-content">
          ...
          <div className="headline-image-card">
            <Image
              src="/images/history/ai-history-timeline-f.webp"
              alt="AI History Timeline - From Dartmouth to DeepMind"
              fill
      ...
      <style jsx>{`
        ...
        .path-link:hover {
          color: #333d29 !important;
          border-left-color: #333d29 !important;
          padding-left: 40px !important;
          font-weight: 600 !important;
          transform: translateX(4px) !important;
          text-shadow: 0 0 12px rgba(51, 61, 41, 0.4), 0 0 24px rgba(51, 61, 41, 0.2) !important;
        }
