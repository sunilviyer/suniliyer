...
const cardTypeStyles: Record<CardType, {
  ...
  concept: {
    ...
    badgeColor: '#A0AEC0',
    label: 'CONCEPT',
    backgroundImage: '/images/cards/technical-concepts.webp'
  },
  example: {
    color: '#A0847C',
    badgeColor: '#B5A09E',
    label: 'EXAMPLE',
    backgroundImage: '/images/cards/example-cards.webp'
  },
  milestone: {
    color: '#D69E2E',
    badgeColor: '#ECC94B',
    label: 'MILESTONE',
    backgroundImage: '/images/cards/milestone-cards.webp'
  },
  framework: {
    color: '#A0887C',
    badgeColor: '#B5A89E',
    label: 'FRAMEWORK',
    backgroundImage: '/images/cards/framework-cards.webp'
  },
  resource: {
    color: '#7A9E9E',
    badgeColor: '#9EB5B5',
    label: 'RESOURCE',
    backgroundImage: '/images/cards/resource-cards.webp'
  },
  insight: {
    color: '#38A169',
    badgeColor: '#48BB78',
    label: 'INSIGHT',
    backgroundImage: '/images/cards/market-insights.webp'
  },
  scenario: {
    color: '#7A8A9E',
    badgeColor: '#9EA8B5',
    label: 'SCENARIO',
    backgroundImage: '/images/cards/scenario-cards.webp'
  },
  'operational-pattern': {
    color: '#5A67D8',
    badgeColor: '#667EEA',
    label: 'OPERATIONAL PATTERN',
    backgroundImage: '/images/cards/operational-pattern.webp'
  },
  'market-insight': {
    color: '#38A169',
    badgeColor: '#48BB78',
