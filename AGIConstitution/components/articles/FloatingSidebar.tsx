...
const cardTypeConfig = {
  example: {
    label: 'Examples',
    image: '/images/cards/example-cards.webp',
    textColor: '#FFFFFF',
  },
  milestone: {
    label: 'Milestones',
    image: '/images/cards/milestone-cards.webp',
    textColor: '#1a1a1a',
  },
  framework: {
    label: 'Frameworks',
    image: '/images/cards/framework-cards.webp',
    textColor: '#FFFFFF',
  },
  scenario: {
    label: 'Scenarios',
    image: '/images/cards/scenario-cards.webp',
    textColor: '#FFFFFF',
  },
  resource: {
    label: 'Resources',
    image: '/images/cards/resource-cards.webp',
    textColor: '#FFFFFF',
  },
  insight: {
    label: 'Market Insights',
    image: '/images/cards/market-insights.webp',
    textColor: '#FFFFFF',
  },
  concept: {
    label: 'Technical Concepts',
    image: '/images/cards/technical-concepts.webp',
    textColor: '#FFFFFF',
  },
  pattern: {
    label: 'Operational Patterns',
    image: '/images/cards/operational-pattern.webp',
    textColor: '#FFFFFF',
  },
};
