...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    barColor: '#d97706',
    items: [
      { title: 'Author\'s Note', description: 'Introduction & context', image: '/images/constitution/authorsnote.webp', href: '/constitution/authors-note', external: false },
      { title: 'Why Vedas', description: 'Philosophical foundation', image: '/images/constitution/whyvedas.webp', href: '/constitution/context', external: false },
      { title: 'The Constitution', description: 'Full constitutional text', image: '/images/constitution/theconstitution.webp', href: '/constitution', external: false },
      { title: 'Ten Principles', description: 'Core ethical framework', image: '/images/constitution/pillars.webp', href: '/constitution/part-1', external: false },
      { title: 'Closing Declaration', description: 'Final commitments', image: '/images/constitution/declaration.webp', href: '/constitution/part-18', external: false },
    ],
  },
  {
    id: 'portfolio',
