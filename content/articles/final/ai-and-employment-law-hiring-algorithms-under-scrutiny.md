...
relatedConcepts:
  ...
  - technology-employment-discrimination
  - itutor group-settlement
  - vendor-liability
...
image: ai-and-employment-law-hiring-algorithms-under-scrutiny.jpg
imageAlt: AI hiring algorithm review process showing legal framework layers - Title VII, ADEA, ADA requirements with bias audit workflow and employer liability chain
author: Sunil Iyer
readingTime: 20
seoTitle: AI Employment Law - Hiring Algorithm Compliance | Title VII, EEOC, NYC Law 144 Guide
seoDescription: AI hiring tools legal framework - Title VII disparate treatment/impact, ADEA age discrimination, ADA accessibility, NYC Local Law 144 bias audits, Illinois Video Interview Act, EEOC guidance employer liability, four-fifths rule, validation requirements, vendor assessment, compliance strategies.
---

## Summary

AI hiring tools operate within comprehensive employment discrimination legal framework where Title VII of Civil Rights Act 1964 prohibits discrimination based on race, color, religion, sex (including pregnancy, sexual orientation, gender identity), and national origin in companies with 15+ employees through both disparate treatment (intentionally treating people differently due to protected characteristics like refusing to hire women for physically demanding jobs) and disparate impact (neutral practices disproportionately affecting protected groups without business justification like education requirements unnecessarily excluding racial groups). Age Discrimination in Employment Act (ADEA) protects workers 40 and older in 20+ employee companies from AI tools that disproportionately screen out older candidates, use age proxies (graduation year, years of experience caps, "digital native" requirements), or train on historically age-biased data. Americans with Disabilities Act (ADA) prohibits discrimination against qualified individuals with disabilities, requiring accessible AI tools (screen reader compatibility, timed assessment accommodations, game-based assessment alternatives) and raising concerns about AI inadvertently measuring disability-related characteristics rather than job-relevant qualifications (speech impediment candidates scoring poorly on verbal assessments not trained on diverse patterns, facial expression analysis penalizing autism-related characteristics). State and local laws create compliance patchwork - NYC Local Law 144 (2023 effective) requires employers using automated employment decision tools (AEDTs) to conduct annual bias audits by independent auditors calculating impact ratios and scoring rates by demographics, publish audit results on websites, notify candidates at least 10 business days before AI use, disclose assessed qualifications/characteristics and data sources, offer disability accommodation processes; Illinois AI Video Interview Act (2020) requires notification of AI use before video interviews, explanation of how AI works and what it evaluates, applicant consent before AI analysis, limiting video sharing and deleting within 30 days of request; Maryland (2020) requires facial recognition consent. AI hiring tools discriminate through four mechanisms: training data reflecting historical bias (Amazon's resume screener trained on 10 years of male-dominated submissions learned to penalize resumes containing "women's" and downgrade women's college candidates before being scrapped), proxies for protected characteristics where AI uses zip code (correlates with race/socioeconomic status), name (race/ethnicity/gender), graduation year (age), employment gaps (gender caregiving/disability), hobbies (cultural correlations), communication style (cultural variation) producing discriminatory outcomes without directly seeing protected characteristics, measuring wrong characteristics where video interview analysis evaluates facial expressions/eye contact/vocal tone reflecting cultural communication differences rather than qualifications (indirect eye contact cultures scoring poorly for "lack of engagement," autism candidates flagged for "atypical" expressions), gamified assessments measuring gaming convention familiarity over cognitive skills, keyword matching favoring buzzword knowledge over actual skills, and lack of validation where tools never tested for actual job performance prediction fail Uniform Guidelines on Employee Selection Procedures requirements. EEOC May 2023 Technical Assistance Document establishes employers remain liable for discriminatory outcomes even when vendors develop tools ("fact that employer does not design/develop algorithm does not shield from liability"), four-fifths rule applies (adverse impact typically found if protected group selection rate is less than 80% of highest group rate), validation required when tools show adverse impact (must prove job-related and business necessity consistent), less discriminatory alternatives must be considered even if tool validated. EEOC Strategic Enforcement Plan 2024-2028 identifies "technology-related employment discrimination" as priority including algorithmic decision-making, AI/machine learning, automated candidate screening/scoring systems signaling more investigations, enforcement actions, litigation. Enforcement examples include iTutorGroup 2023 settlement (recruiting software programmed to automatically reject female applicants over 55 and male applicants over 60), EEOC v. Facebook (investigating whether ad targeting allowed age-based job advertising discrimination). NYC Local Law 144 implementation reveals challenges: determining AEDT coverage boundaries (blurry line between simple automation and "AI"), audit methodology complexities (prescribed statistical tests difficult to apply creating auditor inconsistencies), vendor unpreparedness (many discontinuing products rather than comply), limited initial enforcement (creating uncertainty about strictness) despite pushing industry toward greater transparency. Illinois Act consent requirement gives candidates control (must use alternative evaluation methods if consent withheld), prompting some employers to reconsider video interview AI altogether questioning whether efficiency gains justify compliance burden and candidate concerns. Employers must conduct vendor due diligence before adoption (requesting development/training documentation, validation study evidence, demographic adverse impact analyses, ongoing monitoring information), legal review of discrimination risk and disclosure requirements across all operating jurisdictions, business justification documentation. During use organizations must monitor selection rates by demographic group at each hiring stage detecting disparate impact before EEOC does, maintain human oversight preventing AI final decisions without review catching errors and checking algorithmic bias, provide accommodation request processes with trained staff, keep comprehensive records (tools used, configurations, results, decision documentation). Organizations cannot outsource Title VII responsibilities to vendors - must conduct own adverse impact analyses, cannot rely solely on vendor assurances, face liability regardless of vendor promises with vendor contracts typically disclaiming discrimination claim liability requiring employers to demand detailed documentation, regular adverse impact reports, contractual indemnification, audit/investigation cooperation. Future regulatory expansion includes federal legislation proposals in Congress, state laws under consideration (California, New Jersey), detailed EEOC guidance expected on specific AI hiring tool types, increasing class action lawsuits challenging AI hiring systems.

## Key Learning Objectives

After reading this article, you will be able to:

1. **Understand employment discrimination framework** - Title VII (disparate treatment/impact), ADEA (age 40+), ADA (disability accessibility/accommodations) applying to AI
2. **Navigate state/local AI laws** - NYC Local Law 144 bias audit/transparency requirements, Illinois Video Interview Act consent provisions, Maryland facial recognition rules
3. **Identify AI discrimination mechanisms** - Historical bias in training data, protected characteristic proxies, wrong characteristic measurement, lack of validation
4. **Analyze Amazon case lessons** - Male-dominated training data teaching AI to penalize female-associated characteristics, detection importance, scrapping decision
5. **Apply EEOC guidance** - Employer liability despite vendor development, four-fifths rule, validation requirements, less discriminatory alternatives consideration
6. **Recognize enforcement priorities** - EEOC Strategic Plan technology discrimination focus, iTutorGroup settlement, Facebook investigation, class action trends
7. **Implement NYC Law 144 compliance** - AEDT determination, annual independent bias audits, result publication, candidate notification, accommodation processes
8. **Conduct vendor assessment** - Due diligence on validation/adverse impact, legal review, business justification documentation, ongoing monitoring requirements
9. **Maintain compliance operations** - Selection rate monitoring by demographics, human oversight requirements, accommodation processes, comprehensive recordkeeping
10. **Understand liability boundaries** - Employer responsibility despite vendor tools, own adverse impact analysis requirements, vendor contract limitations
...
1. U.S. Equal Employment Opportunity Commission. "Assessing Adverse Impact in Software, Algorithms, and Artificial Intelligence Used in Employment Selection Procedures Under Title VII." Technical Assistance Document, May 18, 2023.

2. U.S. Equal Employment Opportunity Commission. "The Americans with Disabilities Act and the Use of Software, Algorithms, and Artificial Intelligence to Assess Job Applicants and Employees." Technical Assistance Document, May 12, 2022.

3. U.S. Equal Employment Opportunity Commission. "Strategic Enforcement Plan Fiscal Years 2024-2028." September 21, 2023.

4. Dastin, Jeffrey. "Amazon scraps secret AI recruiting tool that showed bias against women." Reuters, October 10, 2018.

5. New York City Department of Consumer and Worker Protection. "Automated Employment Decision Tools (Local Law 144)." Rules and guidance, 2023.

6. Illinois General Assembly. "Artificial Intelligence Video Interview Act." 820 ILCS 42.
...
8. Uniform Guidelines on Employee Selection Procedures (1978). 29 CFR Part 1607.
...
12. Raghavan, Manish, et al. "Mitigating Bias in Algorithmic Hiring: Evaluating Claims and Practices." ACM Conference on Fairness, Accountability, and Transparency, 2020.

13. Bogen, Miranda, and Aaron Rieke. "Help Wanted: An Examination of Hiring Algorithms, Equity, and Bias." Upturn, December 2018.
...
*Next: AI and Intellectual Property – Copyright, Patents, and Trade Secrets*
