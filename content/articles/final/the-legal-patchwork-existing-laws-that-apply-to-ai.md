...
image: the-legal-patchwork-existing-laws-that-apply-to-ai.jpg
imageAlt: Patchwork of civil rights laws from different decades overlaying modern AI systems
author: Sunil Iyer
readingTime: 13
seoTitle: The Legal Patchwork - Existing Laws That Apply to AI
seoDescription: Civil rights laws (Title VII, ECOA, Fair Housing Act, ADA, ADEA) apply to AI. Disparate impact doctrine, four-fifths rule testing, proxy discrimination, and real cases (Apple Card, Facebook housing ads, Amazon hiring). Learn compliance requirements.
---

## Summary

Before you wait for AI-specific legislation, understand this: existing civil rights laws already apply to algorithmic decision-making with full force. Title VII (1964) prohibits employment discrimination, ECOA (1974) bans lending discrimination, the Fair Housing Act (1968) addresses housing discrimination, the ADA (1990) protects people with disabilities, and ADEA (1967) prevents age discrimination—all apply to AI systems. The disparate impact doctrine established in Griggs v. Duke Power (1971) means you can violate civil rights laws without intending to discriminate; statistical disparities are enough. Organizations must test AI using the four-fifths rule, avoid proxy discrimination (using factors correlated with protected characteristics), provide adverse action explanations, and document validation efforts. Real cases include Apple Card gender discrimination investigation, Facebook housing ad targeting violations, and Amazon's biased hiring AI. This article explains each law's requirements, how AI creates unique discrimination risks, testing methodologies, fairness metrics, and practical compliance steps.

## Key Learning Objectives

After reading this article, you will be able to:

1. **Identify civil rights laws** that apply to AI (Title VII, ECOA, FHA, ADA, ADEA)
2. **Understand disparate impact** doctrine and how unintentional discrimination is still illegal
3. **Apply the four-fifths rule** to test AI systems for adverse impact
4. **Recognize proxy discrimination** - using factors correlated with protected characteristics
5. **Explain real cases** - Apple Card, Facebook housing ads, Amazon hiring, Upstart lending
6. **Conduct adverse impact testing** - calculate selection rates, apply four-fifths rule, investigate root causes
7. **Understand fairness metrics** - demographic parity, equal opportunity, predictive parity, individual fairness
8. **Implement compliance** - inventory systems, conduct regular testing, establish governance, train staff
...
**Immediate actions:**
- [ ] Inventory all AI systems that affect people (hiring, lending, housing, etc.)
- [ ] Identify which protected characteristics could be impacted
- [ ] Collect demographic data for testing (separated from AI inputs)
- [ ] Review AI inputs for potential proxy discrimination
- [ ] Assess whether AI can provide adverse action explanations

**For high-stakes AI systems:**
- [ ] Calculate selection rates by demographic group
- [ ] Apply four-fifths rule to identify adverse impact
- [ ] Investigate root causes of any disparities found
- [ ] Validate job-relatedness or business necessity
- [ ] Document testing methodology and findings
- [ ] Establish regular monitoring schedule

**Organizational infrastructure:**
- [ ] Assign accountability for anti-discrimination testing
- [ ] Train AI developers on civil rights requirements
- [ ] Train AI users on non-discrimination obligations
- [ ] Establish process for remediation when bias is found
- [ ] Engage legal counsel with civil rights expertise
- [ ] Consider external audits for high-risk systems
...
7. U.S. Equal Employment Opportunity Commission. "Uniform Guidelines on Employee Selection Procedures." 29 CFR Part 1607 (1978).

8. U.S. Equal Employment Opportunity Commission. "The Americans with Disabilities Act and the Use of Software, Algorithms, and Artificial Intelligence to Assess Job Applicants and Employees." May 12, 2022.
