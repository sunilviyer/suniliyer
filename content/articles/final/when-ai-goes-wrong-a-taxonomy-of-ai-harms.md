...
slug: when-ai-goes-wrong-a-taxonomy-of-ai-harms
path: risk
publishDate: 2025-06-20
tldr: AI harms occur across five interconnected levels requiring systematic risk assessment - Individual harms (civil rights violations like HUD charging Facebook with housing discrimination via ad targeting, economic opportunity denial like Amazon's gender-biased recruiting AI, physical safety risks like healthcare algorithm giving Black patients lower risk scores affecting 200M Americans), Group harms (algorithmic discrimination with facial recognition error rates of 34.7% for dark-skinned women vs 0.8% for light-skinned men, bias amplification turning historical patterns into worse outcomes), Societal harms (democracy threats through AI-powered propaganda and deepfakes, misinformation at scale during COVID-19, job displacement affecting 80% of workforce per OpenAI study), Organizational harms (reputational damage like Microsoft's Tay chatbot, legal liability from discriminatory algorithms and consent decrees, cultural erosion from algorithmic decision-making), and Ecosystem harms (environmental impact with GPT-3 training producing 552 tons CO2, resource concentration in few tech companies, supply chain exploitation of data labelers). Understanding this taxonomy enables comprehensive risk assessment, appropriate governance controls for each harm type, and stakeholder-specific communication. Prevention requires pre-deployment impact assessments, designing for vulnerable populations, human oversight for critical decisions, continuous monitoring, and failure response planning.
relatedConcepts:
  - ai-harms-taxonomy
  - individual-harms
  - group-harms
  ...
  - supply-chain-ethics
examples:
  - five-level-ai-harms-case-studies
templates:
  - ai-harm-assessment-framework
crossPathRefs:
  - path: risk
    articles:
...
image: when-ai-goes-wrong-a-taxonomy-of-ai-harms.jpg
imageAlt: Five-level taxonomy of AI harms showing individual, group, societal, organizational, and ecosystem impacts with interconnected relationships
author: Sunil Iyer
readingTime: 12
seoTitle: When AI Goes Wrong - A Taxonomy of AI Harms | Five-Level Risk Framework
seoDescription: Comprehensive AI harms taxonomy - Individual (civil rights, economic denial, physical safety), Group (discrimination, bias amplification), Societal (democracy, misinformation, jobs), Organizational (reputation, liability, culture), Ecosystem (environment, concentration, supply chain). Risk assessment and prevention guide.
---

## Summary

AI harms don't happen in isolation but can be systematically organized into five interconnected categories drawn from NIST AI RMF and OECD frameworks. Individual harms directly affect specific people through civil rights violations (HUD charged Facebook with housing discrimination via ad algorithm allowing landlords to exclude by race/religion/origin even without explicit selection), economic opportunity denial (Amazon's recruiting AI penalized resumes with "women's" after learning from male-favoring historical data), and physical safety risks (hospital algorithm gave Black patients lower risk scores than equally sick white patients, affecting 200M Americans before discovery). Group harms affect entire communities through algorithmic discrimination (Gender Shades project revealed facial recognition error rates of 34.7% for dark-skinned women vs 0.8% for light-skinned men) and bias amplification (hiring algorithms trained on 60/40 gender split produce 80/20 outcomes, worsening existing bias). Societal harms threaten democracy through AI-powered micro-targeted propaganda and deepfake videos, enable misinformation at scale (COVID-19 vaccine misinformation generated thousands of posts per minute), and accelerate job displacement (OpenAI study estimates 80% of workforce affected). Organizational harms include reputational damage (Microsoft's Tay chatbot, Air Canada liable for chatbot misinformation), legal liability from discriminatory algorithms and regulatory violations, and cultural erosion when algorithmic decision-making reduces employee engagement. Ecosystem harms span environmental impact (GPT-3 training: 1,287 MWh electricity, 552 tons CO2, equivalent to 123 cars driven for a year), resource concentration creating dependencies, and supply chain exploitation of data labelers in developing countries exposed to disturbing content. This taxonomy enables comprehensive risk assessment across all harm levels, appropriate governance controls tailored to each type, and stakeholder-specific communication. Prevention requires pre-deployment impact assessments, designing for vulnerable populations, human oversight for high-stakes decisions, continuous monitoring for drift and emerging problems, and preparation for failure response.

## Key Learning Objectives

After reading this article, you will be able to:

1. **Identify five harm categories** - Individual, Group, Societal, Organizational, Ecosystem as comprehensive risk framework
2. **Recognize individual harms** - Civil rights violations, economic opportunity denial, physical safety risks with case examples
3. **Understand group harms** - Algorithmic discrimination patterns, bias amplification mechanisms, disparate impact
4. **Assess societal harms** - Democracy threats (propaganda, deepfakes), misinformation scale, job displacement predictions
5. **Evaluate organizational harms** - Reputational damage cases, legal liability exposure, cultural erosion from automation
6. **Consider ecosystem harms** - Environmental impact calculations, resource concentration effects, supply chain ethics
7. **Apply taxonomy for risk assessment** - Systematic evaluation across all five levels before deployment
8. **Design governance controls** - Tailored safeguards for different harm types (appeals for individual, audits for group, monitoring for societal)
9. **Communicate with stakeholders** - Board focus on organizational risks, regulator focus on societal harms, employee focus on individual impacts
10. **Implement prevention measures** - Impact assessments, design for vulnerable populations, human oversight, monitoring, failure planning
...
**For comprehensive AI harm prevention:**
- [ ] Conduct five-level harm assessment (individual, group, societal, organizational, ecosystem)
- [ ] Identify vulnerable populations most at risk
- [ ] Assess likelihood and severity of each potential harm
- [ ] Design safeguards specific to each harm type
- [ ] Implement appeals process for individual harms
- [ ] Establish demographic monitoring for group harms
- [ ] Coordinate with regulators on societal harms
- [ ] Ensure executive oversight for organizational risks
- [ ] Audit supply chain for ecosystem impacts
- [ ] Create human review for high-stakes decisions
- [ ] Build continuous monitoring for drift and bias
- [ ] Establish incident response procedures
- [ ] Document risk assessment and mitigation
- [ ] Train staff on harm recognition and reporting
- [ ] Test failure response plans

**For stakeholder communication:**
- [ ] Frame board discussions around organizational risks
- [ ] Address regulator concerns about societal harms
- [ ] Communicate with employees about individual impacts
- [ ] Engage civil society on broader implications
- [ ] Report environmental and ecosystem effects
- [ ] Provide transparency appropriate to each audience
