---
title: 'Article 39: AI and Employment Law – Hiring Algorithms Under Scrutiny'
tldr: ''
...
- type: image_prompt
  ...
  prompt: legal documents, scales of justice, regulatory framework visualization,
    ...
    article header
- type: flowchart
  label: Transparency Requirements Process
  section: Transparency Requirements
  id: flowchart-transparency-requirements
- type: flowchart
  label: Requirements Process
  section: Requirements
  id: flowchart-requirements
- type: flowchart
...
- type: template
  label: 'Disparate treatment:'
  section: Title VII of the Civil Rights Act of 1964
  id: template-title-vii-of-the-civil-rights-act-of-1964
  template_link: /templates/disparate-treatment.md
- type: template
  label: 'Disparate impact:'
  section: Title VII of the Civil Rights Act of 1964
  id: template-title-vii-of-the-civil-rights-act-of-1964
  template_link: /templates/disparate-impact.md
- type: template
  label: 'Example:'
  section: Title VII of the Civil Rights Act of 1964
  id: template-title-vii-of-the-civil-rights-act-of-1964
...
- type: template
  label: 'Example:'
  section: The Age Discrimination in Employment Act (ADEA)
  id: template-the-age-discrimination-in-employment-act-adea
  template_link: /templates/example.md
- type: template
  label: 'Example:'
  section: The Americans with Disabilities Act (ADA)
  id: template-the-americans-with-disabilities-act-ada
  template_link: /templates/example.md
- type: template
  label: 'The Amazon Example:'
  section: Training Data Reflects Historical Bias
  id: template-training-data-reflects-historical-bias
  template_link: /templates/the-amazon-example.md
- type: template
  label: 'Example:'
  section: Proxies for Protected Characteristics
  id: template-proxies-for-protected-characteristics
  template_link: /templates/example.md
- type: template
  label: 'Example:'
  section: Lack of Validation
  id: template-lack-of-validation
  template_link: /templates/example.md
- type: list
  label: Bias Audit Requirement
  section: Bias Audit Requirement
  id: list-bias-audit-requirement
- type: list
...
- nyc local law 144
word_count: 3663
processed_date: '2025-12-18T20:06:20.411Z'
---
...
<!-- component:template:template-title-vii-of-the-civil-rights-act-of-1964 -->
...
<!-- component:template:template-the-age-discrimination-in-employment-act-adea -->
...
<!-- component:template:template-the-americans-with-disabilities-act-ada -->
...
<!-- component:template:template-training-data-reflects-historical-bias -->
...
<!-- component:template:template-proxies-for-protected-characteristics -->
...
<!-- component:template:template-lack-of-validation -->
...
<!-- component:list:list-bias-audit-requirement -->
...
<!-- component:flowchart:flowchart-transparency-requirements -->
...
<!-- component:list:list-requirements -->

### Requirements

Employers must:

<!-- component:flowchart:flowchart-requirements -->
