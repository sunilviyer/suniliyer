---
title: 'Article 80: The AI Business Case – ROI, Risks, and Reality Checks'
tldr: ''
...
- type: image_prompt
  ...
  prompt: balanced composition showing risk and safety elements, warning symbols with
    ...
    article header
- type: table
  label: Benefit vs Metric Table
  section: Quantifying Benefits
  id: table-quantifying-benefits
- type: table
  label: Assumption vs Base Case Table
  section: Sensitivity Analysis
  id: table-sensitivity-analysis
- type: table
  label: Category vs Item Table
  section: Building a Comprehensive Cost Model
  id: table-building-a-comprehensive-cost-model
- type: table
  label: Category vs Item Table
  section: Building a Comprehensive Cost Model
  id: table-building-a-comprehensive-cost-model
- type: table
  label: Risk vs Probability Table
  section: Quantifying Risk Exposure
  id: table-quantifying-risk-exposure
- type: table
  label: Alternative vs Cost Table
  section: Structured Alternatives Analysis
  id: table-structured-alternatives-analysis
- type: table
  label: Alternative vs Year 0 Table
  section: Making the Comparison
  id: table-making-the-comparison
- type: flowchart
  label: Introduction Process
  section: Introduction
  id: flowchart-introduction
- type: flowchart
  label: 'Building the Business Case: A Framework Process'
  section: 'Building the Business Case: A Framework'
  id: flowchart-building-the-business-case-a-framework
- type: flowchart
  label: Full Business Case Structure Process
  section: Full Business Case Structure
  id: flowchart-full-business-case-structure
- type: flowchart
...
- type: template
  label: Business Case Template Summary
  section: Business Case Template Summary
  id: template-business-case-template-summary
  template_link: /templates/business-case-template-summary.md
topic_fingerprint:
- risk assessment
- fairness
- audit
...
- nist
word_count: 2153
processed_date: '2025-12-18T20:07:04.872Z'
---
...
<!-- component:flowchart:flowchart-building-the-business-case-a-framework -->
...
<!-- component:table:table-quantifying-benefits -->
|---------|--------|----------|--------|------------|--------------|
...
<!-- component:table:table-sensitivity-analysis -->
|------------|-----------|------------|-------------|
...
| Category | Item | Cost |
<!-- component:table:table-building-a-comprehensive-cost-model -->
|----------|------|------|
...
<!-- component:table:table-quantifying-risk-exposure -->
|------|-------------|--------|----------|-----------------|
...
<!-- component:table:table-structured-alternatives-analysis -->
|-------------|------|----------|------|-----|
...
<!-- component:table:table-making-the-comparison -->
|-------------|--------|--------|--------|--------|-----------|
...
<!-- component:flowchart:flowchart-full-business-case-structure -->
...
<!-- component:template:template-business-case-template-summary -->
