---
title: 'Article 45: The Right to Explanation – What GDPR Actually Requires'
tldr: ''
...
- type: flowchart
  label: The Emerging Consensus Process
  section: The Emerging Consensus
  id: flowchart-the-emerging-consensus
- type: flowchart
  label: What Individual Explanations Should Include Process
  section: What Individual Explanations Should Include
  id: flowchart-what-individual-explanations-should-include
- type: flowchart
...
- type: template
  label: 'Example:'
  section: 'Requirement 1: Disclose the Existence of Automated Decision-Making'
  id: template-requirement-1-disclose-the-existence-of-automated-decision-making
  template_link: /templates/example.md
- type: template
  label: 'Requirement 2: Provide "Meaningful Information About the Logic Involved"'
  section: 'Requirement 2: Provide "Meaningful Information About the Logic Involved"'
  id: template-requirement-2-provide-meaningful-information-about-the-logic-involved
  template_link: /templates/requirement-2-provide-meaningful-information-about-the-logic-involved.md
- type: template
  label: 'Example:'
  section: 'Requirement 2: Provide "Meaningful Information About the Logic Involved"'
  id: template-requirement-2-provide-meaningful-information-about-the-logic-involved
...
- type: template
  label: 'Example:'
  section: 'Requirement 3: Explain Significance and Consequences'
  id: template-requirement-3-explain-significance-and-consequences
  template_link: /templates/example.md
- type: template
  label: 'Example:'
  section: 'Requirement 4: Enable Individuals to Contest Decisions'
  id: template-requirement-4-enable-individuals-to-contest-decisions
  template_link: /templates/example.md
- type: template
  label: 'Example:'
  section: 'Requirement 5: Provide Human Intervention on Request'
  id: template-requirement-5-provide-human-intervention-on-request
  template_link: /templates/example.md
- type: template
  label: 'Example:'
  section: 'Requirement 6: Allow Individuals to Express Their Views'
  id: template-requirement-6-allow-individuals-to-express-their-views
  template_link: /templates/example.md
- type: list
  label: 'Requirement 1: Disclose the Existence of Automated Decision-Making'
  section: 'Requirement 1: Disclose the Existence of Automated Decision-Making'
  id: list-requirement-1-disclose-the-existence-of-automated-decision-making
- type: list
  label: 'Requirement 2: Provide "Meaningful Information About the Logic Involved"'
  section: 'Requirement 2: Provide "Meaningful Information About the Logic Involved"'
  id: list-requirement-2-provide-meaningful-information-about-the-logic-involved
- type: list
  label: 'Requirement 3: Explain Significance and Consequences'
  section: 'Requirement 3: Explain Significance and Consequences'
  id: list-requirement-3-explain-significance-and-consequences
- type: list
  label: 'Requirement 4: Enable Individuals to Contest Decisions'
  section: 'Requirement 4: Enable Individuals to Contest Decisions'
  id: list-requirement-4-enable-individuals-to-contest-decisions
- type: list
  label: 'Requirement 5: Provide Human Intervention on Request'
  section: 'Requirement 5: Provide Human Intervention on Request'
  id: list-requirement-5-provide-human-intervention-on-request
- type: list
  label: 'Requirement 6: Allow Individuals to Express Their Views'
  section: 'Requirement 6: Allow Individuals to Express Their Views'
  id: list-requirement-6-allow-individuals-to-express-their-views
- type: list
  label: Sector-Specific Requirements
  section: Sector-Specific Requirements
  id: list-sector-specific-requirements
- type: list
  label: 'Step 2: Determine Explanation Requirements'
  section: 'Step 2: Determine Explanation Requirements'
  id: list-step-2-determine-explanation-requirements
- type: list
...
- nyc local law 144
word_count: 4049
processed_date: '2025-12-18T20:06:28.577Z'
---
...
<!-- component:flowchart:flowchart-the-emerging-consensus -->
...
<!-- component:list:list-requirement-1-disclose-the-existence-of-automated-decision-making -->
...
<!-- component:template:template-requirement-1-disclose-the-existence-of-automated-decision-making -->
...
<!-- component:template:template-requirement-2-provide-meaningful-information-about-the-logic-involved -->
...
<!-- component:list:list-requirement-3-explain-significance-and-consequences -->
...
<!-- component:template:template-requirement-3-explain-significance-and-consequences -->
...
<!-- component:list:list-requirement-4-enable-individuals-to-contest-decisions -->
...
<!-- component:template:template-requirement-4-enable-individuals-to-contest-decisions -->
...
<!-- component:list:list-requirement-5-provide-human-intervention-on-request -->
...
<!-- component:template:template-requirement-5-provide-human-intervention-on-request -->
...
<!-- component:list:list-requirement-6-allow-individuals-to-express-their-views -->
...
<!-- component:template:template-requirement-6-allow-individuals-to-express-their-views -->
...
<!-- component:flowchart:flowchart-what-individual-explanations-should-include -->
...
<!-- component:list:list-step-2-determine-explanation-requirements -->
