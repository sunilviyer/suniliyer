---
title: 'Article 132: AI and Copyright – The Unresolved Legal Questions'
tldr: ''
...
- type: image_prompt
  ...
  prompt: legal documents, scales of justice, regulatory framework visualization,
    ...
    article header
- type: table
  label: Claimant vs Argument Table
  section: 'Question 2: Who Owns AI-Generated Content?'
  id: table-question-2-who-owns-ai-generated-content
- type: table
  label: Activity vs Risk Level Table
  section: For Organizations Using AI
  id: table-for-organizations-using-ai
- type: flowchart
  label: For Organizations Using AI Process
  section: For Organizations Using AI
  id: flowchart-for-organizations-using-ai
- type: flowchart
  label: For Content Creators Process
  section: For Content Creators
  id: flowchart-for-content-creators
- type: flowchart
...
- type: template
  label: 'Example:'
  section: 'Question 2: Who Owns AI-Generated Content?'
  id: template-question-2-who-owns-ai-generated-content
  template_link: /templates/example.md
- type: template
  label: 'Example:'
  section: 'Question 3: Does AI Output Infringe Existing Copyrights?'
  id: template-question-3-does-ai-output-infringe-existing-copyrights
  template_link: /templates/example.md
topic_fingerprint:
- midjourney
- chatgpt
...
- stability ai
word_count: 2257
processed_date: '2025-12-18T20:05:26.296Z'
---
...
<!-- component:table:table-question-2-who-owns-ai-generated-content -->
|----------|----------|------------------|
...
<!-- component:template:template-question-2-who-owns-ai-generated-content -->
...
<!-- component:template:template-question-3-does-ai-output-infringe-existing-copyrights -->
...
<!-- component:table:table-for-organizations-using-ai -->
|----------|-----------|----------------|
...
<!-- component:flowchart:flowchart-for-organizations-using-ai -->
