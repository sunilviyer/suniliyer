...
- type: table
  ...
  section: 'Step 10: Policy Administration'
  id: table-step-10-policy-administration
- type: table
  label: Audience vs Message Table
  section: 13.1 Communication Plan
  id: table-131-communication-plan
- type: table
  label: Phase vs Activities Table
  section: 13.2 Implementation Timeline
  id: table-132-implementation-timeline
- type: table
  label: Organization Size vs Recommended Length Table
  section: 'Quick Reference: Policy Length Guidelines'
  id: table-quick-reference-policy-length-guidelines
- type: flowchart
  label: What You Need to Gather Process
  section: What You Need to Gather
  id: flowchart-what-you-need-to-gather
- type: flowchart
  label: 12.2 Approval Process Process
  section: 12.2 Approval Process
  id: flowchart-122-approval-process
- type: flowchart
  label: Common Mistakes to Avoid Process
  section: Common Mistakes to Avoid
  id: flowchart-common-mistakes-to-avoid
- type: flowchart
  label: Summary Process
  section: Summary
  id: flowchart-summary
- type: template
  label: 'Article 149: How to Write an AI Policy — A Template-Based Guide'
  section: 'Article 149: How to Write an AI Policy — A Template-Based Guide'
  id: template-article-149-how-to-write-an-ai-policy-a-template-based-guide
  template_link: /templates/article-149-how-to-write-an-ai-policy-a-template-based-guide.md
- type: template
  label: 'Template:'
  section: 1.1 Write the Purpose Statement
  id: template-11-write-the-purpose-statement
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 1.2 Define the Scope
  id: template-12-define-the-scope
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 3.1 Governance Structure
  id: template-31-governance-structure
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 3.2 Role Definitions
  id: template-32-role-definitions
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 4.1 Planning and Initiation Requirements
  id: template-41-planning-and-initiation-requirements
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 4.2 Design and Development Requirements
  id: template-42-design-and-development-requirements
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 4.3 Deployment Requirements
  id: template-43-deployment-requirements
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 4.4 Monitoring and Operations Requirements
  id: template-44-monitoring-and-operations-requirements
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 4.5 Decommissioning Requirements
  id: template-45-decommissioning-requirements
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 5.1 Risk Categories
  id: template-51-risk-categories
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 5.2 Risk Assessment Process
  id: template-52-risk-assessment-process
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 6.1 Generative AI (ChatGPT, Claude, etc.)
  id: template-61-generative-ai-chatgpt-claude-etc
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 6.2 AI in Human Resources
  id: template-62-ai-in-human-resources
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 6.3 Customer-Facing AI
  id: template-63-customer-facing-ai
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 'Step 7: Third-Party and Procurement Requirements'
  id: template-step-7-third-party-and-procurement-requirements
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 'Step 8: Training and Awareness'
  id: template-step-8-training-and-awareness
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 'Step 9: Compliance and Enforcement'
  id: template-step-9-compliance-and-enforcement
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 'Step 10: Policy Administration'
  id: template-step-10-policy-administration
  template_link: /templates/template.md
- type: template
  label: 'Appendix A: AI Risk Assessment Questionnaire'
  section: 'Appendix A: AI Risk Assessment Questionnaire'
  id: template-appendix-a-ai-risk-assessment-questionnaire
  template_link: /templates/appendix-a-ai-risk-assessment-questionnaire.md
- type: template
  label: 'Appendix B: Model Card Template'
  section: 'Appendix B: Model Card Template'
  id: template-appendix-b-model-card-template
  template_link: /templates/appendix-b-model-card-template.md
- type: template
  label: 'Template:'
  section: 13.1 Communication Plan
  id: template-131-communication-plan
  template_link: /templates/template.md
- type: template
  label: 'Template:'
  section: 13.2 Implementation Timeline
  id: template-132-implementation-timeline
  template_link: /templates/template.md
- type: list
  label: 'Step 2: Establish Governing Principles'
  section: 'Step 2: Establish Governing Principles'
  id: list-step-2-establish-governing-principles
- type: list
  label: 2.1 Select Your Core Principles
  section: 2.1 Select Your Core Principles
  id: list-21-select-your-core-principles
- type: list
  label: 2.2 Create a Principles Hierarchy
  section: 2.2 Create a Principles Hierarchy
  id: list-22-create-a-principles-hierarchy
- type: list
  label: 'Step 4: Create the AI Lifecycle Requirements'
  section: 'Step 4: Create the AI Lifecycle Requirements'
  id: list-step-4-create-the-ai-lifecycle-requirements
- type: list
  label: 4.1 Planning and Initiation Requirements
  section: 4.1 Planning and Initiation Requirements
  id: list-41-planning-and-initiation-requirements
- type: list
  label: 4.2 Design and Development Requirements
  section: 4.2 Design and Development Requirements
  id: list-42-design-and-development-requirements
- type: list
  label: 4.3 Deployment Requirements
  section: 4.3 Deployment Requirements
  id: list-43-deployment-requirements
- type: list
  label: 4.4 Monitoring and Operations Requirements
  section: 4.4 Monitoring and Operations Requirements
  id: list-44-monitoring-and-operations-requirements
- type: list
  label: 4.5 Decommissioning Requirements
  section: 4.5 Decommissioning Requirements
  id: list-45-decommissioning-requirements
- type: list
  label: 'Step 6: Specific Use Case Requirements'
  section: 'Step 6: Specific Use Case Requirements'
  id: list-step-6-specific-use-case-requirements
- type: list
  label: 'Step 7: Third-Party and Procurement Requirements'
  section: 'Step 7: Third-Party and Procurement Requirements'
  id: list-step-7-third-party-and-procurement-requirements
- type: list
  label: 'Quick Reference: Policy Length Guidelines'
  section: 'Quick Reference: Policy Length Guidelines'
  id: list-quick-reference-policy-length-guidelines
- type: list
...
- nyc local law 144
word_count: 1078
processed_date: '2025-12-18T20:05:55.197Z'
---
