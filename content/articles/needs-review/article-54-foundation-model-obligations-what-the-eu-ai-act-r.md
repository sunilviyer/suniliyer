---
title: 'Article 54: Foundation Model Obligations – What the EU AI Act Requires'
tldr: ''
...
- type: image_prompt
  ...
  prompt: educational diagram showing AI concepts, neural network visualization, technology
    icons, European Union flag colors, EU stars, professional illustration, modern
...
- type: table
  label: Date vs What Happens Table
  section: Timeline for GPAI Obligations
  id: table-timeline-for-gpai-obligations
- type: flowchart
  label: If You're a Foundation Model Provider Process
  section: If You're a Foundation Model Provider
  id: flowchart-if-youre-a-foundation-model-provider
- type: flowchart
  label: If You Build on Foundation Models Process
  section: If You Build on Foundation Models
  id: flowchart-if-you-build-on-foundation-models
- type: flowchart
  label: If You're a Business Leader Process
  section: If You're a Business Leader
  id: flowchart-if-youre-a-business-leader
- type: flowchart
  label: Sources Process
  section: Sources
  id: flowchart-sources
- type: template
  label: 2. Information to Downstream Providers
  section: 2. Information to Downstream Providers
  id: template-2-information-to-downstream-providers
  template_link: /templates/2-information-to-downstream-providers.md
- type: template
  label: Information Flow
  section: Information Flow
  id: template-information-flow
  template_link: /templates/information-flow.md
- type: list
  label: Additional Requirements for Systemic Risk Models
  section: Additional Requirements for Systemic Risk Models
  id: list-additional-requirements-for-systemic-risk-models
topic_fingerprint:
- foundation model
- transformer
- multimodal
...
- telecommunications
word_count: 2021
processed_date: '2025-12-18T20:06:42.087Z'
---
...
<!-- component:template:template-2-information-to-downstream-providers -->
...
<!-- component:list:list-additional-requirements-for-systemic-risk-models -->
...
<!-- component:template:template-information-flow -->
...
| Date | What Happens |
<!-- component:table:table-timeline-for-gpai-obligations -->
|------|--------------|
...
<!-- component:flowchart:flowchart-if-youre-a-foundation-model-provider -->
