...
- type: image_prompt
  ...
  prompt: organizational structure, implementation roadmap, strategic planning elements,
    ...
    article header
- type: table
  label: Activity vs First Line Role Table
  section: Coordination Between First and Second Line
  id: table-coordination-between-first-and-second-line
- type: table
  label: Gap vs Problem Table
  section: Avoiding Gaps and Overlaps
  id: table-avoiding-gaps-and-overlaps
- type: table
  label: Overlap vs Problem Table
  section: Avoiding Gaps and Overlaps
  id: table-avoiding-gaps-and-overlaps
- type: table
  label: Line vs Capability Needed Table
  section: 'Step 3: Build Capability'
  id: table-step-3-build-capability
- type: table
  label: Metric vs What It Measures Table
  section: 'Step 5: Monitor and Improve'
  id: table-step-5-monitor-and-improve
- type: flowchart
...
- nist
word_count: 1526
processed_date: '2025-12-18T20:04:54.320Z'
---
