...
slug: article-101-building-the-ai-governance-function-where-to-sta
path: responsibility
tldr: Organizations typically start their AI governance journey from one of these positions:

**Reactive start:** "We just had an AI incident" or "Regula...
contentSections:
...
image: article-101-building-the-ai-governance-function-where-to-sta.jpg
imageAlt: Article 101: Building the AI Governance Function – Where to Start
author: Sunil Iyer
publishDate: 2025-12-23
readingTime: 11
seoTitle: Article 101: Building the AI Governance Function – Where to 
seoDescription: Organizations typically start their AI governance journey from one of these positions:
